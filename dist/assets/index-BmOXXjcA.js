...
`)+`
`+p);const x=y+m+r,S=y+p+a,P=Za(i,i.VERTEX_SHADER,x),A=Za(i,i.FRAGMENT_SHADER,S);i.attachShader(_,P),i.attachShader(_,A),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function C(I){if(s.debug.checkShaderErrors){const B=i.getProgramInfoLog(_).trim(),L=i.getShaderInfoLog(P).trim(),W=i.getShaderInfoLog(A).trim();let U=!0,K=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(U=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,P,A);else{const it=ja(i,P,"vertex"),k=ja(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
