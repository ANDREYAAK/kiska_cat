...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function Ba(){return new bn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Tr(),fragmentShader:`
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function ka(){return new bn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Tr(),fragmentShader:`
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function Tr(){return`
...
#define LOW_PRECISION`),t}function rm(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===wc?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===Ec?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===Sn&&(t="SHADOWMAP_TYPE_VSM"),t}function am(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Gi:case Vi:t="ENVMAP_TYPE_CUBE";break;case co:t="ENVMAP_TYPE_CUBE_UV";break}return t}function cm(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Vi:t="ENVMAP_MODE_REFRACTION";break}return t}function lm(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case bc:t="ENVMAP_BLENDING_MULTIPLY";break;case Gl:t="ENVMAP_BLENDING_MIX";break;case Vl:t="ENVMAP_BLENDING_ADD";break}return t}function hm(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function um(s,t,e,n){const i=s.getContext(),o=e.defines;let r=e.vertexShader,a=e.fragmentShader;const c=rm(e),l=am(e),h=cm(e),u=lm(e),d=hm(e),f=$p(e),g=Qp(o),_=i.createProgram();let m,p,y=e.glslVersion?"#version "+e.glslVersion+`
...
`)+`
`+p);const x=y+m+r,S=y+p+a,P=qa(i,i.VERTEX_SHADER,x),A=qa(i,i.FRAGMENT_SHADER,S);i.attachShader(_,P),i.attachShader(_,A),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function C(I){if(s.debug.checkShaderErrors){const B=i.getProgramInfoLog(_).trim(),L=i.getShaderInfoLog(P).trim(),W=i.getShaderInfoLog(A).trim();let U=!0,K=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(U=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,P,A);else{const it=Za(i,P,"vertex"),k=Za(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;class Om{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,e,n){if(this.texture===null){const i=new Se,o=t.properties.get(i);o.__webglTexture=e.texture,(e.depthNear!=n.depthNear||e.depthFar!=n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}render(t,e){if(this.texture!==null){if(this.mesh===null){const n=e.cameras[0].viewport,i=new bn({vertexShader:Nm,fragmentShader:zm,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new q(new Me(20,20),i)}t.render(this.mesh,e)}}reset(){this.texture=null,this.mesh=null}}class Fm extends li{constructor(t,e){super();const n=this;let i=null,o=1,r=null,a="local-floor",c=1,l=null,h=null,u=null,d=null,f=null,g=null;const _=new Om,m=e.getContextAttributes();let p=null,y=null;const x=[],S=[],P=new ht;let A=null;const C=new Ge;C.layers.enable(1),C.viewport=new me;const D=new Ge;D.layers.enable(2),D.viewport=new me;const E=[C,D],M=new Dm;M.layers.enable(1),M.layers.enable(2);let I=null,B=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(j){let ut=x[j];return ut===void 0&&(ut=new Qo,x[j]=ut),ut.getTargetRaySpace()},this.getControllerGrip=function(j){let ut=x[j];return ut===void 0&&(ut=new Qo,x[j]=ut),ut.getGripSpace()},this.getHand=function(j){let ut=x[j];return ut===void 0&&(ut=new Qo,x[j]=ut),ut.getHandSpace()};function L(j){const ut=S.indexOf(j.inputSource);if(ut===-1)return;const Et=x[ut];Et!==void 0&&(Et.update(j.inputSource,j.frame,l||r),Et.dispatchEvent({type:j.type,data:j.inputSource}))}function W(){i.removeEventListener("select",L),i.removeEventListener("selectstart",L),i.removeEventListener("selectend",L),i.removeEventListener("squeeze",L),i.removeEventListener("squeezestart",L),i.removeEventListener("squeezeend",L),i.removeEventListener("end",W),i.removeEventListener("inputsourceschange",U);for(let j=0;j<x.length;j++){const ut=S[j];ut!==null&&(S[j]=null,x[j].disconnect(ut))}I=null,B=null,_.reset(),t.setRenderTarget(p),f=null,d=null,u=null,i=null,y=null,Nt.stop(),n.isPresenting=!1,t.setPixelRatio(A),t.setSize(P.width,P.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(j){o=j,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(j){a=j,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||r},this.setReferenceSpace=function(j){l=j},this.getBaseLayer=function(){return d!==null?d:f},this.getBinding=function(){return u},this.getFrame=function(){return g},this.getSession=function(){return i},this.setSession=async function(j){if(i=j,i!==null){if(p=t.getRenderTarget(),i.addEventListener("select",L),i.addEventListener("selectstart",L),i.addEventListener("selectend",L),i.addEventListener("squeeze",L),i.addEventListener("squeezestart",L),i.addEventListener("squeezeend",L),i.addEventListener("end",W),i.addEventListener("inputsourceschange",U),m.xrCompatible!==!0&&await e.makeXRCompatible(),A=t.getPixelRatio(),t.getSize(P),i.renderState.layers===void 0){const ut={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:o};f=new XRWebGLLayer(i,e,ut),i.updateRenderState({baseLayer:f}),t.setPixelRatio(1),t.setSize(f.framebufferWidth,f.framebufferHeight,!1),y=new oi(f.framebufferWidth,f.framebufferHeight,{format:ln,type:Gn,colorSpace:t.outputColorSpace,stencilBuffer:m.stencil})}else{let ut=null,Et=null,_t=null;m.depth&&(_t=m.stencil?e.DEPTH24_STENCIL8:e.DEPTH_COMPONENT24,ut=m.stencil?us:Bi,Et=m.stencil?gs:Wi);const Ft={colorFormat:e.RGBA8,depthFormat:_t,scaleFactor:o};u=new XRWebGLBinding(i,e),d=u.createProjectionLayer(Ft),i.updateRenderState({layers:[d]}),t.setPixelRatio(1),t.setSize(d.textureWidth,d.textureHeight,!1),y=new oi(d.textureWidth,d.textureHeight,{format:ln,type:Gn,depthTexture:new Zc(d.textureWidth,d.textureHeight,Et,void 0,void 0,void 0,void 0,void 0,void 0,ut),stencilBuffer:m.stencil,colorSpace:t.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:d.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(c),l=null,r=await i.requestReferenceSpace(a),Nt.setContext(i),Nt.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode};function U(j){for(let ut=0;ut<j.removed.length;ut++){const Et=j.removed[ut],_t=S.indexOf(Et);_t>=0&&(S[_t]=null,x[_t].disconnect(Et))}for(let ut=0;ut<j.added.length;ut++){const Et=j.added[ut];let _t=S.indexOf(Et);if(_t===-1){for(let zt=0;zt<x.length;zt++)if(zt>=S.length){S.push(Et),_t=zt;break}else if(S[zt]===null){S[zt]=Et,_t=zt;break}if(_t===-1)break}const Ft=x[_t];Ft&&Ft.connect(Et)}}const K=new R,it=new R;function k(j,ut,Et){K.setFromMatrixPosition(ut.matrixWorld),it.setFromMatrixPosition(Et.matrixWorld);const _t=K.distanceTo(it),Ft=ut.projectionMatrix.elements,zt=Et.projectionMatrix.elements,N=Ft[14]/(Ft[10]-1),Gt=Ft[14]/(Ft[10]+1),Q=(Ft[9]+1)/Ft[5],dt=(Ft[9]-1)/Ft[5],nt=(Ft[8]-1)/Ft[0],J=(zt[8]+1)/zt[0],X=N*nt,at=N*J,yt=_t/(-nt+J),T=yt*-nt;ut.matrixWorld.decompose(j.position,j.quaternion,j.scale),j.translateX(T),j.translateZ(yt),j.matrixWorld.compose(j.position,j.quaternion,j.scale),j.matrixWorldInverse.copy(j.matrixWorld).invert();const w=N+yt,F=Gt+yt,Y=X-T,ot=at+(_t-T),tt=Q*Gt/F*w,bt=dt*Gt/F*w;j.projectionMatrix.makePerspective(Y,ot,tt,bt,w,F),j.projectionMatrixInverse.copy(j.projectionMatrix).invert()}function $(j,ut){ut===null?j.matrixWorld.copy(j.matrix):j.matrixWorld.multiplyMatrices(ut.matrixWorld,j.matrix),j.matrixWorldInverse.copy(j.matrixWorld).invert()}this.updateCamera=function(j){if(i===null)return;_.texture!==null&&(j.near=_.depthNear,j.far=_.depthFar),M.near=D.near=C.near=j.near,M.far=D.far=C.far=j.far,(I!==M.near||B!==M.far)&&(i.updateRenderState({depthNear:M.near,depthFar:M.far}),I=M.near,B=M.far,C.near=I,C.far=B,D.near=I,D.far=B,C.updateProjectionMatrix(),D.updateProjectionMatrix(),j.updateProjectionMatrix());const ut=j.parent,Et=M.cameras;$(M,ut);for(let _t=0;_t<Et.length;_t++)$(Et[_t],ut);Et.length===2?k(M,C,D):M.projectionMatrix.copy(C.projectionMatrix),et(j,M,ut)};function et(j,ut,Et){Et===null?j.matrix.copy(ut.matrixWorld):(j.matrix.copy(Et.matrixWorld),j.matrix.invert(),j.matrix.multiply(ut.matrixWorld)),j.matrix.decompose(j.position,j.quaternion,j.scale),j.updateMatrixWorld(!0),j.projectionMatrix.copy(ut.projectionMatrix),j.projectionMatrixInverse.copy(ut.projectionMatrixInverse),j.isPerspectiveCamera&&(j.fov=ds*2*Math.atan(1/j.projectionMatrix.elements[5]),j.zoom=1)}this.getCamera=function(){return M},this.getFoveation=function(){if(!(d===null&&f===null))return c},this.setFoveation=function(j){c=j,d!==null&&(d.fixedFoveation=j),f!==null&&f.fixedFoveation!==void 0&&(f.fixedFoveation=j)},this.hasDepthSensing=function(){return _.texture!==null};let mt=null;function Lt(j,ut){if(h=ut.getViewerPose(l||r),g=ut,h!==null){const Et=h.views;f!==null&&(t.setRenderTargetFramebuffer(y,f.framebuffer),t.setRenderTarget(y));let _t=!1;Et.length!==M.cameras.length&&(M.cameras.length=0,_t=!0);for(let zt=0;zt<Et.length;zt++){const N=Et[zt];let Gt=null;if(f!==null)Gt=f.getViewport(N);else{const dt=u.getViewSubImage(d,N);Gt=dt.viewport,zt===0&&(t.setRenderTargetTextures(y,dt.colorTexture,d.ignoreDepthValues?void 0:dt.depthStencilTexture),t.setRenderTarget(y))}let Q=E[zt];Q===void 0&&(Q=new Ge,Q.layers.enable(zt),Q.viewport=new me,E[zt]=Q),Q.matrix.fromArray(N.transform.matrix),Q.matrix.decompose(Q.position,Q.quaternion,Q.scale),Q.projectionMatrix.fromArray(N.projectionMatrix),Q.projectionMatrixInverse.copy(Q.projectionMatrix).invert(),Q.viewport.set(Gt.x,Gt.y,Gt.width,Gt.height),zt===0&&(M.matrix.copy(Q.matrix),M.matrix.decompose(M.position,M.quaternion,M.scale)),_t===!0&&M.cameras.push(Q)}const Ft=i.enabledFeatures;if(Ft&&Ft.includes("depth-sensing")){const zt=u.getDepthInformation(Et[0]);zt&&zt.isValid&&zt.texture&&_.init(t,zt,i.renderState)}}for(let Et=0;Et<x.length;Et++){const _t=S[Et],Ft=x[Et];_t!==null&&Ft!==void 0&&Ft.update(_t,ut,l||r)}_.render(t,M),mt&&mt(j,ut),ut.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:ut}),g=null}const Nt=new Yc;Nt.setAnimationLoop(Lt),this.setAnimationLoop=function(j){mt=j},this.dispose=function(){}}}const Kn=new dn,Bm=new de;function km(s,t){function e(m,p){m.matrixAutoUpdate===!0&&m.updateMatrix(),p.value.copy(m.matrix)}function n(m,p){p.color.getRGB(m.fogColor.value,Vc(s)),p.isFog?(m.fogNear.value=p.near,m.fogFar.value=p.far):p.isFogExp2&&(m.fogDensity.value=p.density)}function i(m,p,y,x,S){p.isMeshBasicMaterial||p.isMeshLambertMaterial?o(m,p):p.isMeshToonMaterial?(o(m,p),u(m,p)):p.isMeshPhongMaterial?(o(m,p),h(m,p)):p.isMeshStandardMaterial?(o(m,p),d(m,p),p.isMeshPhysicalMaterial&&f(m,p,S)):p.isMeshMatcapMaterial?(o(m,p),g(m,p)):p.isMeshDepthMaterial?o(m,p):p.isMeshDistanceMaterial?(o(m,p),_(m,p)):p.isMeshNormalMaterial?o(m,p):p.isLineBasicMaterial?(r(m,p),p.isLineDashedMaterial&&a(m,p)):p.isPointsMaterial?c(m,p,y,x):p.isSpriteMaterial?l(m,p):p.isShadowMaterial?(m.color.value.copy(p.color),m.opacity.value=p.opacity):p.isShaderMaterial&&(p.uniformsNeedUpdate=!1)}function o(m,p){m.opacity.value=p.opacity,p.color&&m.diffuse.value.copy(p.color),p.emissive&&m.emissive.value.copy(p.emissive).multiplyScalar(p.emissiveIntensity),p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.bumpMap&&(m.bumpMap.value=p.bumpMap,e(p.bumpMap,m.bumpMapTransform),m.bumpScale.value=p.bumpScale,p.side===Ce&&(m.bumpScale.value*=-1)),p.normalMap&&(m.normalMap.value=p.normalMap,e(p.normalMap,m.normalMapTransform),m.normalScale.value.copy(p.normalScale),p.side===Ce&&m.normalScale.value.negate()),p.displacementMap&&(m.displacementMap.value=p.displacementMap,e(p.displacementMap,m.displacementMapTransform),m.displacementScale.value=p.displacementScale,m.displacementBias.value=p.displacementBias),p.emissiveMap&&(m.emissiveMap.value=p.emissiveMap,e(p.emissiveMap,m.emissiveMapTransform)),p.specularMap&&(m.specularMap.value=p.specularMap,e(p.specularMap,m.specularMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest);const y=t.get(p),x=y.envMap,S=y.envMapRotation;if(x&&(m.envMap.value=x,Kn.copy(S),Kn.x*=-1,Kn.y*=-1,Kn.z*=-1,x.isCubeTexture&&x.isRenderTargetTexture===!1&&(Kn.y*=-1,Kn.z*=-1),m.envMapRotation.value.setFromMatrix4(Bm.makeRotationFromEuler(Kn)),m.flipEnvMap.value=x.isCubeTexture&&x.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=p.reflectivity,m.ior.value=p.ior,m.refractionRatio.value=p.refractionRatio),p.lightMap){m.lightMap.value=p.lightMap;const P=s._useLegacyLights===!0?Math.PI:1;m.lightMapIntensity.value=p.lightMapIntensity*P,e(p.lightMap,m.lightMapTransform)}p.aoMap&&(m.aoMap.value=p.aoMap,m.aoMapIntensity.value=p.aoMapIntensity,e(p.aoMap,m.aoMapTransform))}function r(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform))}function a(m,p){m.dashSize.value=p.dashSize,m.totalSize.value=p.dashSize+p.gapSize,m.scale.value=p.scale}function c(m,p,y,x){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.size.value=p.size*y,m.scale.value=x*.5,p.map&&(m.map.value=p.map,e(p.map,m.uvTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function l(m,p){m.diffuse.value.copy(p.color),m.opacity.value=p.opacity,m.rotation.value=p.rotation,p.map&&(m.map.value=p.map,e(p.map,m.mapTransform)),p.alphaMap&&(m.alphaMap.value=p.alphaMap,e(p.alphaMap,m.alphaMapTransform)),p.alphaTest>0&&(m.alphaTest.value=p.alphaTest)}function h(m,p){m.specular.value.copy(p.specular),m.shininess.value=Math.max(p.shininess,1e-4)}function u(m,p){p.gradientMap&&(m.gradientMap.value=p.gradientMap)}function d(m,p){m.metalness.value=p.metalness,p.metalnessMap&&(m.metalnessMap.value=p.metalnessMap,e(p.metalnessMap,m.metalnessMapTransform)),m.roughness.value=p.roughness,p.roughnessMap&&(m.roughnessMap.value=p.roughnessMap,e(p.roughnessMap,m.roughnessMapTransform)),p.envMap&&(m.envMapIntensity.value=p.envMapIntensity)}function f(m,p,y){m.ior.value=p.ior,p.sheen>0&&(m.sheenColor.value.copy(p.sheenColor).multiplyScalar(p.sheen),m.sheenRoughness.value=p.sheenRoughness,p.sheenColorMap&&(m.sheenColorMap.value=p.sheenColorMap,e(p.sheenColorMap,m.sheenColorMapTransform)),p.sheenRoughnessMap&&(m.sheenRoughnessMap.value=p.sheenRoughnessMap,e(p.sheenRoughnessMap,m.sheenRoughnessMapTransform))),p.clearcoat>0&&(m.clearcoat.value=p.clearcoat,m.clearcoatRoughness.value=p.clearcoatRoughness,p.clearcoatMap&&(m.clearcoatMap.value=p.clearcoatMap,e(p.clearcoatMap,m.clearcoatMapTransform)),p.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=p.clearcoatRoughnessMap,e(p.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),p.clearcoatNormalMap&&(m.clearcoatNormalMap.value=p.clearcoatNormalMap,e(p.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(p.clearcoatNormalScale),p.side===Ce&&m.clearcoatNormalScale.value.negate())),p.dispersion>0&&(m.dispersion.value=p.dispersion),p.iridescence>0&&(m.iridescence.value=p.iridescence,m.iridescenceIOR.value=p.iridescenceIOR,m.iridescenceThicknessMinimum.value=p.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=p.iridescenceThicknessRange[1],p.iridescenceMap&&(m.iridescenceMap.value=p.iridescenceMap,e(p.iridescenceMap,m.iridescenceMapTransform)),p.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=p.iridescenceThicknessMap,e(p.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),p.transmission>0&&(m.transmission.value=p.transmission,m.transmissionSamplerMap.value=y.texture,m.transmissionSamplerSize.value.set(y.width,y.height),p.transmissionMap&&(m.transmissionMap.value=p.transmissionMap,e(p.transmissionMap,m.transmissionMapTransform)),m.thickness.value=p.thickness,p.thicknessMap&&(m.thicknessMap.value=p.thicknessMap,e(p.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=p.attenuationDistance,m.attenuationColor.value.copy(p.attenuationColor)),p.anisotropy>0&&(m.anisotropyVector.value.set(p.anisotropy*Math.cos(p.anisotropyRotation),p.anisotropy*Math.sin(p.anisotropyRotation)),p.anisotropyMap&&(m.anisotropyMap.value=p.anisotropyMap,e(p.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=p.specularIntensity,m.specularColor.value.copy(p.specularColor),p.specularColorMap&&(m.specularColorMap.value=p.specularColorMap,e(p.specularColorMap,m.specularColorMapTransform)),p.specularIntensityMap&&(m.specularIntensityMap.value=p.specularIntensityMap,e(p.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,p){p.matcap&&(m.matcap.value=p.matcap)}function _(m,p){const y=t.get(p).light;m.referencePosition.value.setFromMatrixPosition(y.matrixWorld),m.nearDistance.value=y.shadow.camera.near,m.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function Hm(s,t,e,n){let i={},o={},r=[];const a=s.getParameter(s.MAX_UNIFORM_BUFFER_BINDINGS);function c(y,x){const S=x.program;n.uniformBlockBinding(y,S)}function l(y,x){let S=i[y.id];S===void 0&&(g(y),S=h(y),i[y.id]=S,y.addEventListener("dispose",m));const P=x.program;n.updateUBOMapping(y,P);const A=t.render.frame;o[y.id]!==A&&(d(y),o[y.id]=A)}function h(y){const x=u();y.__bindingPointIndex=x;const S=s.createBuffer(),P=y.__size,A=y.usage;return s.bindBuffer(s.UNIFORM_BUFFER,S),s.bufferData(s.UNIFORM_BUFFER,P,A),s.bindBuffer(s.UNIFORM_BUFFER,null),s.bindBufferBase(s.UNIFORM_BUFFER,x,S),S}function u(){for(let y=0;y<a;y++)if(r.indexOf(y)===-1)return r.push(y),y;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function d(y){const x=i[y.id],S=y.uniforms,P=y.__cache;s.bindBuffer(s.UNIFORM_BUFFER,x);for(let A=0,C=S.length;A<C;A++){const D=Array.isArray(S[A])?S[A]:[S[A]];for(let E=0,M=D.length;E<M;E++){const I=D[E];if(f(I,A,E,P)===!0){const B=I.__offset,L=Array.isArray(I.value)?I.value:[I.value];let W=0;for(let U=0;U<L.length;U++){const K=L[U],it=_(K);typeof K=="number"||typeof K=="boolean"?(I.__data[0]=K,s.bufferSubData(s.UNIFORM_BUFFER,B+W,I.__data)):K.isMatrix3?(I.__data[0]=K.elements[0],I.__data[1]=K.elements[1],I.__data[2]=K.elements[2],I.__data[3]=0,I.__data[4]=K.elements[3],I.__data[5]=K.elements[4],I.__data[6]=K.elements[5],I.__data[7]=0,I.__data[8]=K.elements[6],I.__data[9]=K.elements[7],I.__data[10]=K.elements[8],I.__data[11]=0):(K.toArray(I.__data,W),W+=it.storage/Float32Array.BYTES_PER_ELEMENT)}s.bufferSubData(s.UNIFORM_BUFFER,B,I.__data)}}}s.bindBuffer(s.UNIFORM_BUFFER,null)}function f(y,x,S,P){const A=y.value,C=x+"_"+S;if(P[C]===void 0)return typeof A=="number"||typeof A=="boolean"?P[C]=A:P[C]=A.clone(),!0;{const D=P[C];if(typeof A=="number"||typeof A=="boolean"){if(D!==A)return P[C]=A,!0}else if(D.equals(A)===!1)return D.copy(A),!0}return!1}function g(y){const x=y.uniforms;let S=0;const P=16;for(let C=0,D=x.length;C<D;C++){const E=Array.isArray(x[C])?x[C]:[x[C]];for(let M=0,I=E.length;M<I;M++){const B=E[M],L=Array.isArray(B.value)?B.value:[B.value];for(let W=0,U=L.length;W<U;W++){const K=L[W],it=_(K),k=S%P;k!==0&&P-k<it.boundary&&(S+=P-k),B.__data=new Float32Array(it.storage/Float32Array.BYTES_PER_ELEMENT),B.__offset=S,S+=it.storage}}}const A=S%P;return A>0&&(S+=P-A),y.__size=S,y.__cache={},this}function _(y){const x={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(x.boundary=4,x.storage=4):y.isVector2?(x.boundary=8,x.storage=8):y.isVector3||y.isColor?(x.boundary=16,x.storage=12):y.isVector4?(x.boundary=16,x.storage=16):y.isMatrix3?(x.boundary=48,x.storage=48):y.isMatrix4?(x.boundary=64,x.storage=64):y.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",y),x}function m(y){const x=y.target;x.removeEventListener("dispose",m);const S=r.indexOf(x.__bindingPointIndex);r.splice(S,1),s.deleteBuffer(i[x.id]),delete i[x.id],delete o[x.id]}function p(){for(const y in i)s.deleteBuffer(i[y]);r=[],i={},o={}}return{bind:c,update:l,dispose:p}}class Gm{constructor(t={}){const{canvas:e=Dh(),context:n=null,depth:i=!0,stencil:o=!1,alpha:r=!1,antialias:a=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:h="default",failIfMajorPerformanceCaveat:u=!1}=t;this.isWebGLRenderer=!0;let d;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");d=n.getContextAttributes().alpha}else d=r;const f=new Uint32Array(4),g=new Int32Array(4);let _=null,m=null;const p=[],y=[];this.domElement=e,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=ke,this._useLegacyLights=!1,this.toneMapping=Hn,this.toneMappingExposure=1;const x=this;let S=!1,P=0,A=0,C=null,D=-1,E=null;const M=new me,I=new me;let B=null;const L=new jt(0);let W=0,U=e.width,K=e.height,it=1,k=null,$=null;const et=new me(0,0,U,K),mt=new me(0,0,U,K);let Lt=!1;const Nt=new br;let j=!1,ut=!1;const Et=new de,_t=new R,Ft={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function zt(){return C===null?it:1}let N=n;function Gt(b,z){return e.getContext(b,z)}try{const b={alpha:!0,depth:i,stencil:o,antialias:a,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:h,failIfMajorPerformanceCaveat:u};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${yr}`),e.addEventListener("webglcontextlost",v,!1),e.addEventListener("webglcontextrestored",O,!1),e.addEventListener("webglcontextcreationerror",H,!1),N===null){const z="webgl2";if(N=Gt(z,b),N===null)throw Gt(z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(b){throw console.error("THREE.WebGLRenderer: "+b.message),b}let Q,dt,nt,J,X,at,yt,T,w,F,Y,ot,tt,bt,gt,ct,Rt,xt,ft,St,Tt,pt,Dt,Vt;function Ot(){Q=new Kf(N),Q.init(),pt=new Im(N,Q),dt=new Wf(N,Q,t,pt),nt=new Pm(N),J=new Qf(N),X=new gm,at=new Lm(N,Q,nt,X,dt,pt,J),yt=new Yf(x),T=new jf(x),w=new ou(N),Dt=new Gf(N,w),F=new Jf(N,w,J,Dt),Y=new ep(N,F,w,J),ft=new tp(N,dt,at),ct=new Xf(X),ot=new mm(x,yt,T,Q,dt,Dt,ct),tt=new km(x,X),bt=new xm,gt=new Em(Q),xt=new Hf(x,yt,T,nt,Y,d,c),Rt=new Rm(x,Y,dt),Vt=new Hm(N,J,dt,nt),St=new Vf(N,Q,J),Tt=new $f(N,Q,J),J.programs=ot.programs,x.capabilities=dt,x.extensions=Q,x.properties=X,x.renderLists=bt,x.shadowMap=Rt,x.state=nt,x.info=J}Ot();const Wt=new Fm(x,N);this.xr=Wt,this.getContext=function(){return N},this.getContextAttributes=function(){return N.getContextAttributes()},this.forceContextLoss=function(){const b=Q.get("WEBGL_lose_context");b&&b.loseContext()},this.forceContextRestore=function(){const b=Q.get("WEBGL_lose_context");b&&b.restoreContext()},this.getPixelRatio=function(){return it},this.setPixelRatio=function(b){b!==void 0&&(it=b,this.setSize(U,K,!1))},this.getSize=function(b){return b.set(U,K)},this.setSize=function(b,z,Z=!0){if(Wt.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}U=b,K=z,e.width=Math.floor(b*it),e.height=Math.floor(z*it),Z===!0&&(e.style.width=b+"px",e.style.height=z+"px"),this.setViewport(0,0,b,z)},this.getDrawingBufferSize=function(b){return b.set(U*it,K*it).floor()},this.setDrawingBufferSize=function(b,z,Z){U=b,K=z,it=Z,e.width=Math.floor(b*Z),e.height=Math.floor(z*Z),this.setViewport(0,0,b,z)},this.getCurrentViewport=function(b){return b.copy(M)},this.getViewport=function(b){return b.copy(et)},this.setViewport=function(b,z,Z,V){b.isVector4?et.set(b.x,b.y,b.z,b.w):et.set(b,z,Z,V),nt.viewport(M.copy(et).multiplyScalar(it).round())},this.getScissor=function(b){return b.copy(mt)},this.setScissor=function(b,z,Z,V){b.isVector4?mt.set(b.x,b.y,b.z,b.w):mt.set(b,z,Z,V),nt.scissor(I.copy(mt).multiplyScalar(it).round())},this.getScissorTest=function(){return Lt},this.setScissorTest=function(b){nt.setScissorTest(Lt=b)},this.setOpaqueSort=function(b){k=b},this.setTransparentSort=function(b){$=b},this.getClearColor=function(b){return b.copy(xt.getClearColor())},this.setClearColor=function(){xt.setClearColor.apply(xt,arguments)},this.getClearAlpha=function(){return xt.getClearAlpha()},this.setClearAlpha=function(){xt.setClearAlpha.apply(xt,arguments)},this.clear=function(b=!0,z=!0,Z=!0){let V=0;if(b){let G=!1;if(C!==null){const st=C.texture.format;G=st===Uc||st===Dc||st===Ic}if(G){const st=C.texture.type,Mt=st===Gn||st===Wi||st===Cc||st===gs||st===Pc||st===Lc,wt=xt.getClearColor(),It=xt.getClearAlpha(),Ut=wt.r,Bt=wt.g,Zt=wt.b;Mt?(f[0]=Ut,f[1]=Bt,f[2]=Zt,f[3]=It,N.clearBufferuiv(N.COLOR,0,f)):(g[0]=Ut,g[1]=Bt,g[2]=Zt,g[3]=It,N.clearBufferiv(N.COLOR,0,g))}else V|=N.COLOR_BUFFER_BIT}z&&(V|=N.DEPTH_BUFFER_BIT),Z&&(V|=N.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),N.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",v,!1),e.removeEventListener("webglcontextrestored",O,!1),e.removeEventListener("webglcontextcreationerror",H,!1),bt.dispose(),gt.dispose(),X.dispose(),yt.dispose(),T.dispose(),Y.dispose(),Dt.dispose(),Vt.dispose(),ot.dispose(),Wt.dispose(),Wt.removeEventListener("sessionstart",Kt),Wt.removeEventListener("sessionend",he),Qt.stop()};function v(b){b.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),S=!0}function O(){console.log("THREE.WebGLRenderer: Context Restored."),S=!1;const b=J.autoReset,z=Rt.enabled,Z=Rt.autoUpdate,V=Rt.needsUpdate,G=Rt.type;Ot(),J.autoReset=b,Rt.enabled=z,Rt.autoUpdate=Z,Rt.needsUpdate=V,Rt.type=G}function H(b){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",b.statusMessage)}function lt(b){const z=b.target;z.removeEventListener("dispose",lt),vt(z)}function vt(b){Ht(b),X.remove(b)}function Ht(b){const z=X.get(b).programs;z!==void 0&&(z.forEach(function(Z){ot.releaseProgram(Z)}),b.isShaderMaterial&&ot.releaseShaderCache(b))}this.renderBufferDirect=function(b,z,Z,V,G,st){z===null&&(z=Ft);const Mt=G.isMesh&&G.matrixWorld.determinant()<0,wt=xs(b,z,Z,V,G);nt.setMaterial(V,Mt);let It=Z.index,Ut=1;if(V.wireframe===!0){if(It=F.getWireframeAttribute(Z),It===void 0)return;Ut=2}const Bt=Z.drawRange,Zt=Z.attributes.position;let _e=Bt.start*Ut,we=(Bt.start+Bt.count)*Ut;st!==null&&(_e=Math.max(_e,st.start*Ut),we=Math.min(we,(st.start+st.count)*Ut)),It!==null?(_e=Math.max(_e,0),we=Math.min(we,It.count)):Zt!=null&&(_e=Math.max(_e,0),we=Math.min(we,Zt.count));const Pe=we-_e;if(Pe<0||Pe===1/0)return;Dt.setup(G,V,wt,Z,It);let Xe,ee=St;if(It!==null&&(Xe=w.get(It),ee=Tt,ee.setIndex(Xe)),G.isMesh)V.wireframe===!0?(nt.setLineWidth(V.wireframeLinewidth*zt()),ee.setMode(N.LINES)):ee.setMode(N.TRIANGLES);else if(G.isLine){let Yt=V.linewidth;Yt===void 0&&(Yt=1),nt.setLineWidth(Yt*zt()),G.isLineSegments?ee.setMode(N.LINES):G.isLineLoop?ee.setMode(N.LINE_LOOP):ee.setMode(N.LINE_STRIP)}else G.isPoints?ee.setMode(N.POINTS):G.isSprite&&ee.setMode(N.TRIANGLES);if(G.isBatchedMesh)G._multiDrawInstances!==null?ee.renderMultiDrawInstances(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount,G._multiDrawInstances):ee.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else if(G.isInstancedMesh)ee.renderInstances(_e,Pe,G.count);else if(Z.isInstancedBufferGeometry){const Yt=Z._maxInstanceCount!==void 0?Z._maxInstanceCount:1/0,gn=Math.min(Z.instanceCount,Yt);ee.renderInstances(_e,Pe,gn)}else ee.render(_e,Pe)};function Xt(b,z,Z){b.transparent===!0&&b.side===Ve&&b.forceSinglePass===!1?(b.side=Ce,b.needsUpdate=!0,We(b,z,Z),b.side=on,b.needsUpdate=!0,We(b,z,Z),b.side=Ve):We(b,z,Z)}this.compile=function(b,z,Z=null){Z===null&&(Z=b),m=gt.get(Z),m.init(z),y.push(m),Z.traverseVisible(function(G){G.isLight&&G.layers.test(z.layers)&&(m.pushLight(G),G.castShadow&&m.pushShadow(G))}),b!==Z&&b.traverseVisible(function(G){G.isLight&&G.layers.test(z.layers)&&(m.pushLight(G),G.castShadow&&m.pushShadow(G))}),m.setupLights(x._useLegacyLights);const V=new Set;return b.traverse(function(G){const st=G.material;if(st)if(Array.isArray(st))for(let Mt=0;Mt<st.length;Mt++){const wt=st[Mt];Xt(wt,Z,G),V.add(wt)}else Xt(st,Z,G),V.add(st)}),y.pop(),m=null,V},this.compileAsync=function(b,z,Z=null){const V=this.compile(b,z,Z);return new Promise(G=>{function st(){if(V.forEach(function(Mt){X.get(Mt).currentProgram.isReady()&&V.delete(Mt)}),V.size===0){G(b);return}setTimeout(st,10)}Q.get("KHR_parallel_shader_compile")!==null?st():setTimeout(st,10)})};let ne=null;function le(b){ne&&ne(b)}function Kt(){Qt.stop()}function he(){Qt.start()}const Qt=new Yc;Qt.setAnimationLoop(le),typeof self<"u"&&Qt.setContext(self),this.setAnimationLoop=function(b){ne=b,Wt.setAnimationLoop(b),b===null?Qt.stop():Qt.start()},Wt.addEventListener("sessionstart",Kt),Wt.addEventListener("sessionend",he),this.render=function(b,z){if(z!==void 0&&z.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(S===!0)return;b.matrixWorldAutoUpdate===!0&&b.updateMatrixWorld(),z.parent===null&&z.matrixWorldAutoUpdate===!0&&z.updateMatrixWorld(),Wt.enabled===!0&&Wt.isPresenting===!0&&(Wt.cameraAutoUpdate===!0&&Wt.updateCamera(z),z=Wt.getCamera()),b.isScene===!0&&b.onBeforeRender(x,b,z,C),m=gt.get(b,y.length),m.init(z),y.push(m),Et.multiplyMatrices(z.projectionMatrix,z.matrixWorldInverse),Nt.setFromProjectionMatrix(Et),ut=this.localClippingEnabled,j=ct.init(this.clippingPlanes,ut),_=bt.get(b,p.length),_.init(),p.push(_),Je(b,z,0,x.sortObjects),_.finish(),x.sortObjects===!0&&_.sort(k,$);const Z=Wt.enabled===!1||Wt.isPresenting===!1||Wt.hasDepthSensing()===!1;Z&&xt.addToRenderList(_,b),this.info.render.frame++,j===!0&&ct.beginShadows();const V=m.state.shadowsArray;Rt.render(V,b,z),j===!0&&ct.endShadows(),this.info.autoReset===!0&&this.info.reset();const G=_.opaque,st=_.transmissive;if(m.setupLights(x._useLegacyLights),z.isArrayCamera){const Mt=z.cameras;if(st.length>0)for(let wt=0,It=Mt.length;wt<It;wt++){const Ut=Mt[wt];rn(G,st,b,Ut)}Z&&xt.render(b);for(let wt=0,It=Mt.length;wt<It;wt++){const Ut=Mt[wt];ze(_,b,Ut,Ut.viewport)}}else st.length>0&&rn(G,st,b,z),Z&&xt.render(b),ze(_,b,z);C!==null&&(at.updateMultisampleRenderTarget(C),at.updateRenderTargetMipmap(C)),b.isScene===!0&&b.onAfterRender(x,b,z),Dt.resetDefaultState(),D=-1,E=null,y.pop(),y.length>0?(m=y[y.length-1],j===!0&&ct.setGlobalState(x.clippingPlanes,m.state.camera)):m=null,p.pop(),p.length>0?_=p[p.length-1]:_=null};function Je(b,z,Z,V){if(b.visible===!1)return;if(b.layers.test(z.layers)){if(b.isGroup)Z=b.renderOrder;else if(b.isLOD)b.autoUpdate===!0&&b.update(z);else if(b.isLight)m.pushLight(b),b.castShadow&&m.pushShadow(b);else if(b.isSprite){if(!b.frustumCulled||Nt.intersectsSprite(b)){V&&_t.setFromMatrixPosition(b.matrixWorld).applyMatrix4(Et);const Mt=Y.update(b),wt=b.material;wt.visible&&_.push(b,Mt,wt,Z,_t.z,null)}}else if((b.isMesh||b.isLine||b.isPoints)&&(!b.frustumCulled||Nt.intersectsObject(b))){const Mt=Y.update(b),wt=b.material;if(V&&(b.boundingSphere!==void 0?(b.boundingSphere===null&&b.computeBoundingSphere(),_t.copy(b.boundingSphere.center)):(Mt.boundingSphere===null&&Mt.computeBoundingSphere(),_t.copy(Mt.boundingSphere.center)),_t.applyMatrix4(b.matrixWorld).applyMatrix4(Et)),Array.isArray(wt)){const It=Mt.groups;for(let Ut=0,Bt=It.length;Ut<Bt;Ut++){const Zt=It[Ut],_e=wt[Zt.materialIndex];_e&&_e.visible&&_.push(b,Mt,_e,Z,_t.z,Zt)}}else wt.visible&&_.push(b,Mt,wt,Z,_t.z,null)}}const st=b.children;for(let Mt=0,wt=st.length;Mt<wt;Mt++)Je(st[Mt],z,Z,V)}function ze(b,z,Z,V){const G=b.opaque,st=b.transmissive,Mt=b.transparent;m.setupLightsView(Z),j===!0&&ct.setGlobalState(x.clippingPlanes,Z),V&&nt.viewport(M.copy(V)),G.length>0&&$e(G,z,Z),st.length>0&&$e(st,z,Z),Mt.length>0&&$e(Mt,z,Z),nt.buffers.depth.setTest(!0),nt.buffers.depth.setMask(!0),nt.buffers.color.setMask(!0),nt.setPolygonOffset(!1)}function rn(b,z,Z,V){if((Z.isScene===!0?Z.overrideMaterial:null)!==null)return;m.state.transmissionRenderTarget[V.id]===void 0&&(m.state.transmissionRenderTarget[V.id]=new oi(1,1,{generateMipmaps:!0,type:Q.has("EXT_color_buffer_half_float")||Q.has("EXT_color_buffer_float")?lo:Gn,minFilter:ei,samples:4,stencilBuffer:o,resolveDepthBuffer:!1,resolveStencilBuffer:!1}));const st=m.state.transmissionRenderTarget[V.id],Mt=V.viewport||M;st.setSize(Mt.z,Mt.w);const wt=x.getRenderTarget();x.setRenderTarget(st),x.getClearColor(L),W=x.getClearAlpha(),W<1&&x.setClearColor(16777215,.5),x.clear();const It=x.toneMapping;x.toneMapping=Hn;const Ut=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),m.setupLightsView(V),j===!0&&ct.setGlobalState(x.clippingPlanes,V),$e(b,Z,V),at.updateMultisampleRenderTarget(st),at.updateRenderTargetMipmap(st),Q.has("WEBGL_multisampled_render_to_texture")===!1){let Bt=!1;for(let Zt=0,_e=z.length;Zt<_e;Zt++){const we=z[Zt],Pe=we.object,Xe=we.geometry,ee=we.material,Yt=we.group;if(ee.side===Ve&&Pe.layers.test(V.layers)){const gn=ee.side;ee.side=Ce,ee.needsUpdate=!0,mn(Pe,Z,V,Xe,ee,Yt),ee.side=gn,ee.needsUpdate=!0,Bt=!0}}Bt===!0&&(at.updateMultisampleRenderTarget(st),at.updateRenderTargetMipmap(st))}x.setRenderTarget(wt),x.setClearColor(L,W),Ut!==void 0&&(V.viewport=Ut),x.toneMapping=It}function $e(b,z,Z){const V=z.isScene===!0?z.overrideMaterial:null;for(let G=0,st=b.length;G<st;G++){const Mt=b[G],wt=Mt.object,It=Mt.geometry,Ut=V===null?Mt.material:V,Bt=Mt.group;wt.layers.test(Z.layers)&&mn(wt,z,Z,It,Ut,Bt)}}function mn(b,z,Z,V,G,st){b.onBeforeRender(x,z,Z,V,G,st),b.modelViewMatrix.multiplyMatrices(Z.matrixWorldInverse,b.matrixWorld),b.normalMatrix.getNormalMatrix(b.modelViewMatrix),G.onBeforeRender(x,z,Z,V,b,st),G.transparent===!0&&G.side===Ve&&G.forceSinglePass===!1?(G.side=Ce,G.needsUpdate=!0,x.renderBufferDirect(Z,z,V,G,b,st),G.side=on,G.needsUpdate=!0,x.renderBufferDirect(Z,z,V,G,b,st),G.side=Ve):x.renderBufferDirect(Z,z,V,G,b,st),b.onAfterRender(x,z,Z,V,G,st)}function We(b,z,Z){z.isScene!==!0&&(z=Ft);const V=X.get(b),G=m.state.lights,st=m.state.shadowsArray,Mt=G.state.version,wt=ot.getParameters(b,G.state,st,z,Z),It=ot.getProgramCacheKey(wt);let Ut=V.programs;V.environment=b.isMeshStandardMaterial?z.environment:null,V.fog=z.fog,V.envMap=(b.isMeshStandardMaterial?T:yt).get(b.envMap||V.environment),V.envMapRotation=V.environment!==null&&b.envMap===null?z.environmentRotation:b.envMapRotation,Ut===void 0&&(b.addEventListener("dispose",lt),Ut=new Map,V.programs=Ut);let Bt=Ut.get(It);if(Bt!==void 0){if(V.currentProgram===Bt&&V.lightsStateVersion===Mt)return ji(b,wt),Bt}else wt.uniforms=ot.getUniforms(b),b.onBuild(Z,wt,x),b.onBeforeCompile(wt,x),Bt=ot.acquireProgram(wt,It),Ut.set(It,Bt),V.uniforms=wt.uniforms;const Zt=V.uniforms;return(!b.isShaderMaterial&&!b.isRawShaderMaterial||b.clipping===!0)&&(Zt.clippingPlanes=ct.uniform),ji(b,wt),V.needsLights=vs(b),V.lightsStateVersion=Mt,V.needsLights&&(Zt.ambientLightColor.value=G.state.ambient,Zt.lightProbe.value=G.state.probe,Zt.directionalLights.value=G.state.directional,Zt.directionalLightShadows.value=G.state.directionalShadow,Zt.spotLights.value=G.state.spot,Zt.spotLightShadows.value=G.state.spotShadow,Zt.rectAreaLights.value=G.state.rectArea,Zt.ltc_1.value=G.state.rectAreaLTC1,Zt.ltc_2.value=G.state.rectAreaLTC2,Zt.pointLights.value=G.state.point,Zt.pointLightShadows.value=G.state.pointShadow,Zt.hemisphereLights.value=G.state.hemi,Zt.directionalShadowMap.value=G.state.directionalShadowMap,Zt.directionalShadowMatrix.value=G.state.directionalShadowMatrix,Zt.spotShadowMap.value=G.state.spotShadowMap,Zt.spotLightMatrix.value=G.state.spotLightMatrix,Zt.spotLightMap.value=G.state.spotLightMap,Zt.pointShadowMap.value=G.state.pointShadowMap,Zt.pointShadowMatrix.value=G.state.pointShadowMatrix),V.currentProgram=Bt,V.uniformsList=null,Bt}function Qe(b){if(b.uniformsList===null){const z=b.currentProgram.getUniforms();b.uniformsList=js.seqWithValue(z.seq,b.uniforms)}return b.uniformsList}function ji(b,z){const Z=X.get(b);Z.outputColorSpace=z.outputColorSpace,Z.batching=z.batching,Z.instancing=z.instancing,Z.instancingColor=z.instancingColor,Z.instancingMorph=z.instancingMorph,Z.skinning=z.skinning,Z.morphTargets=z.morphTargets,Z.morphNormals=z.morphNormals,Z.morphColors=z.morphColors,Z.morphTargetsCount=z.morphTargetsCount,Z.numClippingPlanes=z.numClippingPlanes,Z.numIntersection=z.numClipIntersection,Z.vertexAlphas=z.vertexAlphas,Z.vertexTangents=z.vertexTangents,Z.toneMapping=z.toneMapping}function xs(b,z,Z,V,G){z.isScene!==!0&&(z=Ft),at.resetTextureUnits();const st=z.fog,Mt=V.isMeshStandardMaterial?z.environment:null,wt=C===null?x.outputColorSpace:C.isXRRenderTarget===!0?C.texture.colorSpace:Vn,It=(V.isMeshStandardMaterial?T:yt).get(V.envMap||Mt),Ut=V.vertexColors===!0&&!!Z.attributes.color&&Z.attributes.color.itemSize===4,Bt=!!Z.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),Zt=!!Z.morphAttributes.position,_e=!!Z.morphAttributes.normal,we=!!Z.morphAttributes.color;let Pe=Hn;V.toneMapped&&(C===null||C.isXRRenderTarget===!0)&&(Pe=x.toneMapping);const Xe=Z.morphAttributes.position||Z.morphAttributes.normal||Z.morphAttributes.color,ee=Xe!==void 0?Xe.length:0,Yt=X.get(V),gn=m.state.lights;if(j===!0&&(ut===!0||b!==E)){const Ye=b===E&&V.id===D;ct.setState(V,b,Ye)}let fe=!1;V.version===Yt.__version?(Yt.needsLights&&Yt.lightsStateVersion!==gn.state.version||Yt.outputColorSpace!==wt||G.isBatchedMesh&&Yt.batching===!1||!G.isBatchedMesh&&Yt.batching===!0||G.isInstancedMesh&&Yt.instancing===!1||!G.isInstancedMesh&&Yt.instancing===!0||G.isSkinnedMesh&&Yt.skinning===!1||!G.isSkinnedMesh&&Yt.skinning===!0||G.isInstancedMesh&&Yt.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&Yt.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&Yt.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&Yt.instancingMorph===!1&&G.morphTexture!==null||Yt.envMap!==It||V.fog===!0&&Yt.fog!==st||Yt.numClippingPlanes!==void 0&&(Yt.numClippingPlanes!==ct.numPlanes||Yt.numIntersection!==ct.numIntersection)||Yt.vertexAlphas!==Ut||Yt.vertexTangents!==Bt||Yt.morphTargets!==Zt||Yt.morphNormals!==_e||Yt.morphColors!==we||Yt.toneMapping!==Pe||Yt.morphTargetsCount!==ee)&&(fe=!0):(fe=!0,Yt.__version=V.version);let Wn=Yt.currentProgram;fe===!0&&(Wn=We(V,z,G));let Dr=!1,Ki=!1,Mo=!1;const Le=Wn.getUniforms(),Tn=Yt.uniforms;if(nt.useProgram(Wn.program)&&(Dr=!0,Ki=!0,Mo=!0),V.id!==D&&(D=V.id,Ki=!0),Dr||E!==b){Le.setValue(N,"projectionMatrix",b.projectionMatrix),Le.setValue(N,"viewMatrix",b.matrixWorldInverse);const Ye=Le.map.cameraPosition;Ye!==void 0&&Ye.setValue(N,_t.setFromMatrixPosition(b.matrixWorld)),dt.logarithmicDepthBuffer&&Le.setValue(N,"logDepthBufFC",2/(Math.log(b.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&Le.setValue(N,"isOrthographic",b.isOrthographicCamera===!0),E!==b&&(E=b,Ki=!0,Mo=!0)}if(G.isSkinnedMesh){Le.setOptional(N,G,"bindMatrix"),Le.setOptional(N,G,"bindMatrixInverse");const Ye=G.skeleton;Ye&&(Ye.boneTexture===null&&Ye.computeBoneTexture(),Le.setValue(N,"boneTexture",Ye.boneTexture,at))}G.isBatchedMesh&&(Le.setOptional(N,G,"batchingTexture"),Le.setValue(N,"batchingTexture",G._matricesTexture,at));const yo=Z.morphAttributes;if((yo.position!==void 0||yo.normal!==void 0||yo.color!==void 0)&&ft.update(G,Z,Wn),(Ki||Yt.receiveShadow!==G.receiveShadow)&&(Yt.receiveShadow=G.receiveShadow,Le.setValue(N,"receiveShadow",G.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(Tn.envMap.value=It,Tn.flipEnvMap.value=It.isCubeTexture&&It.isRenderTargetTexture===!1?-1:1),V.isMeshStandardMaterial&&V.envMap===null&&z.environment!==null&&(Tn.envMapIntensity.value=z.environmentIntensity),Ki&&(Le.setValue(N,"toneMappingExposure",x.toneMappingExposure),Yt.needsLights&&ui(Tn,Mo),st&&V.fog===!0&&tt.refreshFogUniforms(Tn,st),tt.refreshMaterialUniforms(Tn,V,it,K,m.state.transmissionRenderTarget[b.id]),js.upload(N,Qe(Yt),Tn,at)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(js.upload(N,Qe(Yt),Tn,at),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&Le.setValue(N,"center",G.center),Le.setValue(N,"modelViewMatrix",G.modelViewMatrix),Le.setValue(N,"normalMatrix",G.normalMatrix),Le.setValue(N,"modelMatrix",G.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){const Ye=V.uniformsGroups;for(let So=0,dl=Ye.length;So<dl;So++){const Ur=Ye[So];Vt.update(Ur,Wn),Vt.bind(Ur,Wn)}}return Wn}function ui(b,z){b.ambientLightColor.needsUpdate=z,b.lightProbe.needsUpdate=z,b.directionalLights.needsUpdate=z,b.directionalLightShadows.needsUpdate=z,b.pointLights.needsUpdate=z,b.pointLightShadows.needsUpdate=z,b.spotLights.needsUpdate=z,b.spotLightShadows.needsUpdate=z,b.rectAreaLights.needsUpdate=z,b.hemisphereLights.needsUpdate=z}function vs(b){return b.isMeshLambertMaterial||b.isMeshToonMaterial||b.isMeshPhongMaterial||b.isMeshStandardMaterial||b.isShadowMaterial||b.isShaderMaterial&&b.lights===!0}this.getActiveCubeFace=function(){return P},this.getActiveMipmapLevel=function(){return A},this.getRenderTarget=function(){return C},this.setRenderTargetTextures=function(b,z,Z){X.get(b.texture).__webglTexture=z,X.get(b.depthTexture).__webglTexture=Z;const V=X.get(b);V.__hasExternalTextures=!0,V.__autoAllocateDepthBuffer=Z===void 0,V.__autoAllocateDepthBuffer||Q.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),V.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(b,z){const Z=X.get(b);Z.__webglFramebuffer=z,Z.__useDefaultFramebuffer=z===void 0},this.setRenderTarget=function(b,z=0,Z=0){C=b,P=z,A=Z;let V=!0,G=null,st=!1,Mt=!1;if(b){const It=X.get(b);It.__useDefaultFramebuffer!==void 0?(nt.bindFramebuffer(N.FRAMEBUFFER,null),V=!1):It.__webglFramebuffer===void 0?at.setupRenderTarget(b):It.__hasExternalTextures&&at.rebindTextures(b,X.get(b.texture).__webglTexture,X.get(b.depthTexture).__webglTexture);const Ut=b.texture;(Ut.isData3DTexture||Ut.isDataArrayTexture||Ut.isCompressedArrayTexture)&&(Mt=!0);const Bt=X.get(b).__webglFramebuffer;b.isWebGLCubeRenderTarget?(Array.isArray(Bt[z])?G=Bt[z][Z]:G=Bt[z],st=!0):b.samples>0&&at.useMultisampledRTT(b)===!1?G=X.get(b).__webglMultisampledFramebuffer:Array.isArray(Bt)?G=Bt[Z]:G=Bt,M.copy(b.viewport),I.copy(b.scissor),B=b.scissorTest}else M.copy(et).multiplyScalar(it).floor(),I.copy(mt).multiplyScalar(it).floor(),B=Lt;if(nt.bindFramebuffer(N.FRAMEBUFFER,G)&&V&&nt.drawBuffers(b,G),nt.viewport(M),nt.scissor(I),nt.setScissorTest(B),st){const It=X.get(b.texture);N.framebufferTexture2D(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,N.TEXTURE_CUBE_MAP_POSITIVE_X+z,It.__webglTexture,Z)}else if(Mt){const It=X.get(b.texture),Ut=z||0;N.framebufferTextureLayer(N.FRAMEBUFFER,N.COLOR_ATTACHMENT0,It.__webglTexture,Z||0,Ut)}D=-1},this.readRenderTargetPixels=function(b,z,Z,V,G,st,Mt){if(!(b&&b.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let wt=X.get(b).__webglFramebuffer;if(b.isWebGLCubeRenderTarget&&Mt!==void 0&&(wt=wt[Mt]),wt){nt.bindFramebuffer(N.FRAMEBUFFER,wt);try{const It=b.texture,Ut=It.format,Bt=It.type;if(!dt.textureFormatReadable(Ut)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!dt.textureTypeReadable(Bt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}z>=0&&z<=b.width-V&&Z>=0&&Z<=b.height-G&&N.readPixels(z,Z,V,G,pt.convert(Ut),pt.convert(Bt),st)}finally{const It=C!==null?X.get(C).__webglFramebuffer:null;nt.bindFramebuffer(N.FRAMEBUFFER,It)}}},this.copyFramebufferToTexture=function(b,z,Z=0){const V=Math.pow(2,-Z),G=Math.floor(z.image.width*V),st=Math.floor(z.image.height*V);at.setTexture2D(z,0),N.copyTexSubImage2D(N.TEXTURE_2D,Z,0,0,b.x,b.y,G,st),nt.unbindTexture()},this.copyTextureToTexture=function(b,z,Z,V=0){const G=z.image.width,st=z.image.height,Mt=pt.convert(Z.format),wt=pt.convert(Z.type);at.setTexture2D(Z,0),N.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,Z.flipY),N.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Z.premultiplyAlpha),N.pixelStorei(N.UNPACK_ALIGNMENT,Z.unpackAlignment),z.isDataTexture?N.texSubImage2D(N.TEXTURE_2D,V,b.x,b.y,G,st,Mt,wt,z.image.data):z.isCompressedTexture?N.compressedTexSubImage2D(N.TEXTURE_2D,V,b.x,b.y,z.mipmaps[0].width,z.mipmaps[0].height,Mt,z.mipmaps[0].data):N.texSubImage2D(N.TEXTURE_2D,V,b.x,b.y,Mt,wt,z.image),V===0&&Z.generateMipmaps&&N.generateMipmap(N.TEXTURE_2D),nt.unbindTexture()},this.copyTextureToTexture3D=function(b,z,Z,V,G=0){const st=b.max.x-b.min.x,Mt=b.max.y-b.min.y,wt=b.max.z-b.min.z,It=pt.convert(V.format),Ut=pt.convert(V.type);let Bt;if(V.isData3DTexture)at.setTexture3D(V,0),Bt=N.TEXTURE_3D;else if(V.isDataArrayTexture||V.isCompressedArrayTexture)at.setTexture2DArray(V,0),Bt=N.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}N.pixelStorei(N.UNPACK_FLIP_Y_WEBGL,V.flipY),N.pixelStorei(N.UNPACK_PREMULTIPLY_ALPHA_WEBGL,V.premultiplyAlpha),N.pixelStorei(N.UNPACK_ALIGNMENT,V.unpackAlignment);const Zt=N.getParameter(N.UNPACK_ROW_LENGTH),_e=N.getParameter(N.UNPACK_IMAGE_HEIGHT),we=N.getParameter(N.UNPACK_SKIP_PIXELS),Pe=N.getParameter(N.UNPACK_SKIP_ROWS),Xe=N.getParameter(N.UNPACK_SKIP_IMAGES),ee=Z.isCompressedTexture?Z.mipmaps[G]:Z.image;N.pixelStorei(N.UNPACK_ROW_LENGTH,ee.width),N.pixelStorei(N.UNPACK_IMAGE_HEIGHT,ee.height),N.pixelStorei(N.UNPACK_SKIP_PIXELS,b.min.x),N.pixelStorei(N.UNPACK_SKIP_ROWS,b.min.y),N.pixelStorei(N.UNPACK_SKIP_IMAGES,b.min.z),Z.isDataTexture||Z.isData3DTexture?N.texSubImage3D(Bt,G,z.x,z.y,z.z,st,Mt,wt,It,Ut,ee.data):V.isCompressedArrayTexture?N.compressedTexSubImage3D(Bt,G,z.x,z.y,z.z,st,Mt,wt,It,ee.data):N.texSubImage3D(Bt,G,z.x,z.y,z.z,st,Mt,wt,It,Ut,ee),N.pixelStorei(N.UNPACK_ROW_LENGTH,Zt),N.pixelStorei(N.UNPACK_IMAGE_HEIGHT,_e),N.pixelStorei(N.UNPACK_SKIP_PIXELS,we),N.pixelStorei(N.UNPACK_SKIP_ROWS,Pe),N.pixelStorei(N.UNPACK_SKIP_IMAGES,Xe),G===0&&V.generateMipmaps&&N.generateMipmap(Bt),nt.unbindTexture()},this.initTexture=function(b){b.isCubeTexture?at.setTextureCube(b,0):b.isData3DTexture?at.setTexture3D(b,0):b.isDataArrayTexture||b.isCompressedArrayTexture?at.setTexture2DArray(b,0):at.setTexture2D(b,0),nt.unbindTexture()},this.resetState=function(){P=0,A=0,C=null,nt.reset(),Dt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return En}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const e=this.getContext();e.drawingBufferColorSpace=t===Sr?"display-p3":"srgb",e.unpackColorSpace=ce.workingColorSpace===ho?"display-p3":"srgb"}get useLegacyLights(){return console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights}set useLegacyLights(t){console.warn("THREE.WebGLRenderer: The property .useLegacyLights has been deprecated. Migrate your lighting according to the following guide: https://discourse.threejs.org/t/updates-to-lighting-in-three-js-r155/53733."),this._useLegacyLights=t}}class Ar{constructor(t,e=1,n=1e3){this.isFog=!0,this.name="",this.color=new jt(t),this.near=e,this.far=n}clone(){return new Ar(this.color,this.near,this.far)}toJSON(){return{type:"Fog",name:this.name,color:this.color.getHex(),near:this.near,far:this.far}}}class Vm extends Re{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new dn,this.environmentIntensity=1,this.environmentRotation=new dn,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(t,e){return super.copy(t,e),t.background!==null&&(this.background=t.background.clone()),t.environment!==null&&(this.environment=t.environment.clone()),t.fog!==null&&(this.fog=t.fog.clone()),this.backgroundBlurriness=t.backgroundBlurriness,this.backgroundIntensity=t.backgroundIntensity,this.backgroundRotation.copy(t.backgroundRotation),this.environmentIntensity=t.environmentIntensity,this.environmentRotation.copy(t.environmentRotation),t.overrideMaterial!==null&&(this.overrideMaterial=t.overrideMaterial.clone()),this.matrixAutoUpdate=t.matrixAutoUpdate,this}toJSON(t){const e=super.toJSON(t);return this.fog!==null&&(e.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(e.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(e.object.backgroundIntensity=this.backgroundIntensity),e.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(e.object.environmentIntensity=this.environmentIntensity),e.object.environmentRotation=this.environmentRotation.toArray(),e}}class ni extends qi{constructor(t){super(),this.isLineBasicMaterial=!0,this.type="LineBasicMaterial",this.color=new jt(16777215),this.map=null,this.linewidth=1,this.linecap="round",this.linejoin="round",this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.color.copy(t.color),this.map=t.map,this.linewidth=t.linewidth,this.linecap=t.linecap,this.linejoin=t.linejoin,this.fog=t.fog,this}}const so=new R,oo=new R,nc=new de,es=new po,Gs=new fo,tr=new R,ic=new R;class Bn extends Re{constructor(t=new ge,e=new ni){super(),this.isLine=!0,this.type="Line",this.geometry=t,this.material=e,this.updateMorphTargets()}copy(t,e){return super.copy(t,e),this.material=Array.isArray(t.material)?t.material.slice():t.material,this.geometry=t.geometry,this}computeLineDistances(){const t=this.geometry;if(t.index===null){const e=t.attributes.position,n=[0];for(let i=1,o=e.count;i<o;i++)so.fromBufferAttribute(e,i-1),oo.fromBufferAttribute(e,i),n[i]=n[i-1],n[i]+=so.distanceTo(oo);t.setAttribute("lineDistance",new oe(n,1))}else console.warn("THREE.Line.computeLineDistances(): Computation only possible with non-indexed BufferGeometry.");return this}raycast(t,e){const n=this.geometry,i=this.matrixWorld,o=t.params.Line.threshold,r=n.drawRange;if(n.boundingSphere===null&&n.computeBoundingSphere(),Gs.copy(n.boundingSphere),Gs.applyMatrix4(i),Gs.radius+=o,t.ray.intersectsSphere(Gs)===!1)return;nc.copy(i).invert(),es.copy(t.ray).applyMatrix4(nc);const a=o/((this.scale.x+this.scale.y+this.scale.z)/3),c=a*a,l=this.isLineSegments?2:1,h=n.index,d=n.attributes.position;if(h!==null){const f=Math.max(0,r.start),g=Math.min(h.count,r.start+r.count);for(let _=f,m=g-1;_<m;_+=l){const p=h.getX(_),y=h.getX(_+1),x=Vs(this,t,es,c,p,y);x&&e.push(x)}if(this.isLineLoop){const _=h.getX(g-1),m=h.getX(f),p=Vs(this,t,es,c,_,m);p&&e.push(p)}}else{const f=Math.max(0,r.start),g=Math.min(d.count,r.start+r.count);for(let _=f,m=g-1;_<m;_+=l){const p=Vs(this,t,es,c,_,_+1);p&&e.push(p)}if(this.isLineLoop){const _=Vs(this,t,es,c,g-1,f);_&&e.push(_)}}}updateMorphTargets(){const e=this.geometry.morphAttributes,n=Object.keys(e);if(n.length>0){const i=e[n[0]];if(i!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let o=0,r=i.length;o<r;o++){const a=i[o].name||String(o);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=o}}}}}function Vs(s,t,e,n,i,o){const r=s.geometry.attributes.position;if(so.fromBufferAttribute(r,i),oo.fromBufferAttribute(r,o),e.distanceSqToSegment(so,oo,tr,ic)>n)return;tr.applyMatrix4(s.matrixWorld);const c=t.ray.origin.distanceTo(tr);if(!(c<t.near||c>t.far))return{distance:c,point:ic.clone().applyMatrix4(s.matrixWorld),index:i,face:null,faceIndex:null,object:s}}class ii extends Se{constructor(t,e,n,i,o,r,a,c,l){super(t,e,n,i,o,r,a,c,l),this.isCanvasTexture=!0,this.needsUpdate=!0}}class fn{constructor(){this.type="Curve",this.arcLengthDivisions=200}getPoint(){return console.warn("THREE.Curve: .getPoint() not implemented."),null}getPointAt(t,e){const n=this.getUtoTmapping(t);return this.getPoint(n,e)}getPoints(t=5){const e=[];for(let n=0;n<=t;n++)e.push(this.getPoint(n/t));return e}getSpacedPoints(t=5){const e=[];for(let n=0;n<=t;n++)e.push(this.getPointAt(n/t));return e}getLength(){const t=this.getLengths();return t[t.length-1]}getLengths(t=this.arcLengthDivisions){if(this.cacheArcLengths&&this.cacheArcLengths.length===t+1&&!this.needsUpdate)return this.cacheArcLengths;this.needsUpdate=!1;const e=[];let n,i=this.getPoint(0),o=0;e.push(0);for(let r=1;r<=t;r++)n=this.getPoint(r/t),o+=n.distanceTo(i),e.push(o),i=n;return this.cacheArcLengths=e,e}updateArcLengths(){this.needsUpdate=!0,this.getLengths()}getUtoTmapping(t,e){const n=this.getLengths();let i=0;const o=n.length;let r;e?r=e:r=t*n[o-1];let a=0,c=o-1,l;for(;a<=c;)if(i=Math.floor(a+(c-a)/2),l=n[i]-r,l<0)a=i+1;else if(l>0)c=i-1;else{c=i;break}if(i=c,n[i]===r)return i/(o-1);const h=n[i],d=n[i+1]-h,f=(r-h)/d;return(i+f)/(o-1)}getTangent(t,e){let i=t-1e-4,o=t+1e-4;i<0&&(i=0),o>1&&(o=1);const r=this.getPoint(i),a=this.getPoint(o),c=e||(r.isVector2?new ht:new R);return c.copy(a).sub(r).normalize(),c}getTangentAt(t,e){const n=this.getUtoTmapping(t);return this.getTangent(n,e)}computeFrenetFrames(t,e){const n=new R,i=[],o=[],r=[],a=new R,c=new de;for(let f=0;f<=t;f++){const g=f/t;i[f]=this.getTangentAt(g,new R)}o[0]=new R,r[0]=new R;let l=Number.MAX_VALUE;const h=Math.abs(i[0].x),u=Math.abs(i[0].y),d=Math.abs(i[0].z);h<=l&&(l=h,n.set(1,0,0)),u<=l&&(l=u,n.set(0,1,0)),d<=l&&n.set(0,0,1),a.crossVectors(i[0],n).normalize(),o[0].crossVectors(i[0],a),r[0].crossVectors(i[0],o[0]);for(let f=1;f<=t;f++){if(o[f]=o[f-1].clone(),r[f]=r[f-1].clone(),a.crossVectors(i[f-1],i[f]),a.length()>Number.EPSILON){a.normalize();const g=Math.acos(ye(i[f-1].dot(i[f]),-1,1));o[f].applyMatrix4(c.makeRotationAxis(a,g))}r[f].crossVectors(i[f],o[f])}if(e===!0){let f=Math.acos(ye(o[0].dot(o[t]),-1,1));f/=t,i[0].dot(a.crossVectors(o[0],o[t]))>0&&(f=-f);for(let g=1;g<=t;g++)o[g].applyMatrix4(c.makeRotationAxis(i[g],f*g)),r[g].crossVectors(i[g],o[g])}return{tangents:i,normals:o,binormals:r}}clone(){return new this.constructor().copy(this)}copy(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}toJSON(){const t={metadata:{version:4.6,type:"Curve",generator:"Curve.toJSON"}};return t.arcLengthDivisions=this.arcLengthDivisions,t.type=this.type,t}fromJSON(t){return this.arcLengthDivisions=t.arcLengthDivisions,this}}class Cr extends fn{constructor(t=0,e=0,n=1,i=1,o=0,r=Math.PI*2,a=!1,c=0){super(),this.isEllipseCurve=!0,this.type="EllipseCurve",this.aX=t,this.aY=e,this.xRadius=n,this.yRadius=i,this.aStartAngle=o,this.aEndAngle=r,this.aClockwise=a,this.aRotation=c}getPoint(t,e=new ht){const n=e,i=Math.PI*2;let o=this.aEndAngle-this.aStartAngle;const r=Math.abs(o)<Number.EPSILON;for(;o<0;)o+=i;for(;o>i;)o-=i;o<Number.EPSILON&&(r?o=0:o=i),this.aClockwise===!0&&!r&&(o===i?o=-i:o=o-i);const a=this.aStartAngle+t*o;let c=this.aX+this.xRadius*Math.cos(a),l=this.aY+this.yRadius*Math.sin(a);if(this.aRotation!==0){const h=Math.cos(this.aRotation),u=Math.sin(this.aRotation),d=c-this.aX,f=l-this.aY;c=d*h-f*u+this.aX,l=d*u+f*h+this.aY}return n.set(c,l)}copy(t){return super.copy(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}toJSON(){const t=super.toJSON();return t.aX=this.aX,t.aY=this.aY,t.xRadius=this.xRadius,t.yRadius=this.yRadius,t.aStartAngle=this.aStartAngle,t.aEndAngle=this.aEndAngle,t.aClockwise=this.aClockwise,t.aRotation=this.aRotation,t}fromJSON(t){return super.fromJSON(t),this.aX=t.aX,this.aY=t.aY,this.xRadius=t.xRadius,this.yRadius=t.yRadius,this.aStartAngle=t.aStartAngle,this.aEndAngle=t.aEndAngle,this.aClockwise=t.aClockwise,this.aRotation=t.aRotation,this}}class Wm extends Cr{constructor(t,e,n,i,o,r){super(t,e,n,n,i,o,r),this.isArcCurve=!0,this.type="ArcCurve"}}function Rr(){let s=0,t=0,e=0,n=0;function i(o,r,a,c){s=o,t=a,e=-3*o+3*r-2*a-c,n=2*o-2*r+a+c}return{initCatmullRom:function(o,r,a,c,l){i(r,a,l*(a-o),l*(c-r))},initNonuniformCatmullRom:function(o,r,a,c,l,h,u){let d=(r-o)/l-(a-o)/(l+h)+(a-r)/h,f=(a-r)/h-(c-r)/(h+u)+(c-a)/u;d*=h,f*=h,i(r,a,d,f)},calc:function(o){const r=o*o,a=r*o;return s+t*o+e*r+n*a}}}const Ws=new R,er=new Rr,nr=new Rr,ir=new Rr;class Hi extends fn{constructor(t=[],e=!1,n="centripetal",i=.5){super(),this.isCatmullRomCurve3=!0,this.type="CatmullRomCurve3",this.points=t,this.closed=e,this.curveType=n,this.tension=i}getPoint(t,e=new R){const n=e,i=this.points,o=i.length,r=(o-(this.closed?0:1))*t;let a=Math.floor(r),c=r-a;this.closed?a+=a>0?0:(Math.floor(Math.abs(a)/o)+1)*o:c===0&&a===o-1&&(a=o-2,c=1);let l,h;this.closed||a>0?l=i[(a-1)%o]:(Ws.subVectors(i[0],i[1]).add(i[0]),l=Ws);const u=i[a%o],d=i[(a+1)%o];if(this.closed||a+2<o?h=i[(a+2)%o]:(Ws.subVectors(i[o-1],i[o-2]).add(i[o-1]),h=Ws),this.curveType==="centripetal"||this.curveType==="chordal"){const f=this.curveType==="chordal"?.5:.25;let g=Math.pow(l.distanceToSquared(u),f),_=Math.pow(u.distanceToSquared(d),f),m=Math.pow(d.distanceToSquared(h),f);_<1e-4&&(_=1),g<1e-4&&(g=_),m<1e-4&&(m=_),er.initNonuniformCatmullRom(l.x,u.x,d.x,h.x,g,_,m),nr.initNonuniformCatmullRom(l.y,u.y,d.y,h.y,g,_,m),ir.initNonuniformCatmullRom(l.z,u.z,d.z,h.z,g,_,m)}else this.curveType==="catmullrom"&&(er.initCatmullRom(l.x,u.x,d.x,h.x,this.tension),nr.initCatmullRom(l.y,u.y,d.y,h.y,this.tension),ir.initCatmullRom(l.z,u.z,d.z,h.z,this.tension));return n.set(er.calc(c),nr.calc(c),ir.calc(c)),n}copy(t){super.copy(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const i=t.points[e];this.points.push(i.clone())}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}toJSON(){const t=super.toJSON();t.points=[];for(let e=0,n=this.points.length;e<n;e++){const i=this.points[e];t.points.push(i.toArray())}return t.closed=this.closed,t.curveType=this.curveType,t.tension=this.tension,t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const i=t.points[e];this.points.push(new R().fromArray(i))}return this.closed=t.closed,this.curveType=t.curveType,this.tension=t.tension,this}}function sc(s,t,e,n,i){const o=(n-t)*.5,r=(i-e)*.5,a=s*s,c=s*a;return(2*e-2*n+o+r)*c+(-3*e+3*n-2*o-r)*a+o*s+e}function Xm(s,t){const e=1-s;return e*e*t}function Ym(s,t){return 2*(1-s)*s*t}function qm(s,t){return s*s*t}function cs(s,t,e,n){return Xm(s,t)+Ym(s,e)+qm(s,n)}function Zm(s,t){const e=1-s;return e*e*e*t}function jm(s,t){const e=1-s;return 3*e*e*s*t}function Km(s,t){return 3*(1-s)*s*s*t}function Jm(s,t){return s*s*s*t}function ls(s,t,e,n,i){return Zm(s,t)+jm(s,e)+Km(s,n)+Jm(s,i)}class tl extends fn{constructor(t=new ht,e=new ht,n=new ht,i=new ht){super(),this.isCubicBezierCurve=!0,this.type="CubicBezierCurve",this.v0=t,this.v1=e,this.v2=n,this.v3=i}getPoint(t,e=new ht){const n=e,i=this.v0,o=this.v1,r=this.v2,a=this.v3;return n.set(ls(t,i.x,o.x,r.x,a.x),ls(t,i.y,o.y,r.y,a.y)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}}class $m extends fn{constructor(t=new R,e=new R,n=new R,i=new R){super(),this.isCubicBezierCurve3=!0,this.type="CubicBezierCurve3",this.v0=t,this.v1=e,this.v2=n,this.v3=i}getPoint(t,e=new R){const n=e,i=this.v0,o=this.v1,r=this.v2,a=this.v3;return n.set(ls(t,i.x,o.x,r.x,a.x),ls(t,i.y,o.y,r.y,a.y),ls(t,i.z,o.z,r.z,a.z)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this.v3.copy(t.v3),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t.v3=this.v3.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this.v3.fromArray(t.v3),this}}class el extends fn{constructor(t=new ht,e=new ht){super(),this.isLineCurve=!0,this.type="LineCurve",this.v1=t,this.v2=e}getPoint(t,e=new ht){const n=e;return t===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(t).add(this.v1)),n}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new ht){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Qm extends fn{constructor(t=new R,e=new R){super(),this.isLineCurve3=!0,this.type="LineCurve3",this.v1=t,this.v2=e}getPoint(t,e=new R){const n=e;return t===1?n.copy(this.v2):(n.copy(this.v2).sub(this.v1),n.multiplyScalar(t).add(this.v1)),n}getPointAt(t,e){return this.getPoint(t,e)}getTangent(t,e=new R){return e.subVectors(this.v2,this.v1).normalize()}getTangentAt(t,e){return this.getTangent(t,e)}copy(t){return super.copy(t),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class nl extends fn{constructor(t=new ht,e=new ht,n=new ht){super(),this.isQuadraticBezierCurve=!0,this.type="QuadraticBezierCurve",this.v0=t,this.v1=e,this.v2=n}getPoint(t,e=new ht){const n=e,i=this.v0,o=this.v1,r=this.v2;return n.set(cs(t,i.x,o.x,r.x),cs(t,i.y,o.y,r.y)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class Yi extends fn{constructor(t=new R,e=new R,n=new R){super(),this.isQuadraticBezierCurve3=!0,this.type="QuadraticBezierCurve3",this.v0=t,this.v1=e,this.v2=n}getPoint(t,e=new R){const n=e,i=this.v0,o=this.v1,r=this.v2;return n.set(cs(t,i.x,o.x,r.x),cs(t,i.y,o.y,r.y),cs(t,i.z,o.z,r.z)),n}copy(t){return super.copy(t),this.v0.copy(t.v0),this.v1.copy(t.v1),this.v2.copy(t.v2),this}toJSON(){const t=super.toJSON();return t.v0=this.v0.toArray(),t.v1=this.v1.toArray(),t.v2=this.v2.toArray(),t}fromJSON(t){return super.fromJSON(t),this.v0.fromArray(t.v0),this.v1.fromArray(t.v1),this.v2.fromArray(t.v2),this}}class il extends fn{constructor(t=[]){super(),this.isSplineCurve=!0,this.type="SplineCurve",this.points=t}getPoint(t,e=new ht){const n=e,i=this.points,o=(i.length-1)*t,r=Math.floor(o),a=o-r,c=i[r===0?r:r-1],l=i[r],h=i[r>i.length-2?i.length-1:r+1],u=i[r>i.length-3?i.length-1:r+2];return n.set(sc(a,c.x,l.x,h.x,u.x),sc(a,c.y,l.y,h.y,u.y)),n}copy(t){super.copy(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const i=t.points[e];this.points.push(i.clone())}return this}toJSON(){const t=super.toJSON();t.points=[];for(let e=0,n=this.points.length;e<n;e++){const i=this.points[e];t.points.push(i.toArray())}return t}fromJSON(t){super.fromJSON(t),this.points=[];for(let e=0,n=t.points.length;e<n;e++){const i=t.points[e];this.points.push(new ht().fromArray(i))}return this}}var ro=Object.freeze({__proto__:null,ArcCurve:Wm,CatmullRomCurve3:Hi,CubicBezierCurve:tl,CubicBezierCurve3:$m,EllipseCurve:Cr,LineCurve:el,LineCurve3:Qm,QuadraticBezierCurve:nl,QuadraticBezierCurve3:Yi,SplineCurve:il});class t0 extends fn{constructor(){super(),this.type="CurvePath",this.curves=[],this.autoClose=!1}add(t){this.curves.push(t)}closePath(){const t=this.curves[0].getPoint(0),e=this.curves[this.curves.length-1].getPoint(1);if(!t.equals(e)){const n=t.isVector2===!0?"LineCurve":"LineCurve3";this.curves.push(new ro[n](e,t))}return this}getPoint(t,e){const n=t*this.getLength(),i=this.getCurveLengths();let o=0;for(;o<i.length;){if(i[o]>=n){const r=i[o]-n,a=this.curves[o],c=a.getLength(),l=c===0?0:1-r/c;return a.getPointAt(l,e)}o++}return null}getLength(){const t=this.getCurveLengths();return t[t.length-1]}updateArcLengths(){this.needsUpdate=!0,this.cacheLengths=null,this.getCurveLengths()}getCurveLengths(){if(this.cacheLengths&&this.cacheLengths.length===this.curves.length)return this.cacheLengths;const t=[];let e=0;for(let n=0,i=this.curves.length;n<i;n++)e+=this.curves[n].getLength(),t.push(e);return this.cacheLengths=t,t}getSpacedPoints(t=40){const e=[];for(let n=0;n<=t;n++)e.push(this.getPoint(n/t));return this.autoClose&&e.push(e[0]),e}getPoints(t=12){const e=[];let n;for(let i=0,o=this.curves;i<o.length;i++){const r=o[i],a=r.isEllipseCurve?t*2:r.isLineCurve||r.isLineCurve3?1:r.isSplineCurve?t*r.points.length:t,c=r.getPoints(a);for(let l=0;l<c.length;l++){const h=c[l];n&&n.equals(h)||(e.push(h),n=h)}}return this.autoClose&&e.length>1&&!e[e.length-1].equals(e[0])&&e.push(e[0]),e}copy(t){super.copy(t),this.curves=[];for(let e=0,n=t.curves.length;e<n;e++){const i=t.curves[e];this.curves.push(i.clone())}return this.autoClose=t.autoClose,this}toJSON(){const t=super.toJSON();t.autoClose=this.autoClose,t.curves=[];for(let e=0,n=this.curves.length;e<n;e++){const i=this.curves[e];t.curves.push(i.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.autoClose=t.autoClose,this.curves=[];for(let e=0,n=t.curves.length;e<n;e++){const i=t.curves[e];this.curves.push(new ro[i.type]().fromJSON(i))}return this}}class mr extends t0{constructor(t){super(),this.type="Path",this.currentPoint=new ht,t&&this.setFromPoints(t)}setFromPoints(t){this.moveTo(t[0].x,t[0].y);for(let e=1,n=t.length;e<n;e++)this.lineTo(t[e].x,t[e].y);return this}moveTo(t,e){return this.currentPoint.set(t,e),this}lineTo(t,e){const n=new el(this.currentPoint.clone(),new ht(t,e));return this.curves.push(n),this.currentPoint.set(t,e),this}quadraticCurveTo(t,e,n,i){const o=new nl(this.currentPoint.clone(),new ht(t,e),new ht(n,i));return this.curves.push(o),this.currentPoint.set(n,i),this}bezierCurveTo(t,e,n,i,o,r){const a=new tl(this.currentPoint.clone(),new ht(t,e),new ht(n,i),new ht(o,r));return this.curves.push(a),this.currentPoint.set(o,r),this}splineThru(t){const e=[this.currentPoint.clone()].concat(t),n=new il(e);return this.curves.push(n),this.currentPoint.copy(t[t.length-1]),this}arc(t,e,n,i,o,r){const a=this.currentPoint.x,c=this.currentPoint.y;return this.absarc(t+a,e+c,n,i,o,r),this}absarc(t,e,n,i,o,r){return this.absellipse(t,e,n,n,i,o,r),this}ellipse(t,e,n,i,o,r,a,c){const l=this.currentPoint.x,h=this.currentPoint.y;return this.absellipse(t+l,e+h,n,i,o,r,a,c),this}absellipse(t,e,n,i,o,r,a,c){const l=new Cr(t,e,n,i,o,r,a,c);if(this.curves.length>0){const u=l.getPoint(0);u.equals(this.currentPoint)||this.lineTo(u.x,u.y)}this.curves.push(l);const h=l.getPoint(1);return this.currentPoint.copy(h),this}copy(t){return super.copy(t),this.currentPoint.copy(t.currentPoint),this}toJSON(){const t=super.toJSON();return t.currentPoint=this.currentPoint.toArray(),t}fromJSON(t){return super.fromJSON(t),this.currentPoint.fromArray(t.currentPoint),this}}class go extends ge{constructor(t=[new ht(0,-.5),new ht(.5,0),new ht(0,.5)],e=12,n=0,i=Math.PI*2){super(),this.type="LatheGeometry",this.parameters={points:t,segments:e,phiStart:n,phiLength:i},e=Math.floor(e),i=ye(i,0,Math.PI*2);const o=[],r=[],a=[],c=[],l=[],h=1/e,u=new R,d=new ht,f=new R,g=new R,_=new R;let m=0,p=0;for(let y=0;y<=t.length-1;y++)switch(y){case 0:m=t[y+1].x-t[y].x,p=t[y+1].y-t[y].y,f.x=p*1,f.y=-m,f.z=p*0,_.copy(f),f.normalize(),c.push(f.x,f.y,f.z);break;case t.length-1:c.push(_.x,_.y,_.z);break;default:m=t[y+1].x-t[y].x,p=t[y+1].y-t[y].y,f.x=p*1,f.y=-m,f.z=p*0,g.copy(f),f.x+=_.x,f.y+=_.y,f.z+=_.z,f.normalize(),c.push(f.x,f.y,f.z),_.copy(g)}for(let y=0;y<=e;y++){const x=n+y*h*i,S=Math.sin(x),P=Math.cos(x);for(let A=0;A<=t.length-1;A++){u.x=t[A].x*S,u.y=t[A].y,u.z=t[A].x*P,r.push(u.x,u.y,u.z),d.x=y/e,d.y=A/(t.length-1),a.push(d.x,d.y);const C=c[3*A+0]*S,D=c[3*A+1],E=c[3*A+0]*P;l.push(C,D,E)}}for(let y=0;y<e;y++)for(let x=0;x<t.length-1;x++){const S=x+y*t.length,P=S,A=S+t.length,C=S+t.length+1,D=S+1;o.push(P,A,D),o.push(C,D,A)}this.setIndex(o),this.setAttribute("position",new oe(r,3)),this.setAttribute("uv",new oe(a,2)),this.setAttribute("normal",new oe(l,3))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new go(t.points,t.segments,t.phiStart,t.phiLength)}}class ao extends go{constructor(t=1,e=1,n=4,i=8){const o=new mr;o.absarc(0,-e/2,t,Math.PI*1.5,0),o.absarc(0,e/2,t,0,Math.PI*.5),super(o.getPoints(n),i),this.type="CapsuleGeometry",this.parameters={radius:t,length:e,capSegments:n,radialSegments:i}}static fromJSON(t){return new ao(t.radius,t.length,t.capSegments,t.radialSegments)}}class _o extends ge{constructor(t=1,e=32,n=0,i=Math.PI*2){super(),this.type="CircleGeometry",this.parameters={radius:t,segments:e,thetaStart:n,thetaLength:i},e=Math.max(3,e);const o=[],r=[],a=[],c=[],l=new R,h=new ht;r.push(0,0,0),a.push(0,0,1),c.push(.5,.5);for(let u=0,d=3;u<=e;u++,d+=3){const f=n+u/e*i;l.x=t*Math.cos(f),l.y=t*Math.sin(f),r.push(l.x,l.y,l.z),a.push(0,0,1),h.x=(r[d]/t+1)/2,h.y=(r[d+1]/t+1)/2,c.push(h.x,h.y)}for(let u=1;u<=e;u++)o.push(u,u+1,0);this.setIndex(o),this.setAttribute("position",new oe(r,3)),this.setAttribute("normal",new oe(a,3)),this.setAttribute("uv",new oe(c,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new _o(t.radius,t.segments,t.thetaStart,t.thetaLength)}}class pe extends ge{constructor(t=1,e=1,n=1,i=32,o=1,r=!1,a=0,c=Math.PI*2){super(),this.type="CylinderGeometry",this.parameters={radiusTop:t,radiusBottom:e,height:n,radialSegments:i,heightSegments:o,openEnded:r,thetaStart:a,thetaLength:c};const l=this;i=Math.floor(i),o=Math.floor(o);const h=[],u=[],d=[],f=[];let g=0;const _=[],m=n/2;let p=0;y(),r===!1&&(t>0&&x(!0),e>0&&x(!1)),this.setIndex(h),this.setAttribute("position",new oe(u,3)),this.setAttribute("normal",new oe(d,3)),this.setAttribute("uv",new oe(f,2));function y(){const S=new R,P=new R;let A=0;const C=(e-t)/n;for(let D=0;D<=o;D++){const E=[],M=D/o,I=M*(e-t)+t;for(let B=0;B<=i;B++){const L=B/i,W=L*c+a,U=Math.sin(W),K=Math.cos(W);P.x=I*U,P.y=-M*n+m,P.z=I*K,u.push(P.x,P.y,P.z),S.set(U,C,K).normalize(),d.push(S.x,S.y,S.z),f.push(L,1-M),E.push(g++)}_.push(E)}for(let D=0;D<i;D++)for(let E=0;E<o;E++){const M=_[E][D],I=_[E+1][D],B=_[E+1][D+1],L=_[E][D+1];h.push(M,I,L),h.push(I,B,L),A+=6}l.addGroup(p,A,0),p+=A}function x(S){const P=g,A=new ht,C=new R;let D=0;const E=S===!0?t:e,M=S===!0?1:-1;for(let B=1;B<=i;B++)u.push(0,m*M,0),d.push(0,M,0),f.push(.5,.5),g++;const I=g;for(let B=0;B<=i;B++){const W=B/i*c+a,U=Math.cos(W),K=Math.sin(W);C.x=E*K,C.y=m*M,C.z=E*U,u.push(C.x,C.y,C.z),d.push(0,M,0),A.x=U*.5+.5,A.y=K*.5*M+.5,f.push(A.x,A.y),g++}for(let B=0;B<i;B++){const L=P+B,W=I+B;S===!0?h.push(W,W+1,L):h.push(W+1,W,L),D+=3}l.addGroup(p,D,S===!0?1:2),p+=D}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new pe(t.radiusTop,t.radiusBottom,t.height,t.radialSegments,t.heightSegments,t.openEnded,t.thetaStart,t.thetaLength)}}class ai extends pe{constructor(t=1,e=1,n=32,i=1,o=!1,r=0,a=Math.PI*2){super(0,t,e,n,i,o,r,a),this.type="ConeGeometry",this.parameters={radius:t,height:e,radialSegments:n,heightSegments:i,openEnded:o,thetaStart:r,thetaLength:a}}static fromJSON(t){return new ai(t.radius,t.height,t.radialSegments,t.heightSegments,t.openEnded,t.thetaStart,t.thetaLength)}}class sl extends mr{constructor(t){super(t),this.uuid=hi(),this.type="Shape",this.holes=[]}getPointsHoles(t){const e=[];for(let n=0,i=this.holes.length;n<i;n++)e[n]=this.holes[n].getPoints(t);return e}extractPoints(t){return{shape:this.getPoints(t),holes:this.getPointsHoles(t)}}copy(t){super.copy(t),this.holes=[];for(let e=0,n=t.holes.length;e<n;e++){const i=t.holes[e];this.holes.push(i.clone())}return this}toJSON(){const t=super.toJSON();t.uuid=this.uuid,t.holes=[];for(let e=0,n=this.holes.length;e<n;e++){const i=this.holes[e];t.holes.push(i.toJSON())}return t}fromJSON(t){super.fromJSON(t),this.uuid=t.uuid,this.holes=[];for(let e=0,n=t.holes.length;e<n;e++){const i=t.holes[e];this.holes.push(new mr().fromJSON(i))}return this}}const e0={triangulate:function(s,t,e=2){const n=t&&t.length,i=n?t[0]*e:s.length;let o=ol(s,0,i,e,!0);const r=[];if(!o||o.next===o.prev)return r;let a,c,l,h,u,d,f;if(n&&(o=r0(s,t,o,e)),s.length>80*e){a=l=s[0],c=h=s[1];for(let g=e;g<i;g+=e)u=s[g],d=s[g+1],u<a&&(a=u),d<c&&(c=d),u>l&&(l=u),d>h&&(h=d);f=Math.max(l-a,h-c),f=f!==0?32767/f:0}return fs(o,r,e,a,c,f,0),r}};function ol(s,t,e,n,i){let o,r;if(i===_0(s,t,e,n)>0)for(o=t;o<e;o+=n)r=oc(o,s[o],s[o+1],r);else for(o=e-n;o>=t;o-=n)r=oc(o,s[o],s[o+1],r);return r&&xo(r,r.next)&&(ms(r),r=r.next),r}function ci(s,t){if(!s)return s;t||(t=s);let e=s,n;do if(n=!1,!e.steiner&&(xo(e,e.next)||xe(e.prev,e,e.next)===0)){if(ms(e),e=t=e.prev,e===e.next)break;n=!0}else e=e.next;while(n||e!==t);return t}function fs(s,t,e,n,i,o,r){if(!s)return;!r&&o&&u0(s,n,i,o);let a=s,c,l;for(;s.prev!==s.next;){if(c=s.prev,l=s.next,o?i0(s,n,i,o):n0(s)){t.push(c.i/e|0),t.push(s.i/e|0),t.push(l.i/e|0),ms(s),s=l.next,a=l.next;continue}if(s=l,s===a){r?r===1?(s=s0(ci(s),t,e),fs(s,t,e,n,i,o,2)):r===2&&o0(s,t,e,n,i,o):fs(ci(s),t,e,n,i,o,1);break}}}function n0(s){const t=s.prev,e=s,n=s.next;if(xe(t,e,n)>=0)return!1;const i=t.x,o=e.x,r=n.x,a=t.y,c=e.y,l=n.y,h=i<o?i<r?i:r:o<r?o:r,u=a<c?a<l?a:l:c<l?c:l,d=i>o?i>r?i:r:o>r?o:r,f=a>c?a>l?a:l:c>l?c:l;let g=n.next;for(;g!==t;){if(g.x>=h&&g.x<=d&&g.y>=u&&g.y<=f&&zi(i,a,o,c,r,l,g.x,g.y)&&xe(g.prev,g,g.next)>=0)return!1;g=g.next}return!0}function i0(s,t,e,n){const i=s.prev,o=s,r=s.next;if(xe(i,o,r)>=0)return!1;const a=i.x,c=o.x,l=r.x,h=i.y,u=o.y,d=r.y,f=a<c?a<l?a:l:c<l?c:l,g=h<u?h<d?h:d:u<d?u:d,_=a>c?a>l?a:l:c>l?c:l,m=h>u?h>d?h:d:u>d?u:d,p=gr(f,g,t,e,n),y=gr(_,m,t,e,n);let x=s.prevZ,S=s.nextZ;for(;x&&x.z>=p&&S&&S.z<=y;){if(x.x>=f&&x.x<=_&&x.y>=g&&x.y<=m&&x!==i&&x!==r&&zi(a,h,c,u,l,d,x.x,x.y)&&xe(x.prev,x,x.next)>=0||(x=x.prevZ,S.x>=f&&S.x<=_&&S.y>=g&&S.y<=m&&S!==i&&S!==r&&zi(a,h,c,u,l,d,S.x,S.y)&&xe(S.prev,S,S.next)>=0))return!1;S=S.nextZ}for(;x&&x.z>=p;){if(x.x>=f&&x.x<=_&&x.y>=g&&x.y<=m&&x!==i&&x!==r&&zi(a,h,c,u,l,d,x.x,x.y)&&xe(x.prev,x,x.next)>=0)return!1;x=x.prevZ}for(;S&&S.z<=y;){if(S.x>=f&&S.x<=_&&S.y>=g&&S.y<=m&&S!==i&&S!==r&&zi(a,h,c,u,l,d,S.x,S.y)&&xe(S.prev,S,S.next)>=0)return!1;S=S.nextZ}return!0}function s0(s,t,e){let n=s;do{const i=n.prev,o=n.next.next;!xo(i,o)&&rl(i,n,n.next,o)&&ps(i,o)&&ps(o,i)&&(t.push(i.i/e|0),t.push(n.i/e|0),t.push(o.i/e|0),ms(n),ms(n.next),n=s=o),n=n.next}while(n!==s);return ci(n)}function o0(s,t,e,n,i,o){let r=s;do{let a=r.next.next;for(;a!==r.prev;){if(r.i!==a.i&&p0(r,a)){let c=al(r,a);r=ci(r,r.next),c=ci(c,c.next),fs(r,t,e,n,i,o,0),fs(c,t,e,n,i,o,0);return}a=a.next}r=r.next}while(r!==s)}function r0(s,t,e,n){const i=[];let o,r,a,c,l;for(o=0,r=t.length;o<r;o++)a=t[o]*n,c=o<r-1?t[o+1]*n:s.length,l=ol(s,a,c,n,!1),l===l.next&&(l.steiner=!0),i.push(f0(l));for(i.sort(a0),o=0;o<i.length;o++)e=c0(i[o],e);return e}function a0(s,t){return s.x-t.x}function c0(s,t){const e=l0(s,t);if(!e)return t;const n=al(e,s);return ci(n,n.next),ci(e,e.next)}function l0(s,t){let e=t,n=-1/0,i;const o=s.x,r=s.y;do{if(r<=e.y&&r>=e.next.y&&e.next.y!==e.y){const d=e.x+(r-e.y)*(e.next.x-e.x)/(e.next.y-e.y);if(d<=o&&d>n&&(n=d,i=e.x<e.next.x?e:e.next,d===o))return i}e=e.next}while(e!==t);if(!i)return null;const a=i,c=i.x,l=i.y;let h=1/0,u;e=i;do o>=e.x&&e.x>=c&&o!==e.x&&zi(r<l?o:n,r,c,l,r<l?n:o,r,e.x,e.y)&&(u=Math.abs(r-e.y)/(o-e.x),ps(e,s)&&(u<h||u===h&&(e.x>i.x||e.x===i.x&&h0(i,e)))&&(i=e,h=u)),e=e.next;while(e!==a);return i}function h0(s,t){return xe(s.prev,s,t.prev)<0&&xe(t.next,s,s.next)<0}function u0(s,t,e,n){let i=s;do i.z===0&&(i.z=gr(i.x,i.y,t,e,n)),i.prevZ=i.prev,i.nextZ=i.next,i=i.next;while(i!==s);i.prevZ.nextZ=null,i.prevZ=null,d0(i)}function d0(s){let t,e,n,i,o,r,a,c,l=1;do{for(e=s,s=null,o=null,r=0;e;){for(r++,n=e,a=0,t=0;t<l&&(a++,n=n.nextZ,!!n);t++);for(c=l;a>0||c>0&&n;)a!==0&&(c===0||!n||e.z<=n.z)?(i=e,e=e.nextZ,a--):(i=n,n=n.nextZ,c--),o?o.nextZ=i:s=i,i.prevZ=o,o=i;e=n}o.nextZ=null,l*=2}while(r>1);return s}function gr(s,t,e,n,i){return s=(s-e)*i|0,t=(t-n)*i|0,s=(s|s<<8)&16711935,s=(s|s<<4)&252645135,s=(s|s<<2)&858993459,s=(s|s<<1)&1431655765,t=(t|t<<8)&16711935,t=(t|t<<4)&252645135,t=(t|t<<2)&858993459,t=(t|t<<1)&1431655765,s|t<<1}function f0(s){let t=s,e=s;do(t.x<e.x||t.x===e.x&&t.y<e.y)&&(e=t),t=t.next;while(t!==s);return e}function zi(s,t,e,n,i,o,r,a){return(i-r)*(t-a)>=(s-r)*(o-a)&&(s-r)*(n-a)>=(e-r)*(t-a)&&(e-r)*(o-a)>=(i-r)*(n-a)}function p0(s,t){return s.next.i!==t.i&&s.prev.i!==t.i&&!m0(s,t)&&(ps(s,t)&&ps(t,s)&&g0(s,t)&&(xe(s.prev,s,t.prev)||xe(s,t.prev,t))||xo(s,t)&&xe(s.prev,s,s.next)>0&&xe(t.prev,t,t.next)>0)}function xe(s,t,e){return(t.y-s.y)*(e.x-t.x)-(t.x-s.x)*(e.y-t.y)}function xo(s,t){return s.x===t.x&&s.y===t.y}function rl(s,t,e,n){const i=Ys(xe(s,t,e)),o=Ys(xe(s,t,n)),r=Ys(xe(e,n,s)),a=Ys(xe(e,n,t));return!!(i!==o&&r!==a||i===0&&Xs(s,e,t)||o===0&&Xs(s,n,t)||r===0&&Xs(e,s,n)||a===0&&Xs(e,t,n))}function Xs(s,t,e){return t.x<=Math.max(s.x,e.x)&&t.x>=Math.min(s.x,e.x)&&t.y<=Math.max(s.y,e.y)&&t.y>=Math.min(s.y,e.y)}function Ys(s){return s>0?1:s<0?-1:0}function m0(s,t){let e=s;do{if(e.i!==s.i&&e.next.i!==s.i&&e.i!==t.i&&e.next.i!==t.i&&rl(e,e.next,s,t))return!0;e=e.next}while(e!==s);return!1}function ps(s,t){return xe(s.prev,s,s.next)<0?xe(s,t,s.next)>=0&&xe(s,s.prev,t)>=0:xe(s,t,s.prev)<0||xe(s,s.next,t)<0}function g0(s,t){let e=s,n=!1;const i=(s.x+t.x)/2,o=(s.y+t.y)/2;do e.y>o!=e.next.y>o&&e.next.y!==e.y&&i<(e.next.x-e.x)*(o-e.y)/(e.next.y-e.y)+e.x&&(n=!n),e=e.next;while(e!==s);return n}function al(s,t){const e=new _r(s.i,s.x,s.y),n=new _r(t.i,t.x,t.y),i=s.next,o=t.prev;return s.next=t,t.prev=s,e.next=i,i.prev=e,n.next=e,e.prev=n,o.next=n,n.prev=o,n}function oc(s,t,e,n){const i=new _r(s,t,e);return n?(i.next=n.next,i.prev=n,n.next.prev=i,n.next=i):(i.prev=i,i.next=i),i}function ms(s){s.next.prev=s.prev,s.prev.next=s.next,s.prevZ&&(s.prevZ.nextZ=s.nextZ),s.nextZ&&(s.nextZ.prevZ=s.prevZ)}function _r(s,t,e){this.i=s,this.x=t,this.y=e,this.prev=null,this.next=null,this.z=0,this.prevZ=null,this.nextZ=null,this.steiner=!1}function _0(s,t,e,n){let i=0;for(let o=t,r=e-n;o<e;o+=n)i+=(s[r]-s[o])*(s[o+1]+s[r+1]),r=o;return i}class hs{static area(t){const e=t.length;let n=0;for(let i=e-1,o=0;o<e;i=o++)n+=t[i].x*t[o].y-t[o].x*t[i].y;return n*.5}static isClockWise(t){return hs.area(t)<0}static triangulateShape(t,e){const n=[],i=[],o=[];rc(t),ac(n,t);let r=t.length;e.forEach(rc);for(let c=0;c<e.length;c++)i.push(r),r+=e[c].length,ac(n,e[c]);const a=e0.triangulate(n,i);for(let c=0;c<a.length;c+=3)o.push(a.slice(c,c+3));return o}}function rc(s){const t=s.length;t>2&&s[t-1].equals(s[0])&&s.pop()}function ac(s,t){for(let e=0;e<t.length;e++)s.push(t[e].x),s.push(t[e].y)}class Pr extends ge{constructor(t=new sl([new ht(.5,.5),new ht(-.5,.5),new ht(-.5,-.5),new ht(.5,-.5)]),e={}){super(),this.type="ExtrudeGeometry",this.parameters={shapes:t,options:e},t=Array.isArray(t)?t:[t];const n=this,i=[],o=[];for(let a=0,c=t.length;a<c;a++){const l=t[a];r(l)}this.setAttribute("position",new oe(i,3)),this.setAttribute("uv",new oe(o,2)),this.computeVertexNormals();function r(a){const c=[],l=e.curveSegments!==void 0?e.curveSegments:12,h=e.steps!==void 0?e.steps:1,u=e.depth!==void 0?e.depth:1;let d=e.bevelEnabled!==void 0?e.bevelEnabled:!0,f=e.bevelThickness!==void 0?e.bevelThickness:.2,g=e.bevelSize!==void 0?e.bevelSize:f-.1,_=e.bevelOffset!==void 0?e.bevelOffset:0,m=e.bevelSegments!==void 0?e.bevelSegments:3;const p=e.extrudePath,y=e.UVGenerator!==void 0?e.UVGenerator:x0;let x,S=!1,P,A,C,D;p&&(x=p.getSpacedPoints(h),S=!0,d=!1,P=p.computeFrenetFrames(h,!1),A=new R,C=new R,D=new R),d||(m=0,f=0,g=0,_=0);const E=a.extractPoints(l);let M=E.shape;const I=E.holes;if(!hs.isClockWise(M)){M=M.reverse();for(let Q=0,dt=I.length;Q<dt;Q++){const nt=I[Q];hs.isClockWise(nt)&&(I[Q]=nt.reverse())}}const L=hs.triangulateShape(M,I),W=M;for(let Q=0,dt=I.length;Q<dt;Q++){const nt=I[Q];M=M.concat(nt)}function U(Q,dt,nt){return dt||console.error("THREE.ExtrudeGeometry: vec does not exist"),Q.clone().addScaledVector(dt,nt)}const K=M.length,it=L.length;function k(Q,dt,nt){let J,X,at;const yt=Q.x-dt.x,T=Q.y-dt.y,w=nt.x-Q.x,F=nt.y-Q.y,Y=yt*yt+T*T,ot=yt*F-T*w;if(Math.abs(ot)>Number.EPSILON){const tt=Math.sqrt(Y),bt=Math.sqrt(w*w+F*F),gt=dt.x-T/tt,ct=dt.y+yt/tt,Rt=nt.x-F/bt,xt=nt.y+w/bt,ft=((Rt-gt)*F-(xt-ct)*w)/(yt*F-T*w);J=gt+yt*ft-Q.x,X=ct+T*ft-Q.y;const St=J*J+X*X;if(St<=2)return new ht(J,X);at=Math.sqrt(St/2)}else{let tt=!1;yt>Number.EPSILON?w>Number.EPSILON&&(tt=!0):yt<-Number.EPSILON?w<-Number.EPSILON&&(tt=!0):Math.sign(T)===Math.sign(F)&&(tt=!0),tt?(J=-T,X=yt,at=Math.sqrt(Y)):(J=yt,X=T,at=Math.sqrt(Y/2))}return new ht(J/at,X/at)}const $=[];for(let Q=0,dt=W.length,nt=dt-1,J=Q+1;Q<dt;Q++,nt++,J++)nt===dt&&(nt=0),J===dt&&(J=0),$[Q]=k(W[Q],W[nt],W[J]);const et=[];let mt,Lt=$.concat();for(let Q=0,dt=I.length;Q<dt;Q++){const nt=I[Q];mt=[];for(let J=0,X=nt.length,at=X-1,yt=J+1;J<X;J++,at++,yt++)at===X&&(at=0),yt===X&&(yt=0),mt[J]=k(nt[J],nt[at],nt[yt]);et.push(mt),Lt=Lt.concat(mt)}for(let Q=0;Q<m;Q++){const dt=Q/m,nt=f*Math.cos(dt*Math.PI/2),J=g*Math.sin(dt*Math.PI/2)+_;for(let X=0,at=W.length;X<at;X++){const yt=U(W[X],$[X],J);_t(yt.x,yt.y,-nt)}for(let X=0,at=I.length;X<at;X++){const yt=I[X];mt=et[X];for(let T=0,w=yt.length;T<w;T++){const F=U(yt[T],mt[T],J);_t(F.x,F.y,-nt)}}}const Nt=g+_;for(let Q=0;Q<K;Q++){const dt=d?U(M[Q],Lt[Q],Nt):M[Q];S?(C.copy(P.normals[0]).multiplyScalar(dt.x),A.copy(P.binormals[0]).multiplyScalar(dt.y),D.copy(x[0]).add(C).add(A),_t(D.x,D.y,D.z)):_t(dt.x,dt.y,0)}for(let Q=1;Q<=h;Q++)for(let dt=0;dt<K;dt++){const nt=d?U(M[dt],Lt[dt],Nt):M[dt];S?(C.copy(P.normals[Q]).multiplyScalar(nt.x),A.copy(P.binormals[Q]).multiplyScalar(nt.y),D.copy(x[Q]).add(C).add(A),_t(D.x,D.y,D.z)):_t(nt.x,nt.y,u/h*Q)}for(let Q=m-1;Q>=0;Q--){const dt=Q/m,nt=f*Math.cos(dt*Math.PI/2),J=g*Math.sin(dt*Math.PI/2)+_;for(let X=0,at=W.length;X<at;X++){const yt=U(W[X],$[X],J);_t(yt.x,yt.y,u+nt)}for(let X=0,at=I.length;X<at;X++){const yt=I[X];mt=et[X];for(let T=0,w=yt.length;T<w;T++){const F=U(yt[T],mt[T],J);S?_t(F.x,F.y+x[h-1].y,x[h-1].x+nt):_t(F.x,F.y,u+nt)}}}j(),ut();function j(){const Q=i.length/3;if(d){let dt=0,nt=K*dt;for(let J=0;J<it;J++){const X=L[J];Ft(X[2]+nt,X[1]+nt,X[0]+nt)}dt=h+m*2,nt=K*dt;for(let J=0;J<it;J++){const X=L[J];Ft(X[0]+nt,X[1]+nt,X[2]+nt)}}else{for(let dt=0;dt<it;dt++){const nt=L[dt];Ft(nt[2],nt[1],nt[0])}for(let dt=0;dt<it;dt++){const nt=L[dt];Ft(nt[0]+K*h,nt[1]+K*h,nt[2]+K*h)}}n.addGroup(Q,i.length/3-Q,0)}function ut(){const Q=i.length/3;let dt=0;Et(W,dt),dt+=W.length;for(let nt=0,J=I.length;nt<J;nt++){const X=I[nt];Et(X,dt),dt+=X.length}n.addGroup(Q,i.length/3-Q,1)}function Et(Q,dt){let nt=Q.length;for(;--nt>=0;){const J=nt;let X=nt-1;X<0&&(X=Q.length-1);for(let at=0,yt=h+m*2;at<yt;at++){const T=K*at,w=K*(at+1),F=dt+J+T,Y=dt+X+T,ot=dt+X+w,tt=dt+J+w;zt(F,Y,ot,tt)}}}function _t(Q,dt,nt){c.push(Q),c.push(dt),c.push(nt)}function Ft(Q,dt,nt){N(Q),N(dt),N(nt);const J=i.length/3,X=y.generateTopUV(n,i,J-3,J-2,J-1);Gt(X[0]),Gt(X[1]),Gt(X[2])}function zt(Q,dt,nt,J){N(Q),N(dt),N(J),N(dt),N(nt),N(J);const X=i.length/3,at=y.generateSideWallUV(n,i,X-6,X-3,X-2,X-1);Gt(at[0]),Gt(at[1]),Gt(at[3]),Gt(at[1]),Gt(at[2]),Gt(at[3])}function N(Q){i.push(c[Q*3+0]),i.push(c[Q*3+1]),i.push(c[Q*3+2])}function Gt(Q){o.push(Q.x),o.push(Q.y)}}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}toJSON(){const t=super.toJSON(),e=this.parameters.shapes,n=this.parameters.options;return v0(e,n,t)}static fromJSON(t,e){const n=[];for(let o=0,r=t.shapes.length;o<r;o++){const a=e[t.shapes[o]];n.push(a)}const i=t.options.extrudePath;return i!==void 0&&(t.options.extrudePath=new ro[i.type]().fromJSON(i)),new Pr(n,t.options)}}const x0={generateTopUV:function(s,t,e,n,i){const o=t[e*3],r=t[e*3+1],a=t[n*3],c=t[n*3+1],l=t[i*3],h=t[i*3+1];return[new ht(o,r),new ht(a,c),new ht(l,h)]},generateSideWallUV:function(s,t,e,n,i,o){const r=t[e*3],a=t[e*3+1],c=t[e*3+2],l=t[n*3],h=t[n*3+1],u=t[n*3+2],d=t[i*3],f=t[i*3+1],g=t[i*3+2],_=t[o*3],m=t[o*3+1],p=t[o*3+2];return Math.abs(a-h)<Math.abs(r-l)?[new ht(r,1-c),new ht(l,1-u),new ht(d,1-g),new ht(_,1-p)]:[new ht(a,1-c),new ht(h,1-u),new ht(f,1-g),new ht(m,1-p)]}};function v0(s,t,e){if(e.shapes=[],Array.isArray(s))for(let n=0,i=s.length;n<i;n++){const o=s[n];e.shapes.push(o.uuid)}else e.shapes.push(s.uuid);return e.options=Object.assign({},t),t.extrudePath!==void 0&&(e.options.extrudePath=t.extrudePath.toJSON()),e}class qt extends ge{constructor(t=1,e=32,n=16,i=0,o=Math.PI*2,r=0,a=Math.PI){super(),this.type="SphereGeometry",this.parameters={radius:t,widthSegments:e,heightSegments:n,phiStart:i,phiLength:o,thetaStart:r,thetaLength:a},e=Math.max(3,Math.floor(e)),n=Math.max(2,Math.floor(n));const c=Math.min(r+a,Math.PI);let l=0;const h=[],u=new R,d=new R,f=[],g=[],_=[],m=[];for(let p=0;p<=n;p++){const y=[],x=p/n;let S=0;p===0&&r===0?S=.5/e:p===n&&c===Math.PI&&(S=-.5/e);for(let P=0;P<=e;P++){const A=P/e;u.x=-t*Math.cos(i+A*o)*Math.sin(r+x*a),u.y=t*Math.cos(r+x*a),u.z=t*Math.sin(i+A*o)*Math.sin(r+x*a),g.push(u.x,u.y,u.z),d.copy(u).normalize(),_.push(d.x,d.y,d.z),m.push(A+S,1-x),y.push(l++)}h.push(y)}for(let p=0;p<n;p++)for(let y=0;y<e;y++){const x=h[p][y+1],S=h[p][y],P=h[p+1][y],A=h[p+1][y+1];(p!==0||r>0)&&f.push(x,S,A),(p!==n-1||c<Math.PI)&&f.push(S,P,A)}this.setIndex(f),this.setAttribute("position",new oe(g,3)),this.setAttribute("normal",new oe(_,3)),this.setAttribute("uv",new oe(m,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new qt(t.radius,t.widthSegments,t.heightSegments,t.phiStart,t.phiLength,t.thetaStart,t.thetaLength)}}class On extends ge{constructor(t=1,e=.4,n=12,i=48,o=Math.PI*2){super(),this.type="TorusGeometry",this.parameters={radius:t,tube:e,radialSegments:n,tubularSegments:i,arc:o},n=Math.floor(n),i=Math.floor(i);const r=[],a=[],c=[],l=[],h=new R,u=new R,d=new R;for(let f=0;f<=n;f++)for(let g=0;g<=i;g++){const _=g/i*o,m=f/n*Math.PI*2;u.x=(t+e*Math.cos(m))*Math.cos(_),u.y=(t+e*Math.cos(m))*Math.sin(_),u.z=e*Math.sin(m),a.push(u.x,u.y,u.z),h.x=t*Math.cos(_),h.y=t*Math.sin(_),d.subVectors(u,h).normalize(),c.push(d.x,d.y,d.z),l.push(g/i),l.push(f/n)}for(let f=1;f<=n;f++)for(let g=1;g<=i;g++){const _=(i+1)*f+g-1,m=(i+1)*(f-1)+g-1,p=(i+1)*(f-1)+g,y=(i+1)*f+g;r.push(_,m,y),r.push(m,p,y)}this.setIndex(r),this.setAttribute("position",new oe(a,3)),this.setAttribute("normal",new oe(c,3)),this.setAttribute("uv",new oe(l,2))}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}static fromJSON(t){return new On(t.radius,t.tube,t.radialSegments,t.tubularSegments,t.arc)}}class si extends ge{constructor(t=new Yi(new R(-1,-1,0),new R(-1,1,0),new R(1,1,0)),e=64,n=1,i=8,o=!1){super(),this.type="TubeGeometry",this.parameters={path:t,tubularSegments:e,radius:n,radialSegments:i,closed:o};const r=t.computeFrenetFrames(e,o);this.tangents=r.tangents,this.normals=r.normals,this.binormals=r.binormals;const a=new R,c=new R,l=new ht;let h=new R;const u=[],d=[],f=[],g=[];_(),this.setIndex(g),this.setAttribute("position",new oe(u,3)),this.setAttribute("normal",new oe(d,3)),this.setAttribute("uv",new oe(f,2));function _(){for(let x=0;x<e;x++)m(x);m(o===!1?e:0),y(),p()}function m(x){h=t.getPointAt(x/e,h);const S=r.normals[x],P=r.binormals[x];for(let A=0;A<=i;A++){const C=A/i*Math.PI*2,D=Math.sin(C),E=-Math.cos(C);c.x=E*S.x+D*P.x,c.y=E*S.y+D*P.y,c.z=E*S.z+D*P.z,c.normalize(),d.push(c.x,c.y,c.z),a.x=h.x+n*c.x,a.y=h.y+n*c.y,a.z=h.z+n*c.z,u.push(a.x,a.y,a.z)}}function p(){for(let x=1;x<=e;x++)for(let S=1;S<=i;S++){const P=(i+1)*(x-1)+(S-1),A=(i+1)*x+(S-1),C=(i+1)*x+S,D=(i+1)*(x-1)+S;g.push(P,A,D),g.push(A,C,D)}}function y(){for(let x=0;x<=e;x++)for(let S=0;S<=i;S++)l.x=x/e,l.y=S/i,f.push(l.x,l.y)}}copy(t){return super.copy(t),this.parameters=Object.assign({},t.parameters),this}toJSON(){const t=super.toJSON();return t.path=this.parameters.path.toJSON(),t}static fromJSON(t){return new si(new ro[t.path.type]().fromJSON(t.path),t.tubularSegments,t.radius,t.radialSegments,t.closed)}}class Ct extends qi{constructor(t){super(),this.isMeshStandardMaterial=!0,this.defines={STANDARD:""},this.type="MeshStandardMaterial",this.color=new jt(16777215),this.roughness=1,this.metalness=0,this.map=null,this.lightMap=null,this.lightMapIntensity=1,this.aoMap=null,this.aoMapIntensity=1,this.emissive=new jt(0),this.emissiveIntensity=1,this.emissiveMap=null,this.bumpMap=null,this.bumpScale=1,this.normalMap=null,this.normalMapType=Nc,this.normalScale=new ht(1,1),this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.roughnessMap=null,this.metalnessMap=null,this.alphaMap=null,this.envMap=null,this.envMapRotation=new dn,this.envMapIntensity=1,this.wireframe=!1,this.wireframeLinewidth=1,this.wireframeLinecap="round",this.wireframeLinejoin="round",this.flatShading=!1,this.fog=!0,this.setValues(t)}copy(t){return super.copy(t),this.defines={STANDARD:""},this.color.copy(t.color),this.roughness=t.roughness,this.metalness=t.metalness,this.map=t.map,this.lightMap=t.lightMap,this.lightMapIntensity=t.lightMapIntensity,this.aoMap=t.aoMap,this.aoMapIntensity=t.aoMapIntensity,this.emissive.copy(t.emissive),this.emissiveMap=t.emissiveMap,this.emissiveIntensity=t.emissiveIntensity,this.bumpMap=t.bumpMap,this.bumpScale=t.bumpScale,this.normalMap=t.normalMap,this.normalMapType=t.normalMapType,this.normalScale.copy(t.normalScale),this.displacementMap=t.displacementMap,this.displacementScale=t.displacementScale,this.displacementBias=t.displacementBias,this.roughnessMap=t.roughnessMap,this.metalnessMap=t.metalnessMap,this.alphaMap=t.alphaMap,this.envMap=t.envMap,this.envMapRotation.copy(t.envMapRotation),this.envMapIntensity=t.envMapIntensity,this.wireframe=t.wireframe,this.wireframeLinewidth=t.wireframeLinewidth,this.wireframeLinecap=t.wireframeLinecap,this.wireframeLinejoin=t.wireframeLinejoin,this.flatShading=t.flatShading,this.fog=t.fog,this}}class cl extends Ct{constructor(t){super(),this.isMeshPhysicalMaterial=!0,this.defines={STANDARD:"",PHYSICAL:""},this.type="MeshPhysicalMaterial",this.anisotropyRotation=0,this.anisotropyMap=null,this.clearcoatMap=null,this.clearcoatRoughness=0,this.clearcoatRoughnessMap=null,this.clearcoatNormalScale=new ht(1,1),this.clearcoatNormalMap=null,this.ior=1.5,Object.defineProperty(this,"reflectivity",{get:function(){return ye(2.5*(this.ior-1)/(this.ior+1),0,1)},set:function(e){this.ior=(1+.4*e)/(1-.4*e)}}),this.iridescenceMap=null,this.iridescenceIOR=1.3,this.iridescenceThicknessRange=[100,400],this.iridescenceThicknessMap=null,this.sheenColor=new jt(0),this.sheenColorMap=null,this.sheenRoughness=1,this.sheenRoughnessMap=null,this.transmissionMap=null,this.thickness=0,this.thicknessMap=null,this.attenuationDistance=1/0,this.attenuationColor=new jt(1,1,1),this.specularIntensity=1,this.specularIntensityMap=null,this.specularColor=new jt(1,1,1),this.specularColorMap=null,this._anisotropy=0,this._clearcoat=0,this._dispersion=0,this._iridescence=0,this._sheen=0,this._transmission=0,this.setValues(t)}get anisotropy(){return this._anisotropy}set anisotropy(t){this._anisotropy>0!=t>0&&this.version++,this._anisotropy=t}get clearcoat(){return this._clearcoat}set clearcoat(t){this._clearcoat>0!=t>0&&this.version++,this._clearcoat=t}get iridescence(){return this._iridescence}set iridescence(t){this._iridescence>0!=t>0&&this.version++,this._iridescence=t}get dispersion(){return this._dispersion}set dispersion(t){this._dispersion>0!=t>0&&this.version++,this._dispersion=t}get sheen(){return this._sheen}set sheen(t){this._sheen>0!=t>0&&this.version++,this._sheen=t}get transmission(){return this._transmission}set transmission(t){this._transmission>0!=t>0&&this.version++,this._transmission=t}copy(t){return super.copy(t),this.defines={STANDARD:"",PHYSICAL:""},this.anisotropy=t.anisotropy,this.anisotropyRotation=t.anisotropyRotation,this.anisotropyMap=t.anisotropyMap,this.clearcoat=t.clearcoat,this.clearcoatMap=t.clearcoatMap,this.clearcoatRoughness=t.clearcoatRoughness,this.clearcoatRoughnessMap=t.clearcoatRoughnessMap,this.clearcoatNormalMap=t.clearcoatNormalMap,this.clearcoatNormalScale.copy(t.clearcoatNormalScale),this.dispersion=t.dispersion,this.ior=t.ior,this.iridescence=t.iridescence,this.iridescenceMap=t.iridescenceMap,this.iridescenceIOR=t.iridescenceIOR,this.iridescenceThicknessRange=[...t.iridescenceThicknessRange],this.iridescenceThicknessMap=t.iridescenceThicknessMap,this.sheen=t.sheen,this.sheenColor.copy(t.sheenColor),this.sheenColorMap=t.sheenColorMap,this.sheenRoughness=t.sheenRoughness,this.sheenRoughnessMap=t.sheenRoughnessMap,this.transmission=t.transmission,this.transmissionMap=t.transmissionMap,this.thickness=t.thickness,this.thicknessMap=t.thicknessMap,this.attenuationDistance=t.attenuationDistance,this.attenuationColor.copy(t.attenuationColor),this.specularIntensity=t.specularIntensity,this.specularIntensityMap=t.specularIntensityMap,this.specularColor.copy(t.specularColor),this.specularColorMap=t.specularColorMap,this}}class vo extends Re{constructor(t,e=1){super(),this.isLight=!0,this.type="Light",this.color=new jt(t),this.intensity=e}dispose(){}copy(t,e){return super.copy(t,e),this.color.copy(t.color),this.intensity=t.intensity,this}toJSON(t){const e=super.toJSON(t);return e.object.color=this.color.getHex(),e.object.intensity=this.intensity,this.groundColor!==void 0&&(e.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(e.object.distance=this.distance),this.angle!==void 0&&(e.object.angle=this.angle),this.decay!==void 0&&(e.object.decay=this.decay),this.penumbra!==void 0&&(e.object.penumbra=this.penumbra),this.shadow!==void 0&&(e.object.shadow=this.shadow.toJSON()),e}}class M0 extends vo{constructor(t,e,n){super(t,n),this.isHemisphereLight=!0,this.type="HemisphereLight",this.position.copy(Re.DEFAULT_UP),this.updateMatrix(),this.groundColor=new jt(e)}copy(t,e){return super.copy(t,e),this.groundColor.copy(t.groundColor),this}}const sr=new de,cc=new R,lc=new R;class ll{constructor(t){this.camera=t,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new ht(512,512),this.map=null,this.mapPass=null,this.matrix=new de,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new br,this._frameExtents=new ht(1,1),this._viewportCount=1,this._viewports=[new me(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(t){const e=this.camera,n=this.matrix;cc.setFromMatrixPosition(t.matrixWorld),e.position.copy(cc),lc.setFromMatrixPosition(t.target.matrixWorld),e.lookAt(lc),e.updateMatrixWorld(),sr.multiplyMatrices(e.projectionMatrix,e.matrixWorldInverse),this._frustum.setFromProjectionMatrix(sr),n.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),n.multiply(sr)}getViewport(t){return this._viewports[t]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(t){return this.camera=t.camera.clone(),this.bias=t.bias,this.radius=t.radius,this.mapSize.copy(t.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const t={};return this.bias!==0&&(t.bias=this.bias),this.normalBias!==0&&(t.normalBias=this.normalBias),this.radius!==1&&(t.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(t.mapSize=this.mapSize.toArray()),t.camera=this.camera.toJSON(!1).object,delete t.camera.matrix,t}}const hc=new de,ns=new R,or=new R;class y0 extends ll{constructor(){super(new Ge(90,1,.5,500)),this.isPointLightShadow=!0,this._frameExtents=new ht(4,2),this._viewportCount=6,this._viewports=[new me(2,1,1,1),new me(0,1,1,1),new me(3,1,1,1),new me(1,1,1,1),new me(3,0,1,1),new me(1,0,1,1)],this._cubeDirections=[new R(1,0,0),new R(-1,0,0),new R(0,0,1),new R(0,0,-1),new R(0,1,0),new R(0,-1,0)],this._cubeUps=[new R(0,1,0),new R(0,1,0),new R(0,1,0),new R(0,1,0),new R(0,0,1),new R(0,0,-1)]}updateMatrices(t,e=0){const n=this.camera,i=this.matrix,o=t.distance||n.far;o!==n.far&&(n.far=o,n.updateProjectionMatrix()),ns.setFromMatrixPosition(t.matrixWorld),n.position.copy(ns),or.copy(n.position),or.add(this._cubeDirections[e]),n.up.copy(this._cubeUps[e]),n.lookAt(or),n.updateMatrixWorld(),i.makeTranslation(-ns.x,-ns.y,-ns.z),hc.multiplyMatrices(n.projectionMatrix,n.matrixWorldInverse),this._frustum.setFromProjectionMatrix(hc)}}class S0 extends vo{constructor(t,e,n=0,i=2){super(t,e),this.isPointLight=!0,this.type="PointLight",this.distance=n,this.decay=i,this.shadow=new y0}get power(){return this.intensity*4*Math.PI}set power(t){this.intensity=t/(4*Math.PI)}dispose(){this.shadow.dispose()}copy(t,e){return super.copy(t,e),this.distance=t.distance,this.decay=t.decay,this.shadow=t.shadow.clone(),this}}class w0 extends ll{constructor(){super(new qc(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class hl extends vo{constructor(t,e){super(t,e),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(Re.DEFAULT_UP),this.updateMatrix(),this.target=new Re,this.shadow=new w0}dispose(){this.shadow.dispose()}copy(t){return super.copy(t),this.target=t.target.clone(),this.shadow=t.shadow.clone(),this}}class E0 extends vo{constructor(t,e){super(t,e),this.isAmbientLight=!0,this.type="AmbientLight"}}class b0{constructor(t=!0){this.autoStart=t,this.startTime=0,this.oldTime=0,this.elapsedTime=0,this.running=!1}start(){this.startTime=uc(),this.oldTime=this.startTime,this.elapsedTime=0,this.running=!0}stop(){this.getElapsedTime(),this.running=!1,this.autoStart=!1}getElapsedTime(){return this.getDelta(),this.elapsedTime}getDelta(){let t=0;if(this.autoStart&&!this.running)return this.start(),0;if(this.running){const e=uc();t=(e-this.oldTime)/1e3,this.oldTime=e,this.elapsedTime+=t}return t}}function uc(){return(typeof performance>"u"?Date:performance).now()}const dc=new de;class T0{constructor(t,e,n=0,i=1/0){this.ray=new po(t,e),this.near=n,this.far=i,this.camera=null,this.layers=new Er,this.params={Mesh:{},Line:{threshold:1},LOD:{},Points:{threshold:1},Sprite:{}}}set(t,e){this.ray.set(t,e)}setFromCamera(t,e){e.isPerspectiveCamera?(this.ray.origin.setFromMatrixPosition(e.matrixWorld),this.ray.direction.set(t.x,t.y,.5).unproject(e).sub(this.ray.origin).normalize(),this.camera=e):e.isOrthographicCamera?(this.ray.origin.set(t.x,t.y,(e.near+e.far)/(e.near-e.far)).unproject(e),this.ray.direction.set(0,0,-1).transformDirection(e.matrixWorld),this.camera=e):console.error("THREE.Raycaster: Unsupported camera type: "+e.type)}setFromXRController(t){return dc.identity().extractRotation(t.matrixWorld),this.ray.origin.setFromMatrixPosition(t.matrixWorld),this.ray.direction.set(0,0,-1).applyMatrix4(dc),this}intersectObject(t,e=!0,n=[]){return xr(t,this,n,e),n.sort(fc),n}intersectObjects(t,e=!0,n=[]){for(let i=0,o=t.length;i<o;i++)xr(t[i],this,n,e);return n.sort(fc),n}}function fc(s,t){return s.distance-t.distance}function xr(s,t,e,n){if(s.layers.test(t.layers)&&s.raycast(t,e),n===!0){const i=s.children;for(let o=0,r=i.length;o<r;o++)xr(i[o],t,e,!0)}}class pc{constructor(t=1,e=0,n=0){return this.radius=t,this.phi=e,this.theta=n,this}set(t,e,n){return this.radius=t,this.phi=e,this.theta=n,this}copy(t){return this.radius=t.radius,this.phi=t.phi,this.theta=t.theta,this}makeSafe(){return this.phi=Math.max(1e-6,Math.min(Math.PI-1e-6,this.phi)),this}setFromVector3(t){return this.setFromCartesianCoords(t.x,t.y,t.z)}setFromCartesianCoords(t,e,n){return this.radius=Math.sqrt(t*t+e*e+n*n),this.radius===0?(this.theta=0,this.phi=0):(this.theta=Math.atan2(t,n),this.phi=Math.acos(ye(e/this.radius,-1,1))),this}clone(){return new this.constructor().copy(this)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:yr}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=yr);class A0{constructor(t){rt(this,"scene",new Vm);rt(this,"renderer");rt(this,"clock",new b0);rt(this,"camera");rt(this,"container");rt(this,"updatables",[]);rt(this,"handleResize",()=>{const{clientWidth:t,clientHeight:e}=this.container;this.camera.aspect=t/e,this.camera.updateProjectionMatrix(),this.renderer.setSize(t,e)});this.container=t,this.camera=new Ge(55,1,.5,800),this.renderer=new Gm({antialias:!0}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.outputColorSpace=ke,this.renderer.toneMapping=Tc,this.renderer.toneMappingExposure=1.05,this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=Ec,"physicallyCorrectLights"in this.renderer&&(this.renderer.physicallyCorrectLights=!1),this.container.appendChild(this.renderer.domElement),this.handleResize(),window.addEventListener("resize",this.handleResize)}addUpdatable(...t){this.updatables.push(...t)}addToScene(...t){t.forEach(e=>this.scene.add(e))}start(){this.clock.start();const t=()=>{const e=this.clock.getDelta();this.updatables.forEach(n=>n.update(e)),this.renderer.render(this.scene,this.camera),requestAnimationFrame(t)};t()}}const mc=(s,t,e)=>Math.min(e,Math.max(t,s));class C0{constructor(t){rt(this,"base");rt(this,"stick");rt(this,"radius",40);rt(this,"pointerId",null);rt(this,"vector",{x:0,y:0});rt(this,"onPointerDown",t=>{this.pointerId=t.pointerId,t.target.setPointerCapture(t.pointerId),this.updateStick(t)});rt(this,"onPointerMove",t=>{t.pointerId===this.pointerId&&this.updateStick(t)});rt(this,"onPointerUp",t=>{t.pointerId===this.pointerId&&(this.pointerId=null,this.vector={x:0,y:0},this.stick.style.transform="translate(0px, 0px)")});this.base=document.createElement("div"),this.base.className="joystick",this.stick=document.createElement("div"),this.stick.className="joystick-stick",this.base.appendChild(this.stick),t.appendChild(this.base),this.base.addEventListener("pointerdown",this.onPointerDown),this.base.addEventListener("pointermove",this.onPointerMove),this.base.addEventListener("pointerup",this.onPointerUp),this.base.addEventListener("pointercancel",this.onPointerUp)}getVector(){return{...this.vector}}updateStick(t){const e=this.base.getBoundingClientRect(),n=t.clientX-e.left-e.width/2,i=t.clientY-e.top-e.height/2,o=Math.hypot(n,i),r=Math.min(o,this.radius),a=Math.atan2(i,n),c=Math.cos(a)*r,l=Math.sin(a)*r;this.vector={x:mc(c/this.radius,-1,1),y:mc(l/this.radius,-1,1)},this.stick.style.transform=`translate(${c}px, ${l}px)`}}class R0{constructor(t){rt(this,"keys",new Set);rt(this,"joystick");rt(this,"runHeld",!1);rt(this,"jumpQueued",!1);rt(this,"exitQueued",!1);rt(this,"enterQueued",!1);rt(this,"exitButton",null);rt(this,"onKeyDown",t=>{this.keys.add(t.code),t.code==="Space"&&!t.repeat&&(this.jumpQueued=!0),t.code==="KeyE"&&!t.repeat&&(this.exitQueued=!0),t.code==="Enter"&&!t.repeat&&(this.enterQueued=!0)});rt(this,"onKeyUp",t=>{this.keys.delete(t.code)});this.joystick=new C0(t),this.createTouchButtons(t),window.addEventListener("keydown",this.onKeyDown),window.addEventListener("keyup",this.onKeyUp)}getMoveVector(){let t=0,e=0;if((this.keys.has("KeyW")||this.keys.has("ArrowUp"))&&(e+=1),(this.keys.has("KeyS")||this.keys.has("ArrowDown"))&&(e-=1),(this.keys.has("KeyA")||this.keys.has("ArrowLeft"))&&(t-=1),(this.keys.has("KeyD")||this.keys.has("ArrowRight"))&&(t+=1),t!==0||e!==0){const o=Math.hypot(t,e)||1;return{x:t/o,z:e/o}}const n=this.joystick.getVector();return Math.hypot(n.x,n.y)>.05?{x:n.x*Math.abs(n.x),z:-n.y}:{x:0,z:0}}isSprinting(){if(this.keys.has("ShiftLeft")||this.keys.has("ShiftRight")||this.runHeld)return!0;const t=this.joystick.getVector();return Math.hypot(t.x,t.y)>=.85}consumeJumpPressed(){const t=this.jumpQueued;return this.jumpQueued=!1,t}consumeExitPressed(){const t=this.exitQueued;return this.exitQueued=!1,t}consumeEnterPressed(){const t=this.enterQueued;return this.enterQueued=!1,t}setExitVisible(t){this.exitButton&&(this.exitButton.style.display=t?"":"none")}createTouchButtons(t){const e=document.createElement("div");e.className="action-buttons";const n=document.createElement("button");n.className="action-button",n.type="button",n.textContent="БЕГ";const i=document.createElement("button");i.className="action-button",i.type="button",i.textContent="ПРЫЖОК";const o=document.createElement("button");o.className="action-button",o.type="button",o.textContent="ВЫЙТИ",o.style.display="none",this.exitButton=o;const r=c=>{c.preventDefault(),this.runHeld=!0},a=c=>{c.preventDefault(),this.runHeld=!1};n.addEventListener("pointerdown",r),n.addEventListener("pointerup",a),n.addEventListener("pointercancel",a),n.addEventListener("pointerleave",a),i.addEventListener("pointerdown",c=>{c.preventDefault(),this.jumpQueued=!0}),o.addEventListener("pointerdown",c=>{c.preventDefault(),this.exitQueued=!0}),e.append(n,i,o),t.appendChild(e)}}const gc={type:"change"},rr={type:"start"},_c={type:"end"},qs=new po,xc=new Nn,P0=Math.cos(70*uo.DEG2RAD);class L0 extends li{constructor(t,e){super(),this.object=t,this.domElement=e,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new R,this.cursor=new R,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minTargetRadius=0,this.maxTargetRadius=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.zoomToCursor=!1,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:di.ROTATE,MIDDLE:di.DOLLY,RIGHT:di.PAN},this.touches={ONE:fi.ROTATE,TWO:fi.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return a.phi},this.getAzimuthalAngle=function(){return a.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(v){v.addEventListener("keydown",Rt),this._domElementKeyEvents=v},this.stopListenToKeyEvents=function(){this._domElementKeyEvents.removeEventListener("keydown",Rt),this._domElementKeyEvents=null},this.saveState=function(){n.target0.copy(n.target),n.position0.copy(n.object.position),n.zoom0=n.object.zoom},this.reset=function(){n.target.copy(n.target0),n.object.position.copy(n.position0),n.object.zoom=n.zoom0,n.object.updateProjectionMatrix(),n.dispatchEvent(gc),n.update(),o=i.NONE},this.update=function(){const v=new R,O=new ri().setFromUnitVectors(t.up,new R(0,1,0)),H=O.clone().invert(),lt=new R,vt=new ri,Ht=new R,Xt=2*Math.PI;return function(le=null){const Kt=n.object.position;v.copy(Kt).sub(n.target),v.applyQuaternion(O),a.setFromVector3(v),n.autoRotate&&o===i.NONE&&B(M(le)),n.enableDamping?(a.theta+=c.theta*n.dampingFactor,a.phi+=c.phi*n.dampingFactor):(a.theta+=c.theta,a.phi+=c.phi);let he=n.minAzimuthAngle,Qt=n.maxAzimuthAngle;isFinite(he)&&isFinite(Qt)&&(he<-Math.PI?he+=Xt:he>Math.PI&&(he-=Xt),Qt<-Math.PI?Qt+=Xt:Qt>Math.PI&&(Qt-=Xt),he<=Qt?a.theta=Math.max(he,Math.min(Qt,a.theta)):a.theta=a.theta>(he+Qt)/2?Math.max(he,a.theta):Math.min(Qt,a.theta)),a.phi=Math.max(n.minPolarAngle,Math.min(n.maxPolarAngle,a.phi)),a.makeSafe(),n.enableDamping===!0?n.target.addScaledVector(h,n.dampingFactor):n.target.add(h),n.target.sub(n.cursor),n.target.clampLength(n.minTargetRadius,n.maxTargetRadius),n.target.add(n.cursor);let Je=!1;if(n.zoomToCursor&&A||n.object.isOrthographicCamera)a.radius=et(a.radius);else{const ze=a.radius;a.radius=et(a.radius*l),Je=ze!=a.radius}if(v.setFromSpherical(a),v.applyQuaternion(H),Kt.copy(n.target).add(v),n.object.lookAt(n.target),n.enableDamping===!0?(c.theta*=1-n.dampingFactor,c.phi*=1-n.dampingFactor,h.multiplyScalar(1-n.dampingFactor)):(c.set(0,0,0),h.set(0,0,0)),n.zoomToCursor&&A){let ze=null;if(n.object.isPerspectiveCamera){const rn=v.length();ze=et(rn*l);const $e=rn-ze;n.object.position.addScaledVector(S,$e),n.object.updateMatrixWorld(),Je=!!$e}else if(n.object.isOrthographicCamera){const rn=new R(P.x,P.y,0);rn.unproject(n.object);const $e=n.object.zoom;n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom/l)),n.object.updateProjectionMatrix(),Je=$e!==n.object.zoom;const mn=new R(P.x,P.y,0);mn.unproject(n.object),n.object.position.sub(mn).add(rn),n.object.updateMatrixWorld(),ze=v.length()}else console.warn("WARNING: OrbitControls.js encountered an unknown camera type - zoom to cursor disabled."),n.zoomToCursor=!1;ze!==null&&(this.screenSpacePanning?n.target.set(0,0,-1).transformDirection(n.object.matrix).multiplyScalar(ze).add(n.object.position):(qs.origin.copy(n.object.position),qs.direction.set(0,0,-1).transformDirection(n.object.matrix),Math.abs(n.object.up.dot(qs.direction))<P0?t.lookAt(n.target):(xc.setFromNormalAndCoplanarPoint(n.object.up,n.target),qs.intersectPlane(xc,n.target))))}else if(n.object.isOrthographicCamera){const ze=n.object.zoom;n.object.zoom=Math.max(n.minZoom,Math.min(n.maxZoom,n.object.zoom/l)),ze!==n.object.zoom&&(n.object.updateProjectionMatrix(),Je=!0)}return l=1,A=!1,Je||lt.distanceToSquared(n.object.position)>r||8*(1-vt.dot(n.object.quaternion))>r||Ht.distanceToSquared(n.target)>r?(n.dispatchEvent(gc),lt.copy(n.object.position),vt.copy(n.object.quaternion),Ht.copy(n.target),!0):!1}}(),this.dispose=function(){n.domElement.removeEventListener("contextmenu",St),n.domElement.removeEventListener("pointerdown",T),n.domElement.removeEventListener("pointercancel",F),n.domElement.removeEventListener("wheel",tt),n.domElement.removeEventListener("pointermove",w),n.domElement.removeEventListener("pointerup",F),n.domElement.getRootNode().removeEventListener("keydown",gt,{capture:!0}),n._domElementKeyEvents!==null&&(n._domElementKeyEvents.removeEventListener("keydown",Rt),n._domElementKeyEvents=null)};const n=this,i={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let o=i.NONE;const r=1e-6,a=new pc,c=new pc;let l=1;const h=new R,u=new ht,d=new ht,f=new ht,g=new ht,_=new ht,m=new ht,p=new ht,y=new ht,x=new ht,S=new R,P=new ht;let A=!1;const C=[],D={};let E=!1;function M(v){return v!==null?2*Math.PI/60*n.autoRotateSpeed*v:2*Math.PI/60/60*n.autoRotateSpeed}function I(v){const O=Math.abs(v*.01);return Math.pow(.95,n.zoomSpeed*O)}function B(v){c.theta-=v}function L(v){c.phi-=v}const W=function(){const v=new R;return function(H,lt){v.setFromMatrixColumn(lt,0),v.multiplyScalar(-H),h.add(v)}}(),U=function(){const v=new R;return function(H,lt){n.screenSpacePanning===!0?v.setFromMatrixColumn(lt,1):(v.setFromMatrixColumn(lt,0),v.crossVectors(n.object.up,v)),v.multiplyScalar(H),h.add(v)}}(),K=function(){const v=new R;return function(H,lt){const vt=n.domElement;if(n.object.isPerspectiveCamera){const Ht=n.object.position;v.copy(Ht).sub(n.target);let Xt=v.length();Xt*=Math.tan(n.object.fov/2*Math.PI/180),W(2*H*Xt/vt.clientHeight,n.object.matrix),U(2*lt*Xt/vt.clientHeight,n.object.matrix)}else n.object.isOrthographicCamera?(W(H*(n.object.right-n.object.left)/n.object.zoom/vt.clientWidth,n.object.matrix),U(lt*(n.object.top-n.object.bottom)/n.object.zoom/vt.clientHeight,n.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),n.enablePan=!1)}}();function it(v){n.object.isPerspectiveCamera||n.object.isOrthographicCamera?l/=v:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),n.enableZoom=!1)}function k(v){n.object.isPerspectiveCamera||n.object.isOrthographicCamera?l*=v:(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),n.enableZoom=!1)}function $(v,O){if(!n.zoomToCursor)return;A=!0;const H=n.domElement.getBoundingClientRect(),lt=v-H.left,vt=O-H.top,Ht=H.width,Xt=H.height;P.x=lt/Ht*2-1,P.y=-(vt/Xt)*2+1,S.set(P.x,P.y,1).unproject(n.object).sub(n.object.position).normalize()}function et(v){return Math.max(n.minDistance,Math.min(n.maxDistance,v))}function mt(v){u.set(v.clientX,v.clientY)}function Lt(v){$(v.clientX,v.clientX),p.set(v.clientX,v.clientY)}function Nt(v){g.set(v.clientX,v.clientY)}function j(v){d.set(v.clientX,v.clientY),f.subVectors(d,u).multiplyScalar(n.rotateSpeed);const O=n.domElement;B(2*Math.PI*f.x/O.clientHeight),L(2*Math.PI*f.y/O.clientHeight),u.copy(d),n.update()}function ut(v){y.set(v.clientX,v.clientY),x.subVectors(y,p),x.y>0?it(I(x.y)):x.y<0&&k(I(x.y)),p.copy(y),n.update()}function Et(v){_.set(v.clientX,v.clientY),m.subVectors(_,g).multiplyScalar(n.panSpeed),K(m.x,m.y),g.copy(_),n.update()}function _t(v){$(v.clientX,v.clientY),v.deltaY<0?k(I(v.deltaY)):v.deltaY>0&&it(I(v.deltaY)),n.update()}function Ft(v){let O=!1;switch(v.code){case n.keys.UP:v.ctrlKey||v.metaKey||v.shiftKey?L(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):K(0,n.keyPanSpeed),O=!0;break;case n.keys.BOTTOM:v.ctrlKey||v.metaKey||v.shiftKey?L(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):K(0,-n.keyPanSpeed),O=!0;break;case n.keys.LEFT:v.ctrlKey||v.metaKey||v.shiftKey?B(2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):K(n.keyPanSpeed,0),O=!0;break;case n.keys.RIGHT:v.ctrlKey||v.metaKey||v.shiftKey?B(-2*Math.PI*n.rotateSpeed/n.domElement.clientHeight):K(-n.keyPanSpeed,0),O=!0;break}O&&(v.preventDefault(),n.update())}function zt(v){if(C.length===1)u.set(v.pageX,v.pageY);else{const O=Ot(v),H=.5*(v.pageX+O.x),lt=.5*(v.pageY+O.y);u.set(H,lt)}}function N(v){if(C.length===1)g.set(v.pageX,v.pageY);else{const O=Ot(v),H=.5*(v.pageX+O.x),lt=.5*(v.pageY+O.y);g.set(H,lt)}}function Gt(v){const O=Ot(v),H=v.pageX-O.x,lt=v.pageY-O.y,vt=Math.sqrt(H*H+lt*lt);p.set(0,vt)}function Q(v){n.enableZoom&&Gt(v),n.enablePan&&N(v)}function dt(v){n.enableZoom&&Gt(v),n.enableRotate&&zt(v)}function nt(v){if(C.length==1)d.set(v.pageX,v.pageY);else{const H=Ot(v),lt=.5*(v.pageX+H.x),vt=.5*(v.pageY+H.y);d.set(lt,vt)}f.subVectors(d,u).multiplyScalar(n.rotateSpeed);const O=n.domElement;B(2*Math.PI*f.x/O.clientHeight),L(2*Math.PI*f.y/O.clientHeight),u.copy(d)}function J(v){if(C.length===1)_.set(v.pageX,v.pageY);else{const O=Ot(v),H=.5*(v.pageX+O.x),lt=.5*(v.pageY+O.y);_.set(H,lt)}m.subVectors(_,g).multiplyScalar(n.panSpeed),K(m.x,m.y),g.copy(_)}function X(v){const O=Ot(v),H=v.pageX-O.x,lt=v.pageY-O.y,vt=Math.sqrt(H*H+lt*lt);y.set(0,vt),x.set(0,Math.pow(y.y/p.y,n.zoomSpeed)),it(x.y),p.copy(y);const Ht=(v.pageX+O.x)*.5,Xt=(v.pageY+O.y)*.5;$(Ht,Xt)}function at(v){n.enableZoom&&X(v),n.enablePan&&J(v)}function yt(v){n.enableZoom&&X(v),n.enableRotate&&nt(v)}function T(v){n.enabled!==!1&&(C.length===0&&(n.domElement.setPointerCapture(v.pointerId),n.domElement.addEventListener("pointermove",w),n.domElement.addEventListener("pointerup",F)),!Dt(v)&&(Tt(v),v.pointerType==="touch"?xt(v):Y(v)))}function w(v){n.enabled!==!1&&(v.pointerType==="touch"?ft(v):ot(v))}function F(v){switch(pt(v),C.length){case 0:n.domElement.releasePointerCapture(v.pointerId),n.domElement.removeEventListener("pointermove",w),n.domElement.removeEventListener("pointerup",F),n.dispatchEvent(_c),o=i.NONE;break;case 1:const O=C[0],H=D[O];xt({pointerId:O,pageX:H.x,pageY:H.y});break}}function Y(v){let O;switch(v.button){case 0:O=n.mouseButtons.LEFT;break;case 1:O=n.mouseButtons.MIDDLE;break;case 2:O=n.mouseButtons.RIGHT;break;default:O=-1}switch(O){case di.DOLLY:if(n.enableZoom===!1)return;Lt(v),o=i.DOLLY;break;case di.ROTATE:if(v.ctrlKey||v.metaKey||v.shiftKey){if(n.enablePan===!1)return;Nt(v),o=i.PAN}else{if(n.enableRotate===!1)return;mt(v),o=i.ROTATE}break;case di.PAN:if(v.ctrlKey||v.metaKey||v.shiftKey){if(n.enableRotate===!1)return;mt(v),o=i.ROTATE}else{if(n.enablePan===!1)return;Nt(v),o=i.PAN}break;default:o=i.NONE}o!==i.NONE&&n.dispatchEvent(rr)}function ot(v){switch(o){case i.ROTATE:if(n.enableRotate===!1)return;j(v);break;case i.DOLLY:if(n.enableZoom===!1)return;ut(v);break;case i.PAN:if(n.enablePan===!1)return;Et(v);break}}function tt(v){n.enabled===!1||n.enableZoom===!1||o!==i.NONE||(v.preventDefault(),n.dispatchEvent(rr),_t(bt(v)),n.dispatchEvent(_c))}function bt(v){const O=v.deltaMode,H={clientX:v.clientX,clientY:v.clientY,deltaY:v.deltaY};switch(O){case 1:H.deltaY*=16;break;case 2:H.deltaY*=100;break}return v.ctrlKey&&!E&&(H.deltaY*=10),H}function gt(v){v.key==="Control"&&(E=!0,n.domElement.getRootNode().addEventListener("keyup",ct,{passive:!0,capture:!0}))}function ct(v){v.key==="Control"&&(E=!1,n.domElement.getRootNode().removeEventListener("keyup",ct,{passive:!0,capture:!0}))}function Rt(v){n.enabled===!1||n.enablePan===!1||Ft(v)}function xt(v){switch(Vt(v),C.length){case 1:switch(n.touches.ONE){case fi.ROTATE:if(n.enableRotate===!1)return;zt(v),o=i.TOUCH_ROTATE;break;case fi.PAN:if(n.enablePan===!1)return;N(v),o=i.TOUCH_PAN;break;default:o=i.NONE}break;case 2:switch(n.touches.TWO){case fi.DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;Q(v),o=i.TOUCH_DOLLY_PAN;break;case fi.DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;dt(v),o=i.TOUCH_DOLLY_ROTATE;break;default:o=i.NONE}break;default:o=i.NONE}o!==i.NONE&&n.dispatchEvent(rr)}function ft(v){switch(Vt(v),o){case i.TOUCH_ROTATE:if(n.enableRotate===!1)return;nt(v),n.update();break;case i.TOUCH_PAN:if(n.enablePan===!1)return;J(v),n.update();break;case i.TOUCH_DOLLY_PAN:if(n.enableZoom===!1&&n.enablePan===!1)return;at(v),n.update();break;case i.TOUCH_DOLLY_ROTATE:if(n.enableZoom===!1&&n.enableRotate===!1)return;yt(v),n.update();break;default:o=i.NONE}}function St(v){n.enabled!==!1&&v.preventDefault()}function Tt(v){C.push(v.pointerId)}function pt(v){delete D[v.pointerId];for(let O=0;O<C.length;O++)if(C[O]==v.pointerId){C.splice(O,1);return}}function Dt(v){for(let O=0;O<C.length;O++)if(C[O]==v.pointerId)return!0;return!1}function Vt(v){let O=D[v.pointerId];O===void 0&&(O=new ht,D[v.pointerId]=O),O.set(v.pageX,v.pageY)}function Ot(v){const O=v.pointerId===C[0]?C[1]:C[0];return D[O]}n.domElement.addEventListener("contextmenu",St),n.domElement.addEventListener("pointerdown",T),n.domElement.addEventListener("pointercancel",F),n.domElement.addEventListener("wheel",tt,{passive:!1}),n.domElement.getRootNode().addEventListener("keydown",gt,{passive:!0,capture:!0}),this.update()}}class I0{constructor(t,e,n){rt(this,"controls");rt(this,"camera");rt(this,"target");rt(this,"offset",new R(0,2,0));rt(this,"lastTarget",new R);rt(this,"tmp",new R);this.camera=t,this.target=n,this.controls=new L0(t,e),this.controls.enableDamping=!0,this.controls.dampingFactor=.1,this.controls.minDistance=5,this.controls.maxDistance=80,this.controls.maxPolarAngle=Math.PI/2.2,this.controls.enablePan=!1,this.controls.screenSpacePanning=!1,this.controls.target.copy(this.target.position).add(this.offset),t.position.copy(this.controls.target).add(new R(0,8,-14)),this.lastTarget.copy(this.target.position)}setTarget(t){if(this.target===t)return;const e=t.position.clone().sub(this.target.position);this.camera.position.add(e),this.controls.target.add(e),this.target=t,this.lastTarget.copy(t.position)}update(){this.tmp.copy(this.target.position).sub(this.lastTarget),this.tmp.y=0,this.tmp.lengthSq()>0&&(this.camera.position.add(this.tmp),this.controls.target.add(this.tmp));const t=this.target.position.x+this.offset.x,e=this.target.position.z+this.offset.z,n=t-this.controls.target.x,i=e-this.controls.target.z;(Math.abs(n)>1e-4||Math.abs(i)>1e-4)&&(this.tmp.set(n,0,i),this.camera.position.add(this.tmp),this.controls.target.add(this.tmp)),this.controls.target.y=this.target.position.y+this.offset.y,this.lastTarget.copy(this.target.position),this.controls.update()}}const kt={roads:[{position:{x:0,z:0},width:10,length:380,center:"dashed"},{position:{x:0,z:0},width:10,length:380,rotation:Math.PI/2,center:"dashed"},{position:{x:0,z:70},width:10,length:220,rotation:Math.PI/2,center:"dashed"},{position:{x:-70,z:-10},width:10,length:170,center:"dashed"},{position:{x:65,z:120},width:8,length:130,rotation:Math.PI/2,center:"none"}],crosswalks:[],parks:[{position:{x:-120,z:-40},width:70,depth:60}],waterAreas:[{position:{x:-120,z:-50},width:34,depth:24}],beachAreas:[{position:{x:-150,z:-150},width:90,depth:46}],buildings:[{position:{x:-40,z:102},size:{x:10,y:7.5,z:10},color:"#e30611",roof:"#2980b9",rotation:Math.PI,label:"МТС БАНК"},{position:{x:40,z:92},size:{x:12,y:4.2,z:8},color:"#27ae60",roof:"#27ae60",rotation:Math.PI,label:"ПРОДУКТЫ",shutters:!0},{position:{x:-96,z:26},size:{x:24,y:10,z:12},color:"#eeeeee",roof:"#20b2aa",rotation:-Math.PI/2,label:"МЕДСИ",labelTextColor:"#20b2aa",labelBg:"#ffffff",labelAnchor:"center",labelAllSides:!0},{position:{x:-52,z:26},size:{x:10,y:5,z:8},color:"#e30611",roof:"#ffffff",rotation:-Math.PI/2,label:"МТС SHOP",labelBg:"#ffffff",labelTextColor:"#e30611",labelAnchor:"center"},{position:{x:-55,z:-40},size:{x:20,y:5,z:8},color:"#9b59b6",roof:"#8e44ad",rotation:-Math.PI/2,label:"Магазин одежды"},{position:{x:29,z:130},size:{x:7.2,y:7.2,z:7.6},color:"#f6e3d3",roof:"#c65b4a",rotation:Math.PI},{position:{x:37,z:130},size:{x:7.2,y:7,z:7.6},color:"#e8f2ff",roof:"#4a6fa8",rotation:Math.PI},{position:{x:45,z:130},size:{x:7.2,y:7.4,z:7.6},color:"#f3f0d7",roof:"#b85d3d",rotation:Math.PI},{position:{x:53,z:130},size:{x:7.2,y:7.1,z:7.6},color:"#fde2ea",roof:"#a84a6a",rotation:Math.PI},{position:{x:61,z:130},size:{x:7.2,y:7.3,z:7.6},color:"#e8ffe9",roof:"#4f8b6b",rotation:Math.PI},{position:{x:69,z:130},size:{x:7.2,y:7,z:7.6},color:"#fff0d6",roof:"#b06a3c",rotation:Math.PI},{position:{x:77,z:130},size:{x:7.2,y:7.5,z:7.6},color:"#e9e6ff",roof:"#5b4aa8",rotation:Math.PI},{position:{x:85,z:130},size:{x:7.2,y:7.1,z:7.6},color:"#f7f7f2",roof:"#3f4a57",rotation:Math.PI},{position:{x:93,z:130},size:{x:7.2,y:7.3,z:7.6},color:"#e6f7ff",roof:"#3b6c7d",rotation:Math.PI},{position:{x:101,z:130},size:{x:7.2,y:7.2,z:7.6},color:"#ffe6d8",roof:"#b34e3b",rotation:Math.PI}],umbrellas:[{x:-170,z:-150,color:"#ffb3c1"},{x:-150,z:-142,color:"#ffe08a"},{x:-132,z:-156,color:"#9fd3ff"}],rocks:[{x:-188,z:-160,size:1.2},{x:-176,z:-168,size:1},{x:-160,z:-158,size:.8}],parkingLots:[{buildingIndex:0,spots:10},{buildingIndex:1,spots:2},{buildingIndex:2,spots:2},{buildingIndex:3,spots:2},{buildingIndex:4,spots:2}]},ae={worldSize:260,groundColor:"#4caf50",sandColor:"#f7e2b8",skyTopColor:"#6ecbff",skyBottomColor:"#fff7e8",fogColor:"#eef8ff",fogNear:80,fogFar:520,playerSpeed:6,playerSprintMultiplier:1.75,playerTurnSpeed:10,playerJumpSpeed:8.5,playerGravity:22,sunColor:"#fff1c4",ambientColor:"#fff7ea"},Pt={foundationHeight:.5,facadeInset:.06,door:{width:2,frameWidth:2.4,frameHeight:3.2,outward:.6,frameOutward:.45,localZOutset:.9},windows:{width:1.1,height:1.3,desiredStep:2.4,floorHeight:2.4,marginX:1.2,marginTop:1.1,sillFromBase:1.2,doorClearance:.6},roof:{minHeight:.7,maxHeight:1.2,relative:.12}},D0=(s,t)=>{const e=new te;e.rotation.y=s.rotation??0;const n=new q(new ie(s.size.x*1.06,.5,s.size.z*1.06),new Ct({color:"#7f8c8d",roughness:.9,metalness:.02}));n.position.y=Pt.foundationHeight/2,n.castShadow=!0,n.receiveShadow=!0,e.add(n);const i=new ie(s.size.x,s.size.y,s.size.z),o=new Ct({color:s.color,map:t.wall,roughness:.7,metalness:.05}),r=new q(i,o);r.castShadow=!0,r.receiveShadow=!0,r.position.y=Pt.foundationHeight+s.size.y/2,e.add(r);const a=Math.max(Pt.roof.minHeight,Math.min(Pt.roof.maxHeight,s.size.y*Pt.roof.relative)),c=new ie(s.size.x*1.05,a,s.size.z*1.05),l=new Ct({color:s.roof,map:t.roof,roughness:.6,metalness:.08}),h=new q(c,l);h.castShadow=!0,h.position.y=Pt.foundationHeight+s.size.y+a/2-.02,e.add(h);const u=new Ct({color:"#f9f9f7",roughness:.6,metalness:.02}),d=new q(new ie(s.size.x*1.02,.12,s.size.z*1.02),u);d.position.y=Pt.foundationHeight+s.size.y+.02,d.castShadow=!0,d.receiveShadow=!0,e.add(d);const f=new Ct({map:t.windows,emissive:new jt("#ffd9a8"),emissiveIntensity:.2,roughness:.16,metalness:.18,polygonOffset:!0,polygonOffsetFactor:-1,polygonOffsetUnits:-1}),g=new Ct({color:"#f4f6fb",roughness:.38,metalness:.16}),_=new Me(Pt.windows.width,Pt.windows.height),m=s.size.y-Pt.windows.marginTop,p=Math.max(1,Math.floor((m-Pt.windows.sillFromBase)/Pt.windows.floorHeight)),y=J=>{const X=Math.max(.01,J-2*Pt.windows.marginX),at=Math.max(1,Math.floor(X/Pt.windows.desiredStep)),yt=X/at,T=-X/2+yt/2;return{cols:at,step:yt,x0:T}},x=y(s.size.x),S=Pt.door.width/2+Pt.windows.doorClearance,P=Pt.door.frameHeight+Pt.windows.doorClearance;for(let J=0;J<p;J+=1){let X=Pt.foundationHeight+Pt.windows.sillFromBase+Pt.windows.height/2+J*Pt.windows.floorHeight;s.label==="МТС БАНК"&&J>=1&&(X+=.6);for(let at=0;at<x.cols;at+=1){const yt=x.x0+at*x.step,T=Math.abs(yt)<=S,w=X<=Pt.foundationHeight+P;if(T&&w)continue;const F=new q(_,f);F.position.set(yt,X,s.size.z/2+Pt.facadeInset),F.renderOrder=1,e.add(F);const Y=.06,ot=new ie(Pt.windows.width+.18,Pt.windows.height+.18,Y),tt=new q(ot,g);if(tt.position.set(yt,X,s.size.z/2+Pt.facadeInset-Y/2),tt.castShadow=!0,tt.receiveShadow=!0,tt.renderOrder=0,e.add(tt),s.shutters){const bt=new Ct({color:"#1f6f39",roughness:.75,metalness:.02}),gt=.22,ct=Pt.windows.height*1.02,Rt=.06,xt=s.size.z/2+Pt.facadeInset+.03,ft=new q(new ie(gt,ct,Rt),bt);ft.position.set(yt-Pt.windows.width/2-gt/2-.06,X,xt),ft.castShadow=!0,ft.renderOrder=1,e.add(ft);const St=new q(new ie(gt,ct,Rt),bt);St.position.set(yt+Pt.windows.width/2+gt/2+.06,X,xt),St.castShadow=!0,St.renderOrder=1,e.add(St)}}}const A=y(s.size.z);for(let J=0;J<p;J+=1){let X=Pt.foundationHeight+Pt.windows.sillFromBase+Pt.windows.height/2+J*Pt.windows.floorHeight;s.label==="МТС БАНК"&&J>=1&&(X+=.35);for(let at=0;at<A.cols;at+=1){const yt=A.x0+at*A.step,T=new q(_,f);T.rotation.y=Math.PI/2,T.position.set(s.size.x/2+Pt.facadeInset,X,yt),T.renderOrder=1,e.add(T);const w=.06,F=new ie(Pt.windows.width+.18,Pt.windows.height+.18,w),Y=new q(F,g);Y.rotation.y=Math.PI/2,Y.position.set(s.size.x/2+Pt.facadeInset-w/2,X,yt),Y.castShadow=!0,Y.receiveShadow=!0,Y.renderOrder=0,e.add(Y)}}for(let J=0;J<p;J+=1){let X=Pt.foundationHeight+Pt.windows.sillFromBase+Pt.windows.height/2+J*Pt.windows.floorHeight;s.label==="МТС БАНК"&&J>=1&&(X+=.35);for(let at=0;at<x.cols;at+=1){const yt=x.x0+at*x.step,T=new q(_,f);T.rotation.y=Math.PI,T.position.set(yt,X,-s.size.z/2-Pt.facadeInset),T.renderOrder=1,e.add(T);const w=.06,F=new ie(Pt.windows.width+.18,Pt.windows.height+.18,w),Y=new q(F,g);Y.rotation.y=Math.PI,Y.position.set(yt,X,-s.size.z/2-Pt.facadeInset+w/2),Y.castShadow=!0,Y.receiveShadow=!0,Y.renderOrder=0,e.add(Y)}}for(let J=0;J<p;J+=1){let X=Pt.foundationHeight+Pt.windows.sillFromBase+Pt.windows.height/2+J*Pt.windows.floorHeight;s.label==="МТС БАНК"&&J>=1&&(X+=.35);for(let at=0;at<A.cols;at+=1){const yt=A.x0+at*A.step,T=new q(_,f);T.rotation.y=-Math.PI/2,T.position.set(-s.size.x/2-Pt.facadeInset,X,yt),T.renderOrder=1,e.add(T);const w=.06,F=new ie(Pt.windows.width+.18,Pt.windows.height+.18,w),Y=new q(F,g);Y.rotation.y=-Math.PI/2,Y.position.set(-s.size.x/2-Pt.facadeInset+w/2,X,yt),Y.castShadow=!0,Y.receiveShadow=!0,Y.renderOrder=0,e.add(Y)}}const C=new q(new ie(2.4,3.2,.35),new Ct({color:"#2c3e50",roughness:.7,polygonOffset:!0,polygonOffsetFactor:-2,polygonOffsetUnits:-2}));C.position.set(0,Pt.foundationHeight+1.85,s.size.z/2+Pt.door.frameOutward),C.renderOrder=2,e.add(C);const D=new ie(2,2.8,.15),E=document.createElement("canvas");E.width=256,E.height=512;const M=E.getContext("2d");let I;if(M){M.fillStyle="#8b5a2b",M.fillRect(0,0,E.width,E.height);const J=M.createLinearGradient(0,0,0,E.height);J.addColorStop(0,"rgba(255,255,255,0.16)"),J.addColorStop(.5,"rgba(0,0,0,0.1)"),J.addColorStop(1,"rgba(0,0,0,0.22)"),M.fillStyle=J,M.fillRect(0,0,E.width,E.height);const X=32,at=(E.height-X*3)/2,yt=E.width-X*2;M.strokeStyle="rgba(0,0,0,0.45)",M.lineWidth=6,M.strokeRect(X,X,yt,at),M.strokeRect(X,X*2+at,yt,at),M.strokeStyle="rgba(255,255,255,0.08)",M.lineWidth=2;for(let T=0;T<E.width;T+=12)M.beginPath(),M.moveTo(T+Math.random()*4,0),M.lineTo(T+Math.random()*4,E.height),M.stroke();I=new ii(E),I.wrapS=I.wrapT=wn,I.anisotropy=4}const B=new Ct({color:"#8B4513",roughness:.8,metalness:.15,polygonOffset:!0,polygonOffsetFactor:-3,polygonOffsetUnits:-3,map:I}),L=new te,W=Pt.door.width/2;L.position.set(W,Pt.foundationHeight+1.75,s.size.z/2+Pt.door.outward);const U=new q(D,B);U.position.set(-2/2,0,0),U.castShadow=!0,U.renderOrder=3,U.name="door",L.add(U),e.add(L);const K=new te,it=new q(new pe(.04,.04,.12,12),new Ct({color:"#dcdcdc",metalness:.8,roughness:.25}));it.rotation.z=Math.PI/2,K.add(it);const k=new q(new qt(.05,12,12),new Ct({color:"#f5f5f5",metalness:.9,roughness:.2}));k.position.set(.08,0,0),K.add(k),K.position.set(-2/2+.08,0,D.parameters.depth/2+.02),U.add(K);const $=document.createElement("canvas");$.width=256,$.height=128;const et=$.getContext("2d");let mt;if(et){et.fillStyle="#c9c9c5",et.fillRect(0,0,$.width,$.height);const J=et.createLinearGradient(0,0,0,$.height);J.addColorStop(0,"rgba(255,255,255,0.25)"),J.addColorStop(1,"rgba(0,0,0,0.18)"),et.fillStyle=J,et.fillRect(0,0,$.width,$.height),et.strokeStyle="rgba(0,0,0,0.25)",et.lineWidth=2;for(let X=22;X<$.height;X+=24)et.beginPath(),et.moveTo(0,X+Math.random()*3),et.lineTo($.width,X+Math.random()*3),et.stroke();mt=new ii($),mt.wrapS=mt.wrapT=un,mt.repeat.set(2,1)}const Lt=new Ct({color:"#d0d0cc",roughness:.9,metalness:.02,map:mt}),Nt=Pt.door.frameWidth+.8,j=.55,ut=.16,Et=3,_t=.08,zt=s.size.z/2+Pt.door.outward-j/2-.04,N=zt+(Et-1)*(j-.05);for(let J=0;J<Et;J+=1){const X=ut,at=_t+J*ut,yt=N-J*(j-.05),T=new q(new ie(Nt-J*.18,X,j),Lt);T.position.set(0,at,yt),T.castShadow=!0,T.receiveShadow=!0,e.add(T)}const Gt=new Ct({color:"#c7b18a",roughness:.5,metalness:.25}),Q=new pe(.05,.06,.9,10),dt=J=>{const X=new te,at=Et+1,yt=zt-j/2,T=N+j/2,w=_t+.45,F=w+Et*ut*.6,Y=[];for(let ot=0;ot<at;ot+=1){const tt=new q(Q,Gt),bt=ot/(at-1),gt=T+(yt-T)*bt,ct=w+(F-w)*bt;tt.position.set((Nt/2+.06)*J,ct,gt),tt.castShadow=!0,X.add(tt);const Rt=ct+Q.parameters.height/2;Y.push(new R((Nt/2+.06)*J,Rt,gt))}if(Y.length>=2){const ot=new Hi(Y),tt=new si(ot,16,.045,10,!1),bt=new q(tt,Gt);bt.castShadow=!0,X.add(bt)}e.add(X)};dt(-1),dt(1);const nt=new q(new ie(3.2,.15,1.4),new Ct({color:s.roof,roughness:.55,metalness:.05}));if(nt.position.set(0,Pt.foundationHeight+3.55,s.size.z/2+.85),nt.rotation.x=-.2,nt.castShadow=!0,e.add(nt),s.label){const X=((tt,bt,gt)=>{const ct=document.createElement("canvas");ct.width=512,ct.height=128;const Rt=ct.getContext("2d");if(!Rt)return new Se;Rt.fillStyle=bt,Rt.fillRect(0,0,ct.width,ct.height),Rt.fillStyle=gt;const xt=tt.length>12?36:64;Rt.font=`bold ${xt}px Arial`,Rt.textAlign="center",Rt.textBaseline="middle",Rt.shadowColor="rgba(0,0,0,0.45)",Rt.shadowBlur=8,Rt.shadowOffsetY=3,Rt.fillText(tt,ct.width/2,ct.height/2+2);const ft=new ii(ct);return ft.wrapS=ft.wrapT=wn,ft.anisotropy=8,ft})(s.label,s.labelBg??s.color,s.labelTextColor??"#ffffff"),at=1.4,yt=Pt.foundationHeight+s.size.y+.85,T=.31,w=.31,F=()=>new Ct({map:X,color:"#ffffff",roughness:.25,metalness:.05,polygonOffset:!0,polygonOffsetFactor:-2,polygonOffsetUnits:-2,side:on}),Y=()=>{const tt=Math.min(s.size.x*.9,8),bt=new q(new Me(tt,at),F()),gt=s.labelAnchor??"center",ct=.35,Rt=gt==="edgeRight"?s.size.x/2-tt/2-ct:gt==="edgeLeft"?-s.size.x/2+tt/2+ct:0;bt.position.set(Rt,yt,s.size.z/2+T),bt.castShadow=!0,bt.renderOrder=4,e.add(bt)},ot=()=>{const tt=Math.min(s.size.x*.9,8),bt=Math.min(s.size.z*.9,8),gt=new q(new Me(tt,at),F());gt.rotation.y=Math.PI,gt.position.set(0,yt,-s.size.z/2-T),gt.castShadow=!0,gt.renderOrder=4,e.add(gt);const ct=new q(new Me(bt,at),F());ct.rotation.y=-Math.PI/2,ct.position.set(s.size.x/2+w,yt,0),ct.castShadow=!0,ct.renderOrder=4,e.add(ct);const Rt=new q(new Me(bt,at),F());Rt.rotation.y=Math.PI/2,Rt.position.set(-s.size.x/2-w,yt,0),Rt.castShadow=!0,Rt.renderOrder=4,e.add(Rt)};Y(),s.labelAllSides&&ot()}return e.position.set(s.position.x,0,s.position.z),e.userData.door=L,e},Dn=(s,t)=>{const n=document.createElement("canvas");n.width=512,n.height=512;const i=n.getContext("2d");if(!i){const a=new Se;return a.needsUpdate=!0,a}s!=="clouds"?(i.fillStyle=t,i.fillRect(0,0,512,512)):i.clearRect(0,0,512,512);const o=a=>{const c=i.getImageData(0,0,512,512),l=c.data;for(let h=0;h<l.length;h+=4){const u=(Math.random()-.5)*a;l[h]+=u,l[h+1]+=u,l[h+2]+=u}i.putImageData(c,0,0)};if(s==="grass"){o(40),i.fillStyle="rgba(0, 0, 0, 0.08)";for(let a=0;a<600;a++)i.fillRect(Math.random()*512,Math.random()*512,1,2)}if(s==="sand"){o(30),i.fillStyle="rgba(255, 255, 255, 0.12)";for(let a=0;a<400;a++)i.fillRect(Math.random()*512,Math.random()*512,2,1)}if(s==="path"){o(25),i.fillStyle="rgba(0, 0, 0, 0.12)";for(let a=0;a<500;a++)i.fillRect(Math.random()*512,Math.random()*512,2,2)}if(s==="road"){o(35),i.fillStyle="rgba(0, 0, 0, 0.12)";for(let a=0;a<500;a++)i.fillRect(Math.random()*512,Math.random()*512,2,2)}if(s==="roof"){o(15),i.strokeStyle="rgba(0, 0, 0, 0.25)",i.lineWidth=2;const a=8,c=512/a;for(let l=0;l<=a;l++)i.beginPath(),i.moveTo(0,l*c),i.lineTo(512,l*c),i.stroke()}if(s==="wall"){const a=i.createLinearGradient(0,0,0,512);a.addColorStop(0,"rgba(255,255,255,0.18)"),a.addColorStop(1,"rgba(0,0,0,0.12)"),i.fillStyle=a,i.fillRect(0,0,512,512),o(22),i.fillStyle="rgba(0, 0, 0, 0.06)";for(let l=0;l<900;l++)i.fillRect(Math.random()*512,Math.random()*512,1,1);for(let l=0;l<140;l++){const h=Math.random()*512,u=Math.random()*512,d=4+Math.random()*16;i.beginPath(),i.arc(h,u,d,0,Math.PI*2),i.fillStyle=`rgba(0, 0, 0, ${.025+Math.random()*.03})`,i.fill()}i.strokeStyle="rgba(0, 0, 0, 0.06)",i.lineWidth=2;const c=48;for(let l=0;l<512;l+=c)i.beginPath(),i.moveTo(0,l+(Math.random()*2-1)),i.lineTo(512,l+(Math.random()*2-1)),i.stroke()}if(s==="windows"){const a=i.createLinearGradient(0,0,0,512);a.addColorStop(0,"rgba(170, 210, 235, 0.95)"),a.addColorStop(1,"rgba(45, 75, 95, 0.95)"),i.fillStyle=a,i.fillRect(0,0,512,512),i.fillStyle="rgba(255, 255, 255, 0.14)",i.beginPath(),i.moveTo(512*.1,512*.9),i.lineTo(512*.9,512*.1),i.lineTo(512*.9,512*.28),i.lineTo(512*.28,512*.9),i.closePath(),i.fill(),i.strokeStyle="rgba(25, 35, 45, 0.95)",i.lineWidth=22,i.strokeRect(0,0,512,512),i.strokeStyle="rgba(255, 255, 255, 0.15)",i.lineWidth=6,i.strokeRect(18,18,476,476),i.fillStyle="rgba(25, 35, 45, 0.9)";const c=14;i.fillRect(512/2-c/2,18,c,476),i.fillRect(18,512/2-c/2,476,c),o(10)}if(s==="tile"){i.fillStyle=t,i.fillRect(0,0,512,512),o(15),i.strokeStyle="rgba(0,0,0,0.15)",i.lineWidth=3;const a=4,c=512/a;for(let l=0;l<=a;l++){const h=l*c;i.beginPath(),i.moveTo(h,0),i.lineTo(h,512),i.stroke(),i.beginPath(),i.moveTo(0,h),i.lineTo(512,h),i.stroke()}}if(s==="clouds")for(let c=0;c<26;c+=1){const l=Math.random()*512,h=Math.random()*512,u=34+Math.random()*62,d=5+Math.floor(Math.random()*5);for(let f=0;f<d;f+=1){const g=(Math.random()-.5)*u*.9,_=(Math.random()-.5)*u*.45,m=u*(1+(Math.random()-.5)*.35)*1.35,p=u*(.7+Math.random()*.35);i.save(),i.translate(l+g,h+_),i.scale(m/Math.max(1e-4,p),1);const y=i.createRadialGradient(0,0,0,0,0,p),x=.34+Math.random()*.18;y.addColorStop(0,`rgba(255, 255, 255, ${x})`),y.addColorStop(.62,`rgba(255, 255, 255, ${x*.62})`),y.addColorStop(1,"rgba(255, 255, 255, 0)"),i.fillStyle=y,i.beginPath(),i.arc(0,0,p,0,Math.PI*2),i.fill(),i.restore()}}const r=new ii(n);return r.wrapS=r.wrapT=un,r.anisotropy=4,r},U0=s=>{const n=document.createElement("canvas");n.width=256,n.height=64;const i=n.getContext("2d");if(!i)return new Se;i.fillStyle="#ffffff",i.fillRect(0,0,256,64),i.strokeStyle="#000000",i.lineWidth=8,i.strokeRect(0,0,256,64),i.fillStyle="#000000",i.font="bold 40px monospace",i.textAlign="center",i.textBaseline="middle",i.fillText(s.toUpperCase(),256/2,64/2);const o=new ii(n);return o.minFilter=je,o},N0=new qt(.1,6,6),z0=new He({color:8947848,transparent:!0,opacity:.6,depthWrite:!1});class Zs{constructor(t,e){rt(this,"object",new te);rt(this,"path");rt(this,"speed");rt(this,"targetIndex",0);rt(this,"y");rt(this,"animTime",0);rt(this,"speedScale",1);rt(this,"isParked");rt(this,"doorPivot");rt(this,"doorVoid");rt(this,"doorOpen",0);rt(this,"doorOpenTarget",0);rt(this,"doorOpenSpeed",7);rt(this,"doorMaxAngle",Math.PI*.65);rt(this,"driver");rt(this,"smokeGroup",new te);rt(this,"smokeParticles",[]);rt(this,"nextSmokeTime",0);this.path=t,this.speed=e.speed,this.y=e.y??.22,this.targetIndex=Math.max(0,Math.min(t.length-1,e.startIndex??0)),this.isParked=!!e.parked,this.isParked=!!e.parked,this.object.add(this.buildModel(e.color,e.plateText)),this.object.add(this.smokeGroup);const n=this.path[this.targetIndex]??new R(0,0,0);this.object.position.set(n.x,this.y,n.z),e.plateText&&(this.object.userData.plateText=e.plateText)}setSpeedScale(t){this.speedScale=Math.max(0,t)}setDoorOpen(t){this.doorOpenTarget=t?1:0}getForward2D(){const t=this.object.rotation.y;return{x:Math.sin(t),z:Math.cos(t)}}update(t,e){if(this.path.length<2)return;this.animTime+=t;const n=this.path[this.targetIndex],i=this.object.position.x,o=this.object.position.z,r=n.x-i,a=n.z-o,c=Math.hypot(r,a);if(c<.55){this.targetIndex=(this.targetIndex+1)%this.path.length;return}const l=1/Math.max(c,1e-6),h=r*l,u=a*l,d=this.speed*this.speedScale*t;if(this.object.position.x+=h*Math.min(d,c),this.object.position.z+=u*Math.min(d,c),e!==void 0?this.object.position.y=e+.22:this.object.position.y=this.y,this.object.rotation.y=Math.atan2(h,u),this.updateDoorAnimation(t),this.driver){const f=Math.sin(this.animTime*3.2)*.04;this.driver.head.position.y=this.driver.headBaseY+f,this.driver.earL.position.y=this.driver.earBaseY+f*.9,this.driver.earR.position.y=this.driver.earBaseY+f*.9}this.updateSmoke(t,this.speedScale)}buildModel(t,e){const n=new te,i=new Ct({color:t,roughness:.25,metalness:.1}),o=new Ct({color:"#bfe6ff",roughness:.08,metalness:.05,transparent:!0,opacity:.72}),r=new Ct({color:"#1f2a33",roughness:.9,metalness:.05}),a=new Ct({color:"#151a1f",roughness:.95,metalness:.05,side:Ve}),c=new Ct({color:"#151a1f",roughness:.95,metalness:.05,side:Ce}),l=new cl({color:15901016,roughness:.55,metalness:0,sheen:1,sheenRoughness:.45,sheenColor:16769484,map:this.createFurTexture()}),h=new Ct({color:16775920,roughness:.65,metalness:.05}),u=new Ct({color:16758465,roughness:.45}),d=this.isParked?new qt(1,18,18,0,Math.PI*2,Math.PI*.18,Math.PI*.82):new qt(1,18,18),f=new q(d,i);if(f.scale.set(1.1,.8,2.2),f.position.y=.82,f.castShadow=!0,f.receiveShadow=!0,n.add(f),this.isParked){const ft=new q(d,c);ft.scale.set(1.02,.74,2.05),ft.position.y=.8,ft.castShadow=!1,ft.receiveShadow=!1,n.add(ft)}const g=1.25,_=.7,m=.15,p=new sl,y=-g/2,x=-_/2;p.moveTo(y,x+m),p.lineTo(y,x+_-m),p.quadraticCurveTo(y,x+_,y+m,x+_),p.lineTo(y+g-m,x+_),p.quadraticCurveTo(y+g,x+_,y+g,x+_-m),p.lineTo(y+g,x+m),p.quadraticCurveTo(y+g,x,y+g-m,x),p.lineTo(y+m,x),p.quadraticCurveTo(y,x,y,x+m);const S={depth:.05,bevelEnabled:!0,bevelThickness:.02,bevelSize:.02,bevelSegments:4},P=new Pr(p,S);P.center();const A=new q(P,o);if(A.position.set(0,1.45,.95),A.rotation.x=-.2,n.add(A),!this.isParked){const ft=new Ct({color:"#0a0c0e",roughness:1,metalness:0}),St=new q(new On(.55,.15,12,32),ft);St.rotation.x=Math.PI/2,St.position.set(0,1.45,-.1),n.add(St)}const C=new Ct({color:2829099,roughness:.9,metalness:.02}),D=(ft,St,Tt=1.008)=>{const pt=new R(ft,0,St),Dt=pt.x*pt.x+pt.z*pt.z,Vt=Math.sqrt(Math.max(0,1-Dt));return pt.y=Vt,pt.multiplyScalar(Tt)},E=(ft,St)=>{const Tt=new Hi(ft,!1,"catmullrom",.6),pt=new si(Tt,40,St,6,!1),Dt=new q(pt,C);return Dt.castShadow=!1,Dt.receiveShadow=!1,Dt},M=ft=>{const pt=ft*.9272727272727272,Dt=.35/2.2,Vt=-.55/2.2,Ot=Xt=>{const ne=[];for(let le=0;le<=10;le+=1){const Kt=le/10,he=pt*(1-.02*Math.sin(Kt*Math.PI));ne.push(D(he,Xt,1.01))}return ne},Wt=()=>{const Xt=[],le=.15909090909090906;for(let Kt=0;Kt<=10;Kt+=1){const he=Kt/10,Qt=-.25+(le- -.25)*he;Xt.push(D(pt,Qt,1.011))}return Xt},v=.012,O=E(Ot(Dt),v),H=E(Ot(Vt),v),lt=E(Wt(),v),vt=new q(new ao(.03,.14,4,8),C);vt.rotation.z=Math.PI/2;const Ht=D(pt,-.05/2.2,1.02);vt.position.copy(Ht),f.add(O,H,lt,vt)};M(1),M(-1);const I=new q(new On(.66,.07,10,26),i);I.rotation.x=Math.PI/2,I.scale.set(1,1,1.1);const B=this.isParked?.96:1.02,L=-.08;I.position.set(0,B,L),I.castShadow=!0,n.add(I);const W=new q(new On(.58,.08,10,26),a);W.rotation.x=Math.PI/2,W.scale.set(1,1,1.05),W.position.set(0,B-.12,L-.02),W.castShadow=!1,W.receiveShadow=!0,n.add(W);const U=new q(new pe(.82,.82,.6,26,1,!0),a);U.position.set(0,this.isParked?.86:.92,-.18),U.castShadow=!0,U.receiveShadow=!0,n.add(U);const K=new q(new _o(this.isParked?.9:.74,26),a);if(K.rotation.x=-Math.PI/2,K.position.set(0,this.isParked?.62:.66,-.18),K.receiveShadow=!0,n.add(K),this.isParked){const Ot={x:1.1,y:.8,z:2.2},Wt=-.12+.95/2,v=(.98-.82)/Ot.y,O=Wt/Ot.z,H=Ot.x*Math.sqrt(Math.max(0,1-v*v-O*O)),lt=(rn,$e,mn,We,Qe)=>{const ji=[],xs=[],ui=[],vs=(st,Mt,wt,It,Ut,Bt)=>{ji.push(st,Mt,wt),xs.push(It,Ut,Bt)},b=[];for(let st=0;st<=We;st+=1){const wt=.98+(st/We-.5)*$e,It=(wt-.82)/Ot.y;for(let Ut=0;Ut<=Qe;Ut+=1){const Zt=-.12+(Ut/Qe-.5)*rn,_e=Zt/Ot.z,we=1-It*It-_e*_e,Pe=we>0?Ot.x*Math.sqrt(we):Ot.x*1e-4,Xe=Pe/(Ot.x*Ot.x),ee=(wt-.82)/(Ot.y*Ot.y),Yt=Zt/(Ot.z*Ot.z),gn=Math.hypot(Xe,ee,Yt)||1;b.push({x:Pe,y:wt,z:Zt,nx:Xe/gn,ny:ee/gn,nz:Yt/gn})}}const z=Qe+1;for(const st of b)vs(st.x,st.y,st.z,st.nx,st.ny,st.nz);for(const st of b)vs(st.x-st.nx*mn,st.y-st.ny*mn,st.z-st.nz*mn,-st.nx,-st.ny,-st.nz);for(let st=0;st<We;st+=1)for(let Mt=0;Mt<Qe;Mt+=1){const wt=st*z+Mt,It=wt+z,Ut=It+1,Bt=wt+1;ui.push(wt,It,Bt,It,Ut,Bt)}const Z=b.length;for(let st=0;st<We;st+=1)for(let Mt=0;Mt<Qe;Mt+=1){const wt=Z+st*z+Mt,It=wt+z,Ut=It+1,Bt=wt+1;ui.push(wt,Bt,It,It,Bt,Ut)}const V=(st,Mt,wt,It)=>{ui.push(st,Mt,wt,Mt,It,wt)};for(let st=0;st<Qe;st+=1){const Mt=st,wt=st+1;V(Mt,wt,Z+Mt,Z+wt)}for(let st=0;st<Qe;st+=1){const Mt=We*z+st,wt=Mt+1;V(Mt,Z+Mt,wt,Z+wt)}for(let st=0;st<We;st+=1){const Mt=st*z,wt=Mt+z;V(Mt,Z+Mt,wt,Z+wt)}for(let st=0;st<We;st+=1){const Mt=st*z+Qe,wt=Mt+z;V(Mt,wt,Z+Mt,Z+wt)}const G=new ge;return G.setIndex(ui),G.setAttribute("position",new oe(ji,3)),G.setAttribute("normal",new oe(xs,3)),G.computeBoundingSphere(),G.translate(-H,-.98,-Wt),G},vt=i.clone();vt.side=Ve;const Ht=new te;Ht.position.set(H,.98,Wt);const Xt=lt(.95,.8,.035*2,8,10),ne=new q(Xt,vt);ne.castShadow=!0,ne.receiveShadow=!0,Ht.add(ne),n.add(Ht),this.doorPivot=Ht;const le=.6,Kt=new ie(le,.8*.9,.95*.9),he=new Ct({color:"#050607",roughness:1,metalness:0,side:on}),Qt=new q(Kt,he),Je=-.12/Ot.z,ze=Ot.x*Math.sqrt(Math.max(0,1-v*v-Je*Je));Qt.position.set(ze-le/2,.98,-.12),Qt.castShadow=!1,Qt.receiveShadow=!1,Qt.visible=!1,n.add(Qt),this.doorVoid=Qt}const it=new q(new ie(.95,.18,.4),r);it.position.set(0,1.06,.45),it.castShadow=!0,n.add(it);const k=new te,$=new R(0,1.22,.34);k.position.copy($),k.rotation.x=-.25,n.add(k);const et=new q(new On(.28,.05,10,18),r);et.castShadow=!0,k.add(et);const mt=new q(new pe(.04,.06,.3,10),r);mt.rotation.x=Math.PI/2,mt.position.set(0,-.12,-.18),k.add(mt);const Lt=new q(new ao(.18,1.25,8,14),o);if(Lt.rotation.x=Math.PI/2,Lt.rotation.z=-.55,Lt.scale.set(1.1,.75,.28),Lt.position.set(0,B+.18,$.z+.6),n.add(Lt),!this.isParked){const ft=new qt(.14,16,16),St=new q(ft,h);St.scale.set(1.1,.65,1.2),St.position.set(-.18,.02,.02),St.castShadow=!0,k.add(St);const Tt=new q(ft,h);Tt.scale.set(1.1,.65,1.2),Tt.position.set(.18,.02,.02),Tt.castShadow=!0,k.add(Tt)}const Nt=new q(new pe(.55,.55,.18,18),r);Nt.position.set(0,.92,-.22),Nt.castShadow=!0,n.add(Nt);const j=new q(new pe(.46,.46,.26,16),r);j.position.set(0,1.1,-.22),j.castShadow=!0,n.add(j);const ut=new q(new qt(.55,18,14),i);ut.scale.set(1.25,.55,.6),ut.position.set(0,.55,2.05),ut.castShadow=!0,n.add(ut);const Et=new q(new On(.35,.05,10,18,Math.PI),r);Et.position.set(0,.45,2.15),Et.rotation.x=Math.PI/2,n.add(Et);const _t=new pe(.32,.32,.22,16),Ft=new pe(.2,.2,.23,16),zt=new pe(.08,.08,.24,16),N=new Ct({color:"#20262c",roughness:.9,metalness:.1}),Gt=new Ct({color:"#A0A0A0",roughness:.4,metalness:.8}),Q=new Ct({color:"#FFFFFF",roughness:.2,metalness:.2}),dt=[[.9,.32,1.2,1],[-.9,.32,1.2,-1],[.9,.32,-1.2,1],[-.9,.32,-1.2,-1]];for(const[ft,St,Tt]of dt){const pt=new te;pt.position.set(ft,St,Tt),pt.rotation.z=Math.PI/2;const Dt=new q(_t,N);Dt.castShadow=!0,pt.add(Dt);const Vt=new q(Ft,Gt);pt.add(Vt);const Ot=new q(zt,Q);pt.add(Ot),n.add(pt)}if(!this.isParked){const St=new q(new qt(.66,22,18),l);St.position.set(0,1.93,-.08),St.castShadow=!0,n.add(St);const Tt=new q(new qt(.42,18,14),l);Tt.scale.set(1.05,.75,.95),Tt.position.set(0,1.45,-.28),Tt.castShadow=!0,n.add(Tt),this.addPlayerStyleFace(St,h,.66);const pt=this.createPlayerStyleEar(-.34,l,u);pt.position.set(-.34,2.43,-.18),n.add(pt);const Dt=this.createPlayerStyleEar(.34,l,u);Dt.position.set(.34,2.43,-.18),n.add(Dt),this.driver={head:St,chest:Tt,earL:pt,earR:Dt,headBaseY:St.position.y,chestBaseY:Tt.position.y,earBaseY:pt.position.y}}const nt=new qt(.2,16,16),J=new qt(.14,16,16),X=new Ct({color:16777215,emissive:16777215,emissiveIntensity:1,roughness:.2}),at=new Ct({color:16776960,emissive:16776960,emissiveIntensity:1.5,roughness:.2}),yt=new Ct({color:16711680,emissive:16711680,emissiveIntensity:1.5,roughness:.2}),T=ft=>{const St=new q(nt,X);St.position.set(ft,.82,2.05),St.scale.set(1,1,.4);const Tt=new q(J,at);return Tt.position.set(0,0,.15),Tt.scale.set(1,1,.6),St.add(Tt),St},w=T(.6);n.add(w);const F=T(-.6);n.add(F);const Y=ft=>{const St=new q(nt,yt);return St.position.set(ft,.82,-2.05),St.scale.set(1,1,.5),St},ot=Y(.6);n.add(ot);const tt=Y(-.6);if(n.add(tt),e){const ft=new Me(.5,.125),St=U0(e),Tt=new He({map:St,side:Ve}),pt=new q(ft,Tt);pt.position.set(0,.6,-2.12),pt.rotation.y=Math.PI,pt.rotation.x=-.1,n.add(pt)}const bt=new q(new pe(.06,.06,.2,8),r);bt.rotation.x=Math.PI/2,bt.position.set(.45,.43,-2.05),n.add(bt);const gt=new pe(.16,.16,.08,24);gt.rotateX(Math.PI/2);const ct=new pe(.13,.13,.02,24);ct.rotateX(Math.PI/2);const Rt=new Ct({color:11393254,roughness:.1,metalness:.9}),xt=ft=>{const St=new te,Tt=new q(gt,i);St.add(Tt);const pt=new q(ct,Rt);pt.position.set(0,0,-.05),St.add(pt);const Dt=new q(new pe(.02,.02,.35,8),r);Dt.rotation.z=ft>0?-Math.PI/2.5:Math.PI/2.5,Dt.position.set(ft>0?-.18:.18,-.1,0),St.add(Dt);const Vt=ft>0?1.3:-1.3;return St.position.set(Vt,1.35,.4),St.rotation.y=ft>0?.25:-.25,St};return n.add(xt(1)),n.add(xt(-1)),n}updateSmoke(t,e=1){if(!this.isParked){if(this.nextSmokeTime-=t,this.nextSmokeTime<=0){const n=e<.1;this.nextSmokeTime=n?.15+Math.random()*.15:.05+Math.random()*.05;const i=new q(N0,z0);i.position.set(.45+(Math.random()-.5)*.1,.43+(Math.random()-.5)*.1,-2.15);const o=n?.35:.6;i.scale.setScalar(o+Math.random()*.4),i.rotation.z=Math.random()*Math.PI,this.smokeGroup.add(i);const r=n?.4:1,a=new R((Math.random()-.5)*.15,(.4+Math.random()*.4)*r,(-1.5-Math.random()*1.5)*r);this.smokeParticles.push({mesh:i,life:1,velocity:a})}for(let n=this.smokeParticles.length-1;n>=0;n--){const i=this.smokeParticles[n];if(i.life-=t,i.life<=0){this.smokeGroup.remove(i.mesh),this.smokeParticles.splice(n,1);continue}i.mesh.position.addScaledVector(i.velocity,t),i.mesh.scale.multiplyScalar(1+t*.5)}}}updateDoorAnimation(t){if(!this.doorPivot)return;const e=Math.min(1,t*this.doorOpenSpeed);this.doorOpen+=(this.doorOpenTarget-this.doorOpen)*e,this.doorOpen=uo.clamp(this.doorOpen,0,1),this.doorPivot.rotation.y=-this.doorOpen*this.doorMaxAngle,this.doorVoid&&(this.doorVoid.visible=this.doorOpen>.05)}addPlayerStyleFace(t,e,n){const i=n/.9,o=new q(new qt(.42*i,24,18),e);o.scale.set(1.1,.7,.9),o.position.set(0,-.15*i,.65*i),o.castShadow=!0,t.add(o);const r=new te;r.position.set(0,-.19*i,1.01*i),t.add(r);const a=new ni({color:3881787,linewidth:2}),c=new Yi(new R(-.2*i,-.02*i,0),new R(-.1*i,-.1*i,0),new R(0,-.06*i,0)),l=new ge().setFromPoints(c.getPoints(10));r.add(new Bn(l,a));const h=new Yi(new R(0,-.06*i,0),new R(.1*i,-.1*i,0),new R(.2*i,-.02*i,0)),u=new ge().setFromPoints(h.getPoints(10));r.add(new Bn(u,a));const d=new Ct({color:16777215,roughness:.1}),f=new q(new qt(.23*i,32,24),d);f.position.set(-.34*i,.14*i,.74*i),f.scale.set(1,1,.85),t.add(f);const g=new q(new qt(.22*i,32,24),d);g.position.set(.34*i,.14*i,.74*i),g.scale.set(1,1,.85),t.add(g);const _=new Ct({color:0,roughness:.4}),m=new q(new qt(.12*i,24,18),_);m.scale.set(1,1,.45),m.position.set(-.34*i,.14*i,.95*i),t.add(m);const p=new q(new qt(.12*i,24,18),_);p.scale.set(1,1,.45),p.position.set(.34*i,.14*i,.95*i),t.add(p);const y=new He({color:16777215}),x=new q(new qt(.028*i,12,12),y);x.position.set(-.3*i,.18*i,1.05*i),t.add(x);const S=new q(new qt(.028*i,12,12),y);S.position.set(.27*i,.18*i,1.05*i),t.add(S);const P=new qt(.13*i,16,16),A=new Ct({color:2829099,roughness:.4}),C=new q(P,A);C.position.set(0,-.02*i,.89*i),C.scale.set(1.1,.85,.7),t.add(C);const D=new Bn(new ge().setFromPoints([new R(0,-.09*i,.83*i),new R(0,-.19*i,.89*i)]),new ni({color:3355443}));t.add(D);const E=new ni({color:4473924});this.createWhiskerLine(-.35*i,-.1*i,.73*i,Math.PI-.3,1.3*i,E,t),this.createWhiskerLine(-.35*i,-.17*i,.73*i,Math.PI-.15,1.25*i,E,t),this.createWhiskerLine(-.35*i,-.24*i,.73*i,Math.PI,1.2*i,E,t),this.createWhiskerLine(.35*i,-.1*i,.73*i,.3,1.3*i,E,t),this.createWhiskerLine(.35*i,-.17*i,.73*i,.15,1.25*i,E,t),this.createWhiskerLine(.35*i,-.24*i,.73*i,0,1.2*i,E,t)}createWhiskerLine(t,e,n,i,o,r,a){const c=[new R(t,e,n),new R(t+Math.cos(i)*o,e,n+Math.sin(i)*o)],l=new ge().setFromPoints(c);a.add(new Bn(l,r))}createPlayerStyleEar(t,e,n){const i=new te,o=new q(new ai(.26,.48,14),e);o.scale.set(1,1.05,1),i.add(o);const r=new q(new ai(.2,.38,14),n);return r.position.set(0,-.05,.06),r.scale.set(.82,.82,.55),i.add(r),i.rotation.z=t>0?-.45:.45,i.rotation.x=-.1,i.castShadow=!1,i}createFurTexture(){const t=document.createElement("canvas");t.width=128,t.height=128;const e=t.getContext("2d");if(!e){const i=new Se;return i.needsUpdate=!0,i}e.fillStyle="#f2a158",e.fillRect(0,0,t.width,t.height),e.fillStyle="rgba(194, 114, 49, 0.25)";for(let i=0;i<220;i+=1){const o=Math.random()*t.width,r=Math.random()*t.height,a=1+Math.random()*2.2;e.beginPath(),e.arc(o,r,a,0,Math.PI*2),e.fill()}e.fillStyle="rgba(255, 255, 255, 0.05)";for(let i=0;i<80;i+=1){const o=Math.random()*t.width,r=Math.random()*t.height,a=.8+Math.random()*1.4;e.beginPath(),e.arc(o,r,a,0,Math.PI*2),e.fill()}const n=new ii(t);return n.wrapS=un,n.wrapT=un,n.repeat.set(2.2,2.2),n.colorSpace=ke,n}}const Li=["КОТ-404","МЯУ-007","РЫБА","С0Н","ТЫГДЫК","ЛАПКИ","МУР","КУСЬ","ШЕРСТЬ","ЖРАТЬ"];class O0{constructor(){rt(this,"group",new te);rt(this,"wallTexture",Dn("wall","#f5efe8"));rt(this,"roofTexture",Dn("roof","#d07055"));rt(this,"windowTexture",Dn("windows","#7fc8ff"));rt(this,"groundTexture",Dn("grass",ae.groundColor));rt(this,"sandTexture",Dn("sand",ae.sandColor));rt(this,"roadTexture",Dn("road","#555a60"));rt(this,"tileTexture",Dn("tile","#e0e0e0"));rt(this,"cloudTexture",Dn("clouds","rgba(0,0,0,0)"));rt(this,"buildingPaths",[]);rt(this,"centerLineMaterial",new Ct({color:"#ffffff",roughness:.4,metalness:.1,side:on}));rt(this,"colliders",[]);rt(this,"doors",[]);rt(this,"mtsShopDoor");rt(this,"birds",[]);rt(this,"birdsTime",0);rt(this,"intersections",this.computeIntersections());rt(this,"trafficCars",[]);rt(this,"parkedCars",[]);rt(this,"parkingParams",{spotW:2.9,spotD:5.8,gap:.4,pad:1.2,aisle:6.4,drivewayW:3.2});rt(this,"parkingLayouts",[]);rt(this,"trafficState","NS_GO");rt(this,"trafficTimer",0);rt(this,"trafficCycleTime",5);rt(this,"trafficYellowTime",1.5);rt(this,"trafficLights",[]);rt(this,"riverWidth",18);this.wallTexture.repeat.set(2,2),this.roofTexture.repeat.set(2,2),this.windowTexture.repeat.set(1,1),this.parkingLayouts=this.computeParkingLayouts(),this.intersections=this.computeIntersections(),this.buildSky(),this.buildHills(),this.buildGround(),this.buildParks(),this.buildBeach(),this.buildWater(),this.buildRoads(),this.buildPathsToBuildings(),this.buildParkingLots(),this.buildCrosswalks(),this.buildTrafficLights(),this.buildBuildings(),this.buildTrees(),this.buildLamps(),this.buildUmbrellas(),this.buildBenches(),this.buildRocks(),this.buildBirds(),this.buildTrafficCars()}getWorldHeight(t,e){const n=this.getTerrainHeight(t,e);return Math.abs(t- -70)<6&&Math.abs(e- -40)<16?Math.max(n,.04):n}getRiverCenterZ(t){return 160+10*Math.sin(t*.05)}getTerrainHeight(t,e){if(this.isPointNearBuilding(t,e,6)||this.isPointInParking(t,e,4))return 0;let n=0;const i=this.getRiverCenterZ(t),o=Math.abs(e-i);if(o<this.riverWidth){const h=o/this.riverWidth,u=5*(Math.cos(h*Math.PI)+1)*.5;n-=u}const r=-110,a=-80,c=45,l=(t-r)**2+(e-a)**2;if(l<c*c){const u=Math.sqrt(l)/c;n+=7*(Math.cos(u*Math.PI)+1)*.5}return n}isPointInRiver(t,e,n=0){const i=this.getRiverCenterZ(t);return Math.abs(e-i)<this.riverWidth-2+n}update(t){this.updateTrafficLights(t),this.updateBirds(t),this.updateTrafficCars(t)}updateTrafficCars(t){if(this.trafficCars.length===0)return;const e=18,n=2.2,i=6,o=h=>h*h,r=this.intersections,a=4,c=18,l=h=>this.getTrafficLightState(h);for(const h of this.trafficCars){const u=h.object.position,d=h.getForward2D();let f=1,g=1/0;for(const m of this.trafficCars){if(m===h)continue;const p=m.object.position,y=p.x-u.x,x=p.z-u.z,S=o(y)+o(x);if(S>e*e||S<1e-4)continue;const P=Math.sqrt(S),A=y/P,C=x/P;A*d.x+C*d.z<.7||Math.abs(y*d.z-x*d.x)>n||P<g&&(g=P)}if(g<1/0){if(g<i*.4)f=0;else if(g<i){const m=(g-i*.4)/(i*.6);f=Math.min(f,Math.max(0,m))}}for(const m of r){const p=m.x-u.x,y=m.z-u.z,x=o(p)+o(y);if(x>c*c||x<a*a)continue;const S=Math.sqrt(x),P=p/S,A=y/S;if(!(P*d.x+A*d.z>.4))continue;const D=Math.abs(y)>Math.abs(p)?"NS":"EW",E=l(D);if(!(E==="RED"||E==="YELLOW"))continue;const I=(S-a)/Math.max(c-a,.001),B=Math.max(0,Math.min(1,I));f=Math.min(f,B)}h.setSpeedScale(f);const _=this.getWorldHeight(u.x,u.z);h.update(t,_)}}buildTrafficCars(){const t=kt.roads??[];if(t.length===0)return;const e=(a,c,l)=>Math.max(c,Math.min(l,a)),n=a=>{const c=a.rotation??0,l=a.length/2,h=a.width/2-1.15,u=e(a.width*.25,1.2,Math.max(1.2,h)),d=4,f=4.5,g=[];for(let m=-l+d;m<=l-d+1e-6;m+=f){const p=this.localToWorldXZ(a.position.x,a.position.z,c,u,m);g.push(new R(p.x,0,p.z))}const _=[];for(let m=l-d;m>=-l+d-1e-6;m-=f){const p=this.localToWorldXZ(a.position.x,a.position.z,c,-u,m);_.push(new R(p.x,0,p.z))}if(g.length>0&&_.length>0){const m=g[g.length-1],p=_[0];m.distanceTo(p)<.1&&_.shift()}if(_.length>0&&g.length>0){const m=_[_.length-1],p=g[0];m.distanceTo(p)<.1&&g.shift()}return[...g,..._]},i=a=>t[a]??null,o=[i(0),i(1),i(2)].filter(Boolean);if(o.length===0)return;const r=["#ff6b6b","#6bcBff","#ffd166"];o.forEach((a,c)=>{const l=n(a);if(l.length<4)return;const h=Li[Math.floor(Math.random()*Li.length)],u=new Zs(l,{color:r[c%r.length],speed:8,y:.23,startIndex:Math.floor(l.length*c/o.length),plateText:h});this.trafficCars.push(u),this.group.add(u.object)})}computeWorldBounds2D(t){let e=-130,n=ae.worldSize/2,i=-260/2,o=ae.worldSize/2;const r=(c,l,h,u)=>{e=Math.min(e,c),n=Math.max(n,l),i=Math.min(i,h),o=Math.max(o,u)};for(const c of kt.roads??[]){const l=c.rotation??0,h=Math.abs(Math.cos(l)),u=Math.abs(Math.sin(l)),d=c.width/2,f=c.length/2,g=h*d+u*f,_=u*d+h*f;r(c.position.x-g,c.position.x+g,c.position.z-_,c.position.z+_)}for(const c of kt.buildings??[]){const l=c.size.x/2,h=c.size.z/2;r(c.position.x-l,c.position.x+l,c.position.z-h,c.position.z+h)}const a=[...kt.waterAreas??[],...kt.beachAreas??[],...kt.parks??[]];for(const c of a)r(c.position.x-c.width/2,c.position.x+c.width/2,c.position.z-c.depth/2,c.position.z+c.depth/2);return{minX:e-t,maxX:n+t,minZ:i-t,maxZ:o+t}}buildSky(){const t=ae.worldSize*1.6,e=new qt(t,32,32),n=new bn({side:Ce,uniforms:{topColor:{value:new jt(ae.skyTopColor)},bottomColor:{value:new jt(ae.skyBottomColor)},offset:{value:24},exponent:{value:.42}},vertexShader:`
        varying vec3 vWorldPosition;
        void main() {
